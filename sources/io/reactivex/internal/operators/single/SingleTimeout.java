...
public final class SingleTimeout<T> extends Single<T> {
    ...
    public static final class a<T> extends AtomicReference<Disposable> implements SingleObserver<T>, Runnable, Disposable {
        ...
        public final C0798a<T> fallback;
        ...
        /* loaded from: classes12.dex */
        public static final class C0798a<T> extends AtomicReference<Disposable> implements SingleObserver<T> {
            private static final long serialVersionUID = 2071387740092105509L;
            public final SingleObserver<? super T> downstream;

            public C0798a(SingleObserver<? super T> singleObserver) {
        ...
        public a(SingleObserver<? super T> singleObserver, SingleSource<? extends T> singleSource, long j, TimeUnit timeUnit) {
            ...
            if (singleSource != null) {
                this.fallback = new C0798a<>(singleObserver);
            } else {
                this.fallback = null;
            }
        }
        ...
        public void dispose() {
            ...
            C0798a<T> c0798a = this.fallback;
            if (c0798a != null) {
                DisposableHelper.dispose(c0798a);
            }
        }
