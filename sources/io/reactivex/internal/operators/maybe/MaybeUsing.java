...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        try {
            D call = this.h.call();
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.i.apply(call), "The sourceSupplier returned a null MaybeSource")).subscribe(new a(maybeObserver, call, this.j, this.k));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                if (this.k) {
                    try {
