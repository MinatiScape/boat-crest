...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    public final ParallelFlowable<T> f13916a;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f13917a[ParallelFailureHandling.SKIP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f13917a[ParallelFailureHandling.STOP.ordinal()] = 3;
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L6:
                r2 = 0
            L8:
                io.reactivex.functions.Consumer<? super T> r0 = r9.i     // Catch: java.lang.Throwable -> L14
                r0.accept(r10)     // Catch: java.lang.Throwable -> L14
                io.reactivex.internal.fuseable.ConditionalSubscriber<? super T> r0 = r9.h
            ...
            L14:
                ...
                r4 = 1
                r5 = 2
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r6 = r9.j     // Catch: java.lang.Throwable -> L4c
                r7 = 1
                long r2 = r2 + r7
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.a.f13917a
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r4) goto L8
                if (r6 == r5) goto L4b
            ...
            L4c:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.b.tryOnNext(java.lang.Object):boolean");
        }
    }
    ...
    public static final class c<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        */
        public boolean tryOnNext(T r10) {
            ...
            L8:
                r0 = 1
                io.reactivex.functions.Consumer<? super T> r4 = r9.i     // Catch: java.lang.Throwable -> L14
            ...
            L14:
                ...
                r5 = 2
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r6 = r9.j     // Catch: java.lang.Throwable -> L4b
                r7 = 1
                long r2 = r2 + r7
            ...
            L4b:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.c.tryOnNext(java.lang.Object):boolean");
        }
    }

    public ParallelDoOnNextTry(ParallelFlowable<T> parallelFlowable, Consumer<? super T> consumer, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
        this.f13916a = parallelFlowable;
        this.b = consumer;
        this.c = biFunction;
    }
    ...
    public int parallelism() {
        return this.f13916a.parallelism();
    }
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        if (validate(subscriberArr)) {
            ...
            this.f13916a.subscribe(subscriberArr2);
        }
    }
}
