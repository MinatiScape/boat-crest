...
public final class ObservableFlatMapMaybe<T, R> extends io.reactivex.internal.operators.observable.a<T, R> {
    ...
    public static final class a<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        /* loaded from: classes12.dex */
        public final class C0785a extends AtomicReference<Disposable> implements MaybeObserver<R>, Disposable {
        ...
        public void innerComplete(a<T, R>.C0785a c0785a) {
            this.set.delete(c0785a);
            if (get() == 0) {
        ...
        public void innerError(a<T, R>.C0785a c0785a, Throwable th) {
            this.set.delete(c0785a);
        ...
        public void innerSuccess(a<T, R>.C0785a c0785a, R r) {
            this.set.delete(c0785a);
            if (get() == 0) {
                if (compareAndSet(0, 1)) {
        ...
        public void onNext(T t) {
            try {
                ...
                if (this.cancelled || !this.set.add(c0785a)) {
                    return;
                }
                maybeSource.subscribe(c0785a);
            } catch (Throwable th) {
