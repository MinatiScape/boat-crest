...
public final class ObservableRetryBiPredicate<T> extends io.reactivex.internal.operators.observable.a<T, T> {
    public final BiPredicate<? super Integer, ? super Throwable> h;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        new a(observer, this.h, sequentialDisposable, this.source).subscribeNext();
    }
}
