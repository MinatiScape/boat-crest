...
public final class FlowableFlatMapCompletable<T> extends io.reactivex.internal.operators.flowable.a<T, T> {
    ...
    public static final class a<T> extends BasicIntQueueSubscription<T> implements FlowableSubscriber<T> {
        ...
        /* loaded from: classes12.dex */
        public final class C0745a extends AtomicReference<Disposable> implements CompletableObserver, Disposable {
        ...
        public void innerComplete(a<T>.C0745a c0745a) {
            this.set.delete(c0745a);
            onComplete();
        }

        public void innerError(a<T>.C0745a c0745a, Throwable th) {
            this.set.delete(c0745a);
            onError(th);
        }
        ...
        public void onNext(T t) {
            try {
                ...
                if (this.cancelled || !this.set.add(c0745a)) {
                    return;
                }
                completableSource.subscribe(c0745a);
            } catch (Throwable th) {
