...
public final class FlowableOnBackpressureBufferStrategy<T> extends io.reactivex.internal.operators.flowable.a<T, T> {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f13906a[BackpressureOverflowStrategy.DROP_OLDEST.ordinal()] = 2;
        ...
        */
        public void drain() {
            ...
            L80:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.flowable.FlowableOnBackpressureBufferStrategy.b.drain():void");
        }
        ...
        public void onNext(T t) {
            ...
            synchronized (deque) {
                ...
                if (deque.size() == this.bufferSize) {
                    int i = a.f13906a[this.strategy.ordinal()];
                    if (i == 1) {
                        deque.pollLast();
                        deque.offer(t);
                    } else if (i == 2) {
