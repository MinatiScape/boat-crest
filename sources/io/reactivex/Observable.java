...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f13892a[BackpressureStrategy.LATEST.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f13892a[BackpressureStrategy.MISSING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f13892a[BackpressureStrategy.ERROR.ordinal()] = 4;
    ...
    public final Observable<T> b(long j, TimeUnit timeUnit, ObservableSource<? extends T> observableSource, Scheduler scheduler) {
    ...
    public final <U, V> Observable<T> c(ObservableSource<U> observableSource, Function<? super T, ? extends ObservableSource<V>> function, ObservableSource<? extends T> observableSource2) {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = a.f13892a[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
