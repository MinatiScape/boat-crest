...
public abstract class Completable implements CompletableSource {
    ...
    @SchedulerSupport("none")
    public static Completable b(@NonNull Publisher<? extends CompletableSource> publisher, int i, boolean z) {
    ...
    public final Completable c(long j, TimeUnit timeUnit, Scheduler scheduler, CompletableSource completableSource) {
    ...
    public final Completable timeout(long j, @NonNull TimeUnit timeUnit) {
        return c(j, timeUnit, Schedulers.computation(), null);
    }
    ...
    public final Completable timeout(long j, @NonNull TimeUnit timeUnit, @NonNull CompletableSource completableSource) {
        Objects.requireNonNull(completableSource, "fallback is null");
        return c(j, timeUnit, Schedulers.computation(), completableSource);
    }
