...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f13944a[BackpressureStrategy.LATEST.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f13944a[BackpressureStrategy.MISSING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f13944a[BackpressureStrategy.ERROR.ordinal()] = 4;
    ...
    @NonNull
    @SchedulerSupport("none")
    public final Observable<T> a(@NonNull Consumer<? super T> consumer, @NonNull Consumer<? super Throwable> consumer2, @NonNull Action action, @NonNull Action action2) {
    ...
    @NonNull
    public final Observable<T> b(long j, @NonNull TimeUnit timeUnit, @Nullable ObservableSource<? extends T> observableSource, @NonNull Scheduler scheduler) {
    ...
    @NonNull
    public final <U, V> Observable<T> c(@NonNull ObservableSource<U> observableSource, @NonNull Function<? super T, ? extends ObservableSource<V>> function, @Nullable ObservableSource<? extends T> observableSource2) {
    ...
    public final Flowable<T> toFlowable(@NonNull BackpressureStrategy backpressureStrategy) {
        ...
        int i = a.f13944a[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
    ...
    public final Stream<T> blockingStream(int i) {
        ...
        disposable.getClass();
        return (Stream) stream.onClose(new io.reactivex.rxjava3.core.a(disposable));
    }
