...
public final class SingleDelay<T> extends Single<T> {
    ...
    public final class a implements SingleObserver<T> {
        ...
        public final class RunnableC0862a implements Runnable {
            ...
            public RunnableC0862a(Throwable th) {
                this.h = th;
            }
        ...
        public void onError(Throwable th) {
            ...
            RunnableC0862a runnableC0862a = new RunnableC0862a(th);
            SingleDelay singleDelay = SingleDelay.this;
            sequentialDisposable.replace(scheduler.scheduleDirect(runnableC0862a, singleDelay.l ? singleDelay.i : 0L, singleDelay.j));
        }
