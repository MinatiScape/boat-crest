...
public final class ObservableFlatMapSingle<T, R> extends io.reactivex.rxjava3.internal.operators.observable.a<T, R> {
    ...
    public static final class a<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        /* loaded from: classes12.dex */
        public final class C0852a extends AtomicReference<Disposable> implements SingleObserver<R>, Disposable {
        ...
        public void innerError(a<T, R>.C0852a c0852a, Throwable th) {
            this.set.delete(c0852a);
        ...
        public void innerSuccess(a<T, R>.C0852a c0852a, R r) {
            this.set.delete(c0852a);
            if (get() == 0) {
        ...
        public void onNext(T t) {
            try {
                ...
                if (this.cancelled || !this.set.add(c0852a)) {
                    return;
                }
                singleSource.subscribe(c0852a);
            } catch (Throwable th) {
