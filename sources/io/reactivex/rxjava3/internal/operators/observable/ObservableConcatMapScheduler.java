...
public final class ObservableConcatMapScheduler<T, U> extends io.reactivex.rxjava3.internal.operators.observable.a<T, U> {
    ...
    public static final class a<T, R> extends AtomicInteger implements Observer<T>, Disposable, Runnable {
        ...
        public final C0845a<R> observer;
        ...
        /* loaded from: classes12.dex */
        public static final class C0845a<R> extends AtomicReference<Disposable> implements Observer<R> {
            private static final long serialVersionUID = 2620149119579502636L;
            public final Observer<? super R> downstream;
            public final a<?, R> parent;

            public C0845a(Observer<? super R> observer, a<?, R> aVar) {
        ...
        public a(Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function, int i, boolean z, Scheduler.Worker worker) {
            ...
            this.bufferSize = i;
            this.tillTheEnd = z;
            this.observer = new C0845a<>(observer, this);
            this.worker = worker;
        }
    ...
    public void subscribeActual(Observer<? super U> observer) {
        if (this.j == ErrorMode.IMMEDIATE) {
            this.source.subscribe(new b(new SerializedObserver(observer), this.h, this.i, this.k.createWorker()));
        } else {
            this.source.subscribe(new a(observer, this.h, this.i, this.j == ErrorMode.END, this.k.createWorker()));
        }
    }
}
