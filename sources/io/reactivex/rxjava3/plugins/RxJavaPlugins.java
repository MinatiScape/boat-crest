...
public final class RxJavaPlugins {
    ...
    public static volatile Consumer<? super Throwable> f13994a;
    @Nullable
    public static volatile Function<? super Runnable, ? extends Runnable> b;
    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> c;
    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> d;
    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> e;
    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> f;
    @Nullable
    ...
    public static Scheduler initComputationScheduler(@NonNull Supplier<Scheduler> supplier) {
        ...
        Function<? super Supplier<Scheduler>, ? extends Scheduler> function = c;
        if (function == null) {
            return d(supplier);
        }
    ...
    public static Scheduler initIoScheduler(@NonNull Supplier<Scheduler> supplier) {
        Objects.requireNonNull(supplier, "Scheduler Supplier can't be null");
        Function<? super Supplier<Scheduler>, ? extends Scheduler> function = e;
        if (function == null) {
            return d(supplier);
        }
        return c(function, supplier);
    ...
    public static Scheduler initNewThreadScheduler(@NonNull Supplier<Scheduler> supplier) {
        Objects.requireNonNull(supplier, "Scheduler Supplier can't be null");
        Function<? super Supplier<Scheduler>, ? extends Scheduler> function = f;
        if (function == null) {
            return d(supplier);
        }
        return c(function, supplier);
    ...
    public static Scheduler initSingleScheduler(@NonNull Supplier<Scheduler> supplier) {
        Objects.requireNonNull(supplier, "Scheduler Supplier can't be null");
        Function<? super Supplier<Scheduler>, ? extends Scheduler> function = d;
        if (function == null) {
            return d(supplier);
        }
        return c(function, supplier);
    ...
    public static void onError(@NonNull Throwable th) {
        Consumer<? super Throwable> consumer = f13994a;
        if (th == null) {
