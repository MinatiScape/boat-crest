...
public class g {
    ...
    public static final JsonReader.Options f2079a = JsonReader.Options.of(Constants.NOTIF_MSG, "g", "o", RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, "s", RsaJsonWebKey.EXPONENT_MEMBER_NAME, Constants.INAPP_WINDOW, "lc", "lj", "ml", "hd", "d");
    ...
    public static final JsonReader.Options c = JsonReader.Options.of("n", CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_VALUE);
    ...
    public static GradientStroke a(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f2079a)) {
                case 0:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (selectName != 0) {
                            ...
                            if (selectName != 1) {
                                ...
                                animatableGradientColorValue2 = AnimatableValueParser.e(jsonReader, lottieComposition, i);
                            }
                        } else {
                            animatableGradientColorValue = animatableGradientColorValue2;
