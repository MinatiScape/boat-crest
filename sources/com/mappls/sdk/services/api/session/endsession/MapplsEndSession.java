...
import com.mappls.sdk.services.api.session.endsession.a;
...
public abstract class MapplsEndSession extends MapplsService<Void, b> {

    @Keep
    @AutoValue.Builder
    /* loaded from: classes8.dex */
    public static abstract class Builder {
        public abstract MapplsEndSession autoBuild();
    ...
    public Call<Void> initializeCall() {
        return getService(true).a(sessionType(), clusterId());
    }
