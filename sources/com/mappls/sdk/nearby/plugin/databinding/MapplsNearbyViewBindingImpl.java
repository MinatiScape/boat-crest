...
public class MapplsNearbyViewBindingImpl extends MapplsNearbyViewBinding {
    @Nullable
    ...
    public MapplsNearbyViewBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 13, i, j));
    }

    public MapplsNearbyViewBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
