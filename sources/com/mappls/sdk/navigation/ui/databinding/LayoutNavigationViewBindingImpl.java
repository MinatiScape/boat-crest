...
public class LayoutNavigationViewBindingImpl extends LayoutNavigationViewBinding {
    ...
    public LayoutNavigationViewBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 20, i, j));
    }

    public LayoutNavigationViewBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
