...
public class MapplsDirectionListHeaderBindingImpl extends MapplsDirectionListHeaderBinding {
    ...
    public MapplsDirectionListHeaderBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private MapplsDirectionListHeaderBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[4], (TextView) objArr[3], (ImageView) objArr[2], (FrameLayout) objArr[1], (RelativeLayout) objArr[0]);
        this.mDirtyFlags = -1L;
