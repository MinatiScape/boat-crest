...
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> a() {
        ...
        arrayList49.add("DZ");
        hashMap.put(Integer.valueOf((int) Command.CMD_GET_LOW_LATENCY_SETTINGS), arrayList49);
        ArrayList arrayList50 = new ArrayList(1);
        arrayList50.add("TN");
        hashMap.put(Integer.valueOf((int) Command.CMD_SET_DEVICE_STORAGE), arrayList50);
        ...
        arrayList53.add("SN");
        hashMap.put(Integer.valueOf((int) PressureParam.STATE_ALL_DAY), arrayList53);
        ...
        arrayList73.add("GA");
        hashMap.put(Integer.valueOf((int) Command.CMD_PHONE_NUMBER_PLAY_MODE), arrayList73);
        ...
        arrayList80.add("SC");
        hashMap.put(Integer.valueOf((int) RingLogger.EVT_UPDATE), arrayList80);
        ...
        arrayList93.add("RE");
        arrayList93.add("YT");
        hashMap.put(Integer.valueOf((int) DfuException.ERROR_NO_SERVICE_FOUND_OR_LOSS), arrayList93);
        ArrayList arrayList94 = new ArrayList(1);
        arrayList94.add("ZW");
        hashMap.put(Integer.valueOf((int) DfuException.ERROR_NO_CHARACTERISTIC_FOUND_OR_LOSS), arrayList94);
        ArrayList arrayList95 = new ArrayList(1);
        arrayList95.add("NA");
        hashMap.put(Integer.valueOf((int) DfuException.ERROR_CONNECT_ERROR), arrayList95);
        ArrayList arrayList96 = new ArrayList(1);
        arrayList96.add("MW");
        hashMap.put(Integer.valueOf((int) DfuException.ERROR_CANNOT_FIND_DEVICE), arrayList96);
        ArrayList arrayList97 = new ArrayList(1);
        arrayList97.add("LS");
        hashMap.put(Integer.valueOf((int) DfuException.ERROR_WRITE_CHARAC_NOTIFY_ERROR), arrayList97);
        ArrayList arrayList98 = new ArrayList(1);
        arrayList98.add("BW");
        hashMap.put(Integer.valueOf((int) DfuException.ERROR_WRITE_CHARAC_ERROR), arrayList98);
        ArrayList arrayList99 = new ArrayList(1);
        arrayList99.add("SZ");
        hashMap.put(Integer.valueOf((int) DfuException.ERROR_SEND_COMMAND_REACH_MAX_RETRY_TIMES), arrayList99);
        ...
        arrayList101.add("SH");
        arrayList101.add("TA");
        hashMap.put(Integer.valueOf((int) TGEventListener.SLEEP_START), arrayList101);
        ArrayList arrayList102 = new ArrayList(1);
        arrayList102.add("ER");
        hashMap.put(Integer.valueOf((int) TGEventListener.SLEEP_STOP), arrayList102);
        ArrayList arrayList103 = new ArrayList(1);
        arrayList103.add("AW");
        hashMap.put(297, arrayList103);
        ArrayList arrayList104 = new ArrayList(1);
        arrayList104.add("FO");
        hashMap.put(Integer.valueOf((int) ResultCode.INVALID_TXRX), arrayList104);
        ...
        arrayList108.add("LU");
        hashMap.put(Integer.valueOf((int) com.veryfit.multi.nativeprotocol.b.s1), arrayList108);
        ArrayList arrayList109 = new ArrayList(1);
        arrayList109.add("IE");
        hashMap.put(Integer.valueOf((int) com.veryfit.multi.nativeprotocol.b.t1), arrayList109);
        ArrayList arrayList110 = new ArrayList(1);
        arrayList110.add("IS");
        hashMap.put(354, arrayList110);
        ArrayList arrayList111 = new ArrayList(1);
        arrayList111.add("AL");
        hashMap.put(Integer.valueOf((int) AccessLock.EVT_LOCK_ACQUIRED), arrayList111);
        ...
        arrayList128.add("ME");
        hashMap.put(Integer.valueOf((int) ResultCode.INVALID_FILE), arrayList128);
        ArrayList arrayList129 = new ArrayList(1);
        arrayList129.add(EcgStyleReportUtil.UserInfoKey.HR);
        ...
        arrayList147.add("BO");
        hashMap.put(Integer.valueOf((int) com.veryfit.multi.nativeprotocol.b.u2), arrayList147);
        ...
        arrayList154.add("UY");
        hashMap.put(Integer.valueOf((int) BleCenter.EVT_REMOVED), arrayList154);
        ...
        arrayList201.add("PS");
        hashMap.put(Integer.valueOf((int) AccessLock.EVT_LOCKED), arrayList201);
