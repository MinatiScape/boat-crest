...
public final class WireFormat {
    ...
    public static final int f10966a = a(1, 3);
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f10967a[FieldType.FLOAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f10967a[FieldType.INT64.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f10967a[FieldType.UINT64.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f10967a[FieldType.INT32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f10967a[FieldType.FIXED64.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f10967a[FieldType.FIXED32.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f10967a[FieldType.BOOL.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f10967a[FieldType.BYTES.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f10967a[FieldType.UINT32.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f10967a[FieldType.SFIXED32.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f10967a[FieldType.SFIXED64.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f10967a[FieldType.SINT32.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f10967a[FieldType.SINT64.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f10967a[FieldType.STRING.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f10967a[FieldType.GROUP.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f10967a[FieldType.MESSAGE.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f10967a[FieldType.ENUM.ordinal()] = 18;
    ...
    public static abstract class b {
        ...
        public enum a extends b {
            ...
            @Override // com.google.crypto.tink.shaded.protobuf.WireFormat.b
            public Object readString(CodedInputStream codedInputStream) throws IOException {
                return codedInputStream.readString();
            }
        }

        /* renamed from: com.google.crypto.tink.shaded.protobuf.WireFormat$b$b  reason: collision with other inner class name */
        /* loaded from: classes10.dex */
        public enum C0533b extends b {
            public C0533b(String str, int i) {
                super(str, i, null);
            }
        ...
        static {
            ...
            LOOSE = aVar;
            C0533b c0533b = new C0533b("STRICT", 1);
            STRICT = c0533b;
            c cVar = new c("LAZY", 2);
            LAZY = cVar;
            $VALUES = new b[]{aVar, c0533b, cVar};
        }
    ...
    public static Object b(CodedInputStream codedInputStream, FieldType fieldType, b bVar) throws IOException {
        switch (a.f10967a[fieldType.ordinal()]) {
            case 1:
