...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static final class g {
        ...
        public final CodedOutputStream f10943a;
        public final byte[] b;
        ...
        public g(int i) {
            ...
            this.b = bArr;
            this.f10943a = CodedOutputStream.newInstance(bArr);
        }
    }
    ...
    public static class i extends h {
        ...
        public final boolean isValidUtf8() {
            ...
            return v0.u(this.bytes, offsetIntoBytes, size() + offsetIntoBytes);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.ByteString
        public final CodedInputStream newCodedInput() {
            return CodedInputStream.c(this.bytes, getOffsetIntoBytes(), size(), true);
        }
        ...
        public final int partialIsValidUtf8(int i, int i2, int i3) {
            int offsetIntoBytes = getOffsetIntoBytes() + i2;
            return v0.w(i, this.bytes, offsetIntoBytes, i3 + offsetIntoBytes);
        }
    ...
    static {
        byteArrayCopier = com.google.crypto.tink.shaded.protobuf.b.c() ? new j(null) : new d(null);
    ...
    public static ByteString copyFromUtf8(String str) {
        return new i(str.getBytes(Internal.f10957a));
    }
    ...
    public final ByteString concat(ByteString byteString) {
        if (Integer.MAX_VALUE - size() >= byteString.size()) {
            return m0.concatenate(this, byteString);
        }
    ...
    public final String toStringUtf8() {
        return toString(Internal.f10957a);
    }
    ...
    public static final class Output extends OutputStream {
        ...
        public final int h;
        public final ArrayList<ByteString> i;
        public int j;
        public byte[] k;
        public int l;
        ...
        public synchronized ByteString toByteString() {
            c();
            return ByteString.copyFrom(this.i);
        }
        ...
        public void writeTo(OutputStream outputStream) throws IOException {
            ...
            int i;
            synchronized (this) {
                ArrayList<ByteString> arrayList = this.i;
