...
public class MotionSpec {
    ...
    public final SimpleArrayMap<String, MotionTiming> f10207a = new SimpleArrayMap<>();
    public final SimpleArrayMap<String, PropertyValuesHolder[]> b = new SimpleArrayMap<>();

    public static void a(@NonNull MotionSpec motionSpec, Animator animator) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MotionSpec) {
            return this.f10207a.equals(((MotionSpec) obj).f10207a);
        }
        return false;
    }
    ...
    public long getTotalDuration() {
        ...
        long j = 0;
        for (int i = 0; i < size; i++) {
            MotionTiming valueAt = this.f10207a.valueAt(i);
    ...
    public boolean hasTiming(String str) {
        return this.f10207a.get(str) != null;
    }
    ...
    public void setTiming(String str, @Nullable MotionTiming motionTiming) {
        this.f10207a.put(str, motionTiming);
    }

    @NonNull
    public String toString() {
        return '\n' + getClass().getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f10207a + "}\n";
    }
}
