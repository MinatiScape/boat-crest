...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    @StyleRes
    public static final int j = R.style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    @NonNull
    ...
    public void onCreate(Bundle bundle) {
        ...
        getWindow().getDecorView().setOnTouchListener(new InsetDialogOnTouchListener(this, this.i));
    }
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i2, int i3, int i4) {
        ...
        this.i = dialogBackgroundInsets;
        this.h = MaterialDialogs.insetDrawable(materialShapeDrawable, dialogBackgroundInsets);
    }
}
