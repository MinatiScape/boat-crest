...
public class FlowLayout extends ViewGroup {
    ...
    public final void b(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.h = obtainStyledAttributes.getDimensionPixelSize(R.styleable.FlowLayout_lineSpacing, 0);
        this.i = obtainStyledAttributes.getDimensionPixelSize(R.styleable.FlowLayout_itemSpacing, 0);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (!this.j && measuredWidth > i7) {
                    i9 = this.h + paddingTop;
                    this.k++;
                    i8 = paddingRight;
                }
                childAt.setTag(R.id.row_index_key, Integer.valueOf(this.k - 1));
                int i11 = i8 + i6;
                ...
                i8 += i6 + i5 + childAt.getMeasuredWidth() + this.i;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                paddingLeft = i5 + i3 + i4 + childAt.getMeasuredWidth() + this.i;
