...
public class e {
    ...
    public static final int[] f10219a = {16843848};
    ...
    public static void c(@NonNull View view, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, f10219a, i, i2, new int[0]);
        try {
