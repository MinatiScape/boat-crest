...
public final class d implements MapLifecycleDelegate {

    /* renamed from: a  reason: collision with root package name */
    public final Fragment f10052a;
    ...
    public d(Fragment fragment, IMapFragmentDelegate iMapFragmentDelegate) {
        ...
        this.f10052a = (Fragment) Preconditions.checkNotNull(fragment);
    }
    ...
    public final void getMapAsync(OnMapReadyCallback onMapReadyCallback) {
        try {
            this.b.getMapAsync(new c(this, onMapReadyCallback));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        try {
            Bundle bundle2 = new Bundle();
            zzbz.zzb(bundle, bundle2);
            Bundle arguments = this.f10052a.getArguments();
