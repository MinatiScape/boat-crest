...
public class SignInClientImpl extends GmsClient<zaf> implements com.google.android.gms.signin.zae {
    ...
    public final Bundle getGetServiceRequestExtraArgs() {
        if (!getContext().getPackageName().equals(this.N.getRealClientPackageName())) {
            this.O.putString("com.google.android.gms.signin.internal.realClientPackageName", this.N.getRealClientPackageName());
        }
        return this.O;
    }
    ...
    public final void zaa() {
        try {
            ((zaf) getService()).zae(((Integer) Preconditions.checkNotNull(this.P)).intValue());
    ...
    public final void zac(@NonNull IAccountAccessor iAccountAccessor, boolean z) {
        try {
            ((zaf) getService()).zaf(iAccountAccessor, ((Integer) Preconditions.checkNotNull(this.P)).intValue(), z);
        } catch (RemoteException unused) {
    ...
    public final void zad(zae zaeVar) {
        ...
        try {
            Account accountOrDefault = this.N.getAccountOrDefault();
            ((zaf) getService()).zag(new zai(1, new zat(accountOrDefault, ((Integer) Preconditions.checkNotNull(this.P)).intValue(), "<<default account>>".equals(accountOrDefault.name) ? Storage.getInstance(getContext()).getSavedDefaultGoogleSignInAccount() : null)), zaeVar);
