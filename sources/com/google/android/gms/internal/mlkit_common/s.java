...
public final class s implements ObjectEncoderContext {
    ...
    static {
        ...
        zzbkVar.zza(1);
        g = builder.withProperty(zzbkVar.zzb()).build();
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder("value");
        zzbk zzbkVar2 = new zzbk();
        zzbkVar2.zza(2);
        h = builder2.withProperty(zzbkVar2.zzb()).build();
        i = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_common.zzbp
            @Override // com.google.firebase.encoders.ObjectEncoder
            public final void encode(Object obj, Object obj2) {
                s.g((Map.Entry) obj, (ObjectEncoderContext) obj2);
            }
        };
    }

    public s(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    public static zzbo j(FieldDescriptor fieldDescriptor) {
        zzbo zzboVar = (zzbo) fieldDescriptor.getProperty(zzbo.class);
        if (zzboVar != null) {
            return zzboVar;
        }
    ...
    public final ObjectEncoderContext a(@NonNull FieldDescriptor fieldDescriptor, double d, boolean z) throws IOException {
        ...
        this.f9276a.write(m(8).putDouble(d).array());
        return this;
    }
    ...
    public final ObjectEncoderContext b(@NonNull FieldDescriptor fieldDescriptor, float f2, boolean z) throws IOException {
        ...
        this.f9276a.write(m(4).putFloat(f2).array());
        return this;
    }
    ...
    public final ObjectEncoderContext c(@NonNull FieldDescriptor fieldDescriptor, @Nullable Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                d(fieldDescriptor, ((zzbm) obj).zza(), true);
                return this;
    ...
    public final s d(@NonNull FieldDescriptor fieldDescriptor, int i2, boolean z) throws IOException {
        if (z && i2 == 0) {
            return this;
        }
        zzbo j = j(fieldDescriptor);
        ...
        if (ordinal == 0) {
            ...
            n((j.zza() << 3) | 5);
            this.f9276a.write(m(4).putInt(i2).array());
        }
        return this;
    }

    public final s e(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzbo j2 = j(fieldDescriptor);
        zzbn zzbnVar = zzbn.DEFAULT;
        ...
        if (ordinal == 0) {
            ...
            n((j2.zza() << 3) | 1);
            this.f9276a.write(m(8).putLong(j).array());
        }
        return this;
    }

    public final s f(@Nullable Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.b.get(obj.getClass());
    ...
    public final s k(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    public final s l(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    public final void n(int i2) throws IOException {
        while ((i2 & WristbandManager.SYNC_STATE_FAILED_UNKNOWN) != 0) {
            this.f9276a.write((i2 & 127) | 128);
            i2 >>>= 7;
        }
        this.f9276a.write(i2 & 127);
    }
    ...
    public final void o(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.f9276a.write((((int) j) & 127) | 128);
            j >>>= 7;
        }
