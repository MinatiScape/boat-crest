...
public final class zzaj extends zzj<zzbw> {
    public static final Api<Api.ApiOptions.NoOptions> API;
    public static final zzf.zza M = zzf.zza.FIT_RECORDING;
    public static final Api.ClientKey<zzaj> N;
    public static final Api<Api.ApiOptions.HasGoogleSignInAccountOptions> zzoz;

    static {
        Api.ClientKey<zzaj> clientKey = new Api.ClientKey<>();
        N = clientKey;
        API = new Api<>("Fitness.RECORDING_API", new j(), clientKey);
        zzoz = new Api<>("Fitness.RECORDING_CLIENT", new l(), clientKey);
    }

    public zzaj(Context context, Looper looper, ClientSettings clientSettings, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
