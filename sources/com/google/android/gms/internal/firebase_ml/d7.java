...
public final class d7 extends u5<Long> implements zzxl<Long>, v7 {
    public static final d7 k;
    public long[] i;
    public int j;

    static {
        d7 d7Var = new d7(new long[0], 0);
        k = d7Var;
        d7Var.zztm();
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(d7Var.i, 0, this.i, this.j, d7Var.j);
            this.j = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final /* synthetic */ zzxl<Long> zzcv(int i) {
        if (i >= this.j) {
            return new d7(Arrays.copyOf(this.i, i), this.j);
        }
        throw new IllegalArgumentException();
    }

    public d7(long[] jArr, int i) {
        this.i = jArr;
        this.j = i;
    }
