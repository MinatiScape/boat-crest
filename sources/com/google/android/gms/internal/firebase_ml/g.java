...
public final class g {
    public static void a(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzxk {
    ...
    public static void b(byte b, byte b2, byte b3, char[] cArr, int i) throws zzxk {
    ...
    public static void c(byte b, byte b2, char[] cArr, int i) throws zzxk {
        if (b >= -62 && !l(b2)) {
