...
public final class zzwc extends AbstractSafeParcelable {
    ...
    public zzwc(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) int i3, @SafeParcelable.Param(id = 4) int i4, @SafeParcelable.Param(id = 5) long j) {
        this.h = i;
        this.i = i2;
        this.j = i3;
        this.k = i4;
