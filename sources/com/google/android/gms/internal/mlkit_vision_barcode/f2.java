...
public final class f2 implements ObjectEncoderContext {
    ...
    public OutputStream f9395a;
    public final Map b;
    public final Map c;
    public final ObjectEncoder d;
    public final g2 e = new g2(this);

    static {
        FieldDescriptor.Builder builder = FieldDescriptor.builder(Constants.KEY_KEY);
        zzfc zzfcVar = new zzfc();
        zzfcVar.zza(1);
        g = builder.withProperty(zzfcVar.zzb()).build();
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder("value");
        zzfc zzfcVar2 = new zzfc();
        zzfcVar2.zza(2);
        h = builder2.withProperty(zzfcVar2.zzb()).build();
        i = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzfh
            @Override // com.google.firebase.encoders.ObjectEncoder
            public final void encode(Object obj, Object obj2) {
                f2.g((Map.Entry) obj, (ObjectEncoderContext) obj2);
            }
        };
    }

    public f2(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
        this.f9395a = outputStream;
        this.b = map;
        this.c = map2;
    ...
    public static zzfg j(FieldDescriptor fieldDescriptor) {
        zzfg zzfgVar = (zzfg) fieldDescriptor.getProperty(zzfg.class);
        if (zzfgVar != null) {
            return zzfgVar;
        }
    ...
    public final ObjectEncoderContext a(@NonNull FieldDescriptor fieldDescriptor, double d, boolean z) throws IOException {
        ...
        this.f9395a.write(m(8).putDouble(d).array());
        return this;
    }
    ...
    public final ObjectEncoderContext b(@NonNull FieldDescriptor fieldDescriptor, float f2, boolean z) throws IOException {
        ...
        this.f9395a.write(m(4).putFloat(f2).array());
        return this;
    }
    ...
    public final ObjectEncoderContext c(@NonNull FieldDescriptor fieldDescriptor, @Nullable Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                d(fieldDescriptor, ((zzfe) obj).zza(), true);
                return this;
    ...
    public final f2 d(@NonNull FieldDescriptor fieldDescriptor, int i2, boolean z) throws IOException {
        if (z && i2 == 0) {
            return this;
        }
        zzfg j = j(fieldDescriptor);
        ...
        if (ordinal == 0) {
            ...
            n((j.zza() << 3) | 5);
            this.f9395a.write(m(4).putInt(i2).array());
        }
        return this;
    }

    public final f2 e(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzfg j2 = j(fieldDescriptor);
        zzff zzffVar = zzff.DEFAULT;
        ...
        if (ordinal == 0) {
            ...
            n((j2.zza() << 3) | 1);
            this.f9395a.write(m(8).putLong(j).array());
        }
        return this;
    }

    public final f2 f(@Nullable Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.b.get(obj.getClass());
    ...
    public final long i(ObjectEncoder objectEncoder, Object obj) throws IOException {
        e2 e2Var = new e2();
        try {
            OutputStream outputStream = this.f9395a;
            this.f9395a = e2Var;
            objectEncoder.encode(obj, this);
            this.f9395a = outputStream;
            long a2 = e2Var.a();
    ...
    public final f2 k(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    public final f2 l(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    public final void n(int i2) throws IOException {
        while ((i2 & WristbandManager.SYNC_STATE_FAILED_UNKNOWN) != 0) {
            this.f9395a.write((i2 & 127) | 128);
            i2 >>>= 7;
        }
        this.f9395a.write(i2 & 127);
    }
    ...
    public final void o(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.f9395a.write((((int) j) & 127) | 128);
            j >>>= 7;
        }
        this.f9395a.write(((int) j) & 127);
    }
