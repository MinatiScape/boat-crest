...
public final class zzbp extends GoogleApi implements FusedLocationProviderClient {
    ...
    static {
        ...
        j = clientKey;
        zzb = new Api("LocationServices.API", new o(), clientKey);
    }
    ...
    public final Task c(final LocationRequest locationRequest, ListenerHolder listenerHolder) {
        final q qVar = new q(this, listenerHolder, new p() { // from class: com.google.android.gms.internal.location.zzax
        ...
        return doRegisterEventListener(RegistrationMethods.builder().register(new RemoteCall() { // from class: com.google.android.gms.internal.location.zzay
            ...
            public final void accept(Object obj, Object obj2) {
                Api api = zzbp.zzb;
                ((zzda) obj).zzu(q.this, locationRequest, (TaskCompletionSource) obj2);
            }
        }).unregister(qVar).withHolder(listenerHolder).setMethodKey(2436).build());
    }

    public final Task d(final LocationRequest locationRequest, ListenerHolder listenerHolder) {
        final q qVar = new q(this, listenerHolder, new p() { // from class: com.google.android.gms.internal.location.zzbd
            @Override // com.google.android.gms.internal.location.p
            public final void zza(zzda zzdaVar, ListenerHolder.ListenerKey listenerKey, boolean z, TaskCompletionSource taskCompletionSource) {
        ...
        return doRegisterEventListener(RegistrationMethods.builder().register(new RemoteCall() { // from class: com.google.android.gms.internal.location.zzbf
            ...
            public final void accept(Object obj, Object obj2) {
                Api api = zzbp.zzb;
                ((zzda) obj).zzv(q.this, locationRequest, (TaskCompletionSource) obj2);
            }
        }).unregister(qVar).withHolder(listenerHolder).setMethodKey(2435).build());
    }
    ...
    public final Task<Void> requestLocationUpdates(LocationRequest locationRequest, LocationCallback locationCallback, @Nullable Looper looper) {
        ...
        return c(locationRequest, ListenerHolders.createListenerHolder(locationCallback, looper, LocationCallback.class.getSimpleName()));
    }
    ...
    public final Task<Void> requestLocationUpdates(LocationRequest locationRequest, LocationListener locationListener, @Nullable Looper looper) {
        ...
        return d(locationRequest, ListenerHolders.createListenerHolder(locationListener, looper, LocationListener.class.getSimpleName()));
    }
    ...
    public final Task<Void> requestLocationUpdates(LocationRequest locationRequest, Executor executor, LocationCallback locationCallback) {
        return c(locationRequest, ListenerHolders.createListenerHolder(locationCallback, executor, LocationCallback.class.getSimpleName()));
    }
    ...
    public final Task<Void> requestLocationUpdates(LocationRequest locationRequest, Executor executor, LocationListener locationListener) {
        return d(locationRequest, ListenerHolders.createListenerHolder(locationListener, executor, LocationListener.class.getSimpleName()));
    }
}
