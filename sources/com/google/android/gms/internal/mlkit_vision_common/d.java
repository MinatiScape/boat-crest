...
public final class d implements ObjectEncoderContext {
    ...
    static {
        ...
        zzaeVar.zza(1);
        g = builder.withProperty(zzaeVar.zzb()).build();
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder("value");
        zzae zzaeVar2 = new zzae();
        zzaeVar2.zza(2);
        h = builder2.withProperty(zzaeVar2.zzb()).build();
        i = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_common.zzaj
    ...
    public static zzai j(FieldDescriptor fieldDescriptor) {
        zzai zzaiVar = (zzai) fieldDescriptor.getProperty(zzai.class);
        if (zzaiVar != null) {
            return zzaiVar;
        }
    ...
    public final ObjectEncoderContext a(@NonNull FieldDescriptor fieldDescriptor, double d, boolean z) throws IOException {
        ...
        this.f9651a.write(m(8).putDouble(d).array());
        return this;
    }
    ...
    public final ObjectEncoderContext b(@NonNull FieldDescriptor fieldDescriptor, float f2, boolean z) throws IOException {
        ...
        this.f9651a.write(m(4).putFloat(f2).array());
        return this;
    }
    ...
    public final d d(@NonNull FieldDescriptor fieldDescriptor, int i2, boolean z) throws IOException {
        ...
        if (ordinal == 0) {
            ...
            n((j.zza() << 3) | 5);
            this.f9651a.write(m(4).putInt(i2).array());
        }
        return this;
    }
    ...
    public final d e(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        ...
        if (ordinal == 0) {
            ...
            n((j2.zza() << 3) | 1);
            this.f9651a.write(m(8).putLong(j).array());
        }
        return this;
    }
    ...
    public final void n(int i2) throws IOException {
        while ((i2 & WristbandManager.SYNC_STATE_FAILED_UNKNOWN) != 0) {
            this.f9651a.write((i2 & 127) | 128);
            i2 >>>= 7;
        }
        this.f9651a.write(i2 & 127);
    }
    ...
    public final void o(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.f9651a.write((((int) j) & 127) | 128);
            j >>>= 7;
        }
        this.f9651a.write(((int) j) & 127);
    }
