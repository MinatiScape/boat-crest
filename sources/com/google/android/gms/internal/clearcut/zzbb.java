...
public abstract class zzbb implements Serializable, Iterable<Byte> {
    public static final zzbb zzfi = new w(zzci.zzkt);
    private static final t zzfj;
    private int zzfk = 0;

    static {
        zzfj = m.b() ? new x(null) : new r(null);
    }
    ...
    public static zzbb zzb(byte[] bArr, int i, int i2) {
        return new w(zzfj.a(bArr, i, i2));
    }

    public static zzbb zzf(String str) {
        return new w(str.getBytes(zzci.f8618a));
    }

    public static u zzk(int i) {
        return new u(i, null);
    }
