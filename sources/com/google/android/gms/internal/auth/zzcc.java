...
public final class zzcc {
    ...
    public static UserManager f8552a;
    public static volatile boolean b = !zzb();
    ...
    */
    public static boolean zza(android.content.Context r8) {
        ...
        Lc:
            ...
            monitor-enter(r0)
            boolean r2 = com.google.android.gms.internal.auth.zzcc.b     // Catch: java.lang.Throwable -> L5b
            if (r2 == 0) goto L15
        ...
        L17:
            ...
            r5 = 0
            if (r3 > r4) goto L4e
            android.os.UserManager r4 = com.google.android.gms.internal.auth.zzcc.f8552a     // Catch: java.lang.Throwable -> L5b
            if (r4 != 0) goto L29
            ...
            com.google.android.gms.internal.auth.zzcc.f8552a = r4     // Catch: java.lang.Throwable -> L5b
        L29:
            android.os.UserManager r4 = com.google.android.gms.internal.auth.zzcc.f8552a     // Catch: java.lang.Throwable -> L5b
            if (r4 != 0) goto L2f
            r8 = r2
        ...
        L41:
            ...
            com.google.android.gms.internal.auth.zzcc.f8552a = r5     // Catch: java.lang.Throwable -> L5b
            int r3 = r3 + 1
            goto L17
        L4e:
            r8 = r1
        ...
        L53:
            if (r8 == 0) goto L57
            com.google.android.gms.internal.auth.zzcc.b = r2     // Catch: java.lang.Throwable -> L5b
        L57:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L5b
            if (r8 != 0) goto L5e
            return r2
