...
public class j2 extends AbstractMap {
    ...
    public final Iterable d() {
        return this.j.isEmpty() ? f2.a() : this.j.entrySet();
    }

    @Override // java.util.AbstractMap, java.util.Map
    public final Set entrySet() {
        if (this.l == null) {
            this.l = new i2(this, null);
        }
        return this.l;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (b == j2Var.b()) {
            for (int i = 0; i < b; i++) {
                if (!h(i).equals(j2Var.h(i))) {
                    return false;
                }
            }
            if (b != size) {
                return this.j.equals(j2Var.j);
            }
            return true;
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int l = l(comparable);
        if (l >= 0) {
            return ((g2) this.i.get(l)).setValue(obj);
        }
        o();
        ...
        int i2 = this.h;
        if (size == i2) {
            g2 g2Var = (g2) this.i.remove(i2 - 1);
            n().put(g2Var.a(), g2Var.getValue());
        }
        this.i.add(i, new g2(this, comparable, obj));
        return null;
    }
    ...
    public final Object get(Object obj) {
        ...
        int l = l(comparable);
        if (l >= 0) {
            return ((g2) this.i.get(l)).getValue();
        }
    ...
    public final int l(Comparable comparable) {
        ...
        int i = 0;
        if (size >= 0) {
            int compareTo = comparable.compareTo(((g2) this.i.get(size)).a());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((g2) this.i.get(i2)).a());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object m(int i) {
        o();
        Object value = ((g2) this.i.remove(i)).getValue();
        if (!this.j.isEmpty()) {
