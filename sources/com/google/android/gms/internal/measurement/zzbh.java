...
public final class zzbh extends zzaw {
    public zzbh() {
        this.f8941a.add(zzbl.FOR_IN);
        this.f8941a.add(zzbl.FOR_IN_CONST);
        this.f8941a.add(zzbl.FOR_IN_LET);
        this.f8941a.add(zzbl.FOR_LET);
        this.f8941a.add(zzbl.FOR_OF);
        this.f8941a.add(zzbl.FOR_OF_CONST);
        this.f8941a.add(zzbl.FOR_OF_LET);
        this.f8941a.add(zzbl.WHILE);
    }

    public static zzap b(i iVar, Iterator<zzap> it, zzap zzapVar) {
        if (it != null) {
            while (it.hasNext()) {
                zzap zzc = iVar.a(it.next()).zzc((zzae) zzapVar);
                if (zzc instanceof zzag) {
                    zzag zzagVar = (zzag) zzc;
                    if (com.ido.ble.event.stat.one.d.p.equals(zzagVar.zzc())) {
                        return zzap.zzf;
                    }
    ...
    public static zzap c(i iVar, zzap zzapVar, zzap zzapVar2) {
        return b(iVar, zzapVar.zzl(), zzapVar2);
    }

    public static zzap d(i iVar, zzap zzapVar, zzap zzapVar2) {
        if (zzapVar instanceof Iterable) {
            return b(iVar, ((Iterable) zzapVar).iterator(), zzapVar2);
        }
    ...
    public final zzap zza(String str, zzg zzgVar, List<zzap> list) {
            ...
            switch (ordinal) {
                case 26:
                    ...
                    if (list.get(0) instanceof zzat) {
                        return c(new j(zzgVar, list.get(0).zzi()), zzgVar.zzb(list.get(1)), zzgVar.zzb(list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_IN must be a string");
                case 27:
                    zzh.zzh(zzbl.FOR_IN_CONST.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return c(new g(zzgVar, list.get(0).zzi()), zzgVar.zzb(list.get(1)), zzgVar.zzb(list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_IN_CONST must be a string");
                case 28:
                    zzh.zzh(zzbl.FOR_IN_LET.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return c(new h(zzgVar, list.get(0).zzi()), zzgVar.zzb(list.get(1)), zzgVar.zzb(list.get(2)));
                    }
                ...
                case 30:
                    ...
                    if (list.get(0) instanceof zzat) {
                        return d(new j(zzgVar, list.get(0).zzi()), zzgVar.zzb(list.get(1)), zzgVar.zzb(list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_OF must be a string");
                case 31:
                    zzh.zzh(zzbl.FOR_OF_CONST.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return d(new g(zzgVar, list.get(0).zzi()), zzgVar.zzb(list.get(1)), zzgVar.zzb(list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_OF_CONST must be a string");
                case 32:
                    zzh.zzh(zzbl.FOR_OF_LET.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return d(new h(zzgVar, list.get(0).zzi()), zzgVar.zzb(list.get(1)), zzgVar.zzb(list.get(2)));
                    }
        ...
        if (zzgVar.zzb(list.get(2)).zzg().booleanValue()) {
            ...
            if (zzc2 instanceof zzag) {
                ...
                if (com.ido.ble.event.stat.one.d.p.equals(zzagVar2.zzc())) {
                    return zzap.zzf;
                }
        ...
        while (zzgVar.zzb(zzapVar3).zzg().booleanValue()) {
            ...
            if (zzc3 instanceof zzag) {
                ...
                if (com.ido.ble.event.stat.one.d.p.equals(zzagVar3.zzc())) {
                    return zzap.zzf;
                }
