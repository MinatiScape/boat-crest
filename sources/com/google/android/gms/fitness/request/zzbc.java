...
public final class zzbc extends AbstractSafeParcelable {
    ...
    public zzbc(@SafeParcelable.Param(id = 1) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(id = 2) IBinder iBinder) {
    ...
    public final boolean equals(@Nullable Object obj) {
        if (this != obj) {
            return (obj instanceof zzbc) && Objects.equal(this.h, ((zzbc) obj).h);
        }
        return true;
    }
