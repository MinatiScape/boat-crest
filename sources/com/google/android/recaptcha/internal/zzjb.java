...
interface zzjb {
    ...
    @Deprecated
    void zzC(List list, zzjc zzjcVar, zzgq zzgqVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzjc zzjcVar, zzgq zzgqVar) throws IOException;
    ...
    zzfi zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzjc zzjcVar, zzgq zzgqVar) throws IOException;

    void zzu(Object obj, zzjc zzjcVar, zzgq zzgqVar) throws IOException;
