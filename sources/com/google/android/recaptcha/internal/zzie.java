...
final class zzie extends zzet implements RandomAccess, zzix {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzieVar.zzb, 0, this.zzb, this.zzc, zzieVar.zzc);
            this.zzc = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzie) {
            ...
            if (this.zzc != zzieVar.zzc) {
                return false;
            }
            long[] jArr = zzieVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzhm zzd(int i) {
        if (i >= this.zzc) {
            return new zzie(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzie(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
