...
public final class zzkg {
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzkf zzkfVar = zzf;
        long j2 = (-4) & j;
        int i = zzkfVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzkfVar.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzkfVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzkfVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzkg.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
