...
public class zzjp extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzjj) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object zzl(int i) {
        zzn();
        Object value = ((zzjj) this.zzb.remove(i)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzjp) {
            ...
            if (zzb == zzjpVar.zzb()) {
                for (int i = 0; i < zzb; i++) {
                    if (!zzg(i).equals(zzjpVar.zzg(i))) {
                        return false;
                    }
                }
                if (zzb != size) {
                    return this.zzc.equals(zzjpVar.zzc);
                }
                return true;
            }
            return entrySet().equals(zzjpVar.entrySet());
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb; i2++) {
            i += ((zzjj) this.zzb.get(i2)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzjj zzjjVar = (zzjj) this.zzb.remove(i2 - 1);
            zzm().put(zzjjVar.zza(), zzjjVar.getValue());
        }
        this.zzb.add(i, new zzjj(this, comparable, obj));
        return null;
    }
