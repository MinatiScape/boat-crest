...
final class zzgx extends zzet implements RandomAccess, zzix {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgxVar.zzb, 0, this.zzb, this.zzc, zzgxVar.zzc);
            this.zzc = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzgx) {
            ...
            if (this.zzc != zzgxVar.zzc) {
                return false;
            }
            float[] fArr = zzgxVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzhm zzd(int i) {
        if (i >= this.zzc) {
            return new zzgx(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzgx(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
