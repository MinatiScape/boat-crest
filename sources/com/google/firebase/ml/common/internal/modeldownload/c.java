...
public final class c implements zzk {

    /* renamed from: a  reason: collision with root package name */
    public final zzqf f11378a;
    public final String b;

    public c(@NonNull zzqf zzqfVar, @NonNull String str) {
        this.f11378a = zzqfVar;
        this.b = str;
    }
    ...
    public final File zza(File file) throws FirebaseMLException {
        ...
        File c = new zzi(this.f11378a).c(this.b, zzn.TRANSLATE);
