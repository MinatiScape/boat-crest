...
public interface IObjectDetector extends IInterface {
    ...
    public static abstract class zza extends com.google.android.gms.internal.firebase_ml.zza implements IObjectDetector {
        ...
        public final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                zzj[] zzc = zzc(IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()), (zzsb) com.google.android.gms.internal.firebase_ml.zzd.zza(parcel, zzsb.CREATOR));
    ...
    zzj[] zzc(IObjectWrapper iObjectWrapper, zzsb zzsbVar) throws RemoteException;
}
