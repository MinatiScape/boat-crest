...
public final class FirebaseAnalytics {
    ...
    @Nullable
    @Keep
    public static zzhw getScionFrontendApiImplementation(Context context, @Nullable Bundle bundle) {
    ...
    public Task<String> getAppInstanceId() {
        ...
        try {
            ...
            this.f11075a.zzA(5, "Failed to schedule task for getAppInstanceId", null, null, null);
    ...
    public void setAnalyticsCollectionEnabled(boolean z) {
        this.f11075a.zzK(Boolean.valueOf(z));
    }
