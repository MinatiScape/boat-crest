...
public class QRCodeReader implements Reader {
                ...
                if (round2 == round) {
                    ...
                    for (int i11 = 0; i11 < round2; i11++) {
                        ...
                        for (int i13 = 0; i13 < round; i13++) {
                            if (bitMatrix.get(((int) (i13 * b2)) + i8, i12)) {
    ...
    public static float b(int[] iArr, BitMatrix bitMatrix) throws NotFoundException {
    ...
    public final Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (map != null && map.containsKey(DecodeHintType.PURE_BARCODE)) {
            decoderResult = this.f11868a.decode(a(binaryBitmap.getBlackMatrix()), map);
            points = b;
        } else {
            DetectorResult detect = new Detector(binaryBitmap.getBlackMatrix()).detect(map);
            DecoderResult decode = this.f11868a.decode(detect.getBits(), map);
