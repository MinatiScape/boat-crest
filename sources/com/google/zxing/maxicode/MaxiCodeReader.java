...
public final class MaxiCodeReader implements Reader {
    ...
    public final Decoder f11812a = new Decoder();
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        DecoderResult decode = this.f11812a.decode(a(binaryBitmap.getBlackMatrix()), map);
        Result result = new Result(decode.getText(), decode.getRawBytes(), b, BarcodeFormat.MAXICODE);
