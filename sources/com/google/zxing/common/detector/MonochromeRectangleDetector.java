...
public final class MonochromeRectangleDetector {
    ...
    public final BitMatrix f11792a;

    public MonochromeRectangleDetector(BitMatrix bitMatrix) {
        this.f11792a = bitMatrix;
    }
    ...
    */
    public final int[] a(int r6, int r7, int r8, int r9, boolean r10) {
        ...
        L5:
            if (r2 < r8) goto L3a
            com.google.zxing.common.BitMatrix r3 = r5.f11792a
            if (r10 == 0) goto L12
        ...
        L1c:
            int r3 = r3 + (-1)
            if (r3 < r8) goto L31
            com.google.zxing.common.BitMatrix r4 = r5.f11792a
            if (r10 == 0) goto L2b
    ...
    public final ResultPoint b(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) throws NotFoundException {
        ...
        while (i11 < i8 && i11 >= i7 && i10 < i4 && i10 >= i3) {
            if (i2 == 0) {
                a2 = a(i11, i9, i3, i4, true);
            } else {
                a2 = a(i10, i9, i7, i8, false);
            }
            if (a2 == null) {
                if (iArr != null) {
                    if (i2 == 0) {
    ...
    public ResultPoint[] detect() throws NotFoundException {
        int height = this.f11792a.getHeight();
        int width = this.f11792a.getWidth();
        int i = height / 2;
        int i2 = width / 2;
