...
public final class StringUtils {
    ...
    static {
        ...
        f11791a = name;
        b = SHIFT_JIS.equalsIgnoreCase(name) || "EUC_JP".equalsIgnoreCase(name);
    }
    ...
    public static String guessEncoding(byte[] bArr, Map<DecodeHintType, ?> map) {
        ...
        return (!z4 || (!z2 && (i6 + i7) + i8 <= 0)) ? (!z3 || (!b && i9 < 3 && i < 3)) ? (z && z3) ? (!(i9 == 2 && i2 == 2) && i10 * 10 < length) ? "ISO8859_1" : SHIFT_JIS : z ? "ISO8859_1" : z3 ? SHIFT_JIS : z4 ? "UTF8" : f11791a : SHIFT_JIS : "UTF8";
    }
}
