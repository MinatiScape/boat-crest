...
public final class DataMatrixWriter implements Writer {
    public static BitMatrix a(ByteMatrix byteMatrix, int i, int i2) {
        BitMatrix bitMatrix;
    ...
    public static BitMatrix b(DefaultPlacement defaultPlacement, SymbolInfo symbolInfo, int i, int i2) {
        ...
        if (!str.isEmpty()) {
            if (barcodeFormat == BarcodeFormat.DATA_MATRIX) {
                if (i >= 0 && i2 >= 0) {
                    ...
                    return b(defaultPlacement, lookup, i, i2);
                }
