...
public final class DataMatrixReader implements Reader {
            ...
            if (i4 > 0 && i5 > 0) {
                ...
                for (int i9 = 0; i9 < i5; i9++) {
                    ...
                    for (int i11 = 0; i11 < i4; i11++) {
                        if (bitMatrix.get((i11 * b2) + i8, i10)) {
    ...
    public static int b(int[] iArr, BitMatrix bitMatrix) throws NotFoundException {
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (map != null && map.containsKey(DecodeHintType.PURE_BARCODE)) {
            decoderResult = this.f11798a.decode(a(binaryBitmap.getBlackMatrix()));
            points = b;
        } else {
            DetectorResult detect = new Detector(binaryBitmap.getBlackMatrix()).detect();
            DecoderResult decode = this.f11798a.decode(detect.getBits());
