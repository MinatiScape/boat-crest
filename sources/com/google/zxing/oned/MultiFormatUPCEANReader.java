...
public final class MultiFormatUPCEANReader extends OneDReader {
    ...
    public final UPCEANReader[] f11824a;
    ...
    public MultiFormatUPCEANReader(Map<DecodeHintType, ?> map) {
        ...
        this.f11824a = (UPCEANReader[]) arrayList.toArray(b);
    }

    @Override // com.google.zxing.oned.OneDReader
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        boolean z;
        int[] f = UPCEANReader.f(bitArray);
        for (UPCEANReader uPCEANReader : this.f11824a) {
            try {
                Result decodeRow = uPCEANReader.decodeRow(i, bitArray, f, map);
