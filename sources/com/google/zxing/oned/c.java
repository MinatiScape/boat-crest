...
public final class c {
    ...
    public final int[] f11830a = new int[4];
    ...
    */
    public static java.lang.String e(java.lang.String r5) {
        ...
        L72:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.oned.c.e(java.lang.String):java.lang.String");
    }
    ...
    public static Map<ResultMetadataType, Object> f(String str) {
        ...
        if (str.length() == 5 && (e = e(str)) != null) {
            ...
            enumMap.put((EnumMap) ResultMetadataType.SUGGESTED_PRICE, (ResultMetadataType) e);
            return enumMap;
        }
        return null;
    }
    ...
    public final int a(BitArray bitArray, int[] iArr, StringBuilder sb) throws NotFoundException {
        ...
        for (int i3 = 0; i3 < 5 && i < size; i3++) {
            int c2 = UPCEANReader.c(bitArray, iArr2, i, UPCEANReader.h);
    ...
    public Result b(int i, BitArray bitArray, int[] iArr) throws NotFoundException {
        ...
        Map<ResultMetadataType, Object> f = f(sb2);
        float f2 = i;
        Result result = new Result(sb2, null, new ResultPoint[]{new ResultPoint((iArr[0] + iArr[1]) / 2.0f, f2), new ResultPoint(a2, f2)}, BarcodeFormat.UPC_EAN_EXTENSION);
        if (f != null) {
            result.putAllMetadata(f);
        }
        return result;
    }
}
