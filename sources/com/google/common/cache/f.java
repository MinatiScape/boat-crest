...
public abstract class f extends Number {
    ...
    public static final class b {
        ...
        public volatile long f10546a;

        static {
            try {
                Unsafe access$000 = f.access$000();
                b = access$000;
    ...
    static {
        try {
            ...
            UNSAFE = unsafe;
            baseOffset = unsafe.objectFieldOffset(f.class.getDeclaredField("base"));
            busyOffset = unsafe.objectFieldOffset(f.class.getDeclaredField("busy"));
        } catch (Exception e) {
            throw new Error(e);
        }
    }
    ...
    */
    public final void retryUpdate(long r17, int[] r19, boolean r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.cache.f.retryUpdate(long, int[], boolean):void");
    }
}
