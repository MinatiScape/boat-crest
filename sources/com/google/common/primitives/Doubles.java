...
public final class Doubles extends com.google.common.primitives.a {
    ...
    public static final Pattern f10716a = c();
    ...
    public static class a extends AbstractList<Double> implements RandomAccess, Serializable {
        ...
        public boolean contains(Object obj) {
            return (obj instanceof Double) && Doubles.d(this.array, ((Double) obj).doubleValue(), this.start, this.end) != -1;
        }
    ...
    public static Double tryParse(String str) {
        if (f10716a.matcher(str).matches()) {
            try {
