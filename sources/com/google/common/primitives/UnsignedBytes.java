...
public final class UnsignedBytes {
    ...
    public static class a {
        ...
        public static final String f10722a = a.class.getName().concat("$UnsafeComparator");
        ...
        /* loaded from: classes10.dex */
        public enum EnumC0514a implements Comparator<byte[]> {
            INSTANCE;
        ...
        public static Comparator<byte[]> a() {
            try {
                return (Comparator) Class.forName(f10722a).getEnumConstants()[0];
