...
public final class ImmutableLongArray implements Serializable {
    ...
    public static final class Builder {
        ...
        public final void a(int i) {
            int i2 = this.b + i;
            long[] jArr = this.f10719a;
            if (i2 > jArr.length) {
                this.f10719a = Arrays.copyOf(jArr, b(jArr.length, i2));
            }
        }
        ...
        public Builder addAll(long[] jArr) {
            a(jArr.length);
            System.arraycopy(jArr, 0, this.f10719a, this.b, jArr.length);
            this.b += jArr.length;
            return this;
        }
        ...
        public ImmutableLongArray build() {
            return this.b == 0 ? ImmutableLongArray.EMPTY : new ImmutableLongArray(this.f10719a, 0, this.b);
        }
        ...
        public Builder addAll(ImmutableLongArray immutableLongArray) {
            ...
            System.arraycopy(immutableLongArray.array, immutableLongArray.start, this.f10719a, this.b, immutableLongArray.length());
