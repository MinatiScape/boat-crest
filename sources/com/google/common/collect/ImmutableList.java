...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
    private static final UnmodifiableListIterator<Object> EMPTY_ITR = new a(v1.EMPTY, 0);
    ...
    public static final class Builder<E> extends ImmutableCollection.a<E> {
        ...
        public ImmutableList<E> build() {
            this.c = true;
            return ImmutableList.asImmutableList(this.f10551a, this.b);
        }
    ...
    /* loaded from: classes10.dex */
    public static class a<E> extends com.google.common.collect.b<E> {
    ...
    public static <E> ImmutableList<E> of() {
        return (ImmutableList<E>) v1.EMPTY;
    }
