...
public final class k2 {
    ...
    public static class b<E> extends a<E> implements NavigableSet<E> {
        ...
        public E ceiling(E e) {
            return (E) k2.c(a().tailMultiset(e, BoundType.CLOSED).firstEntry());
        }
        ...
        @Override // java.util.NavigableSet
        public E floor(E e) {
            return (E) k2.c(a().headMultiset(e, BoundType.CLOSED).lastEntry());
        }
        ...
        @Override // java.util.NavigableSet
        public E higher(E e) {
            return (E) k2.c(a().tailMultiset(e, BoundType.OPEN).firstEntry());
        }

        @Override // java.util.NavigableSet
        public E lower(E e) {
            return (E) k2.c(a().headMultiset(e, BoundType.OPEN).lastEntry());
        }

        @Override // java.util.NavigableSet
        public E pollFirst() {
            return (E) k2.c(a().pollFirstEntry());
        }

        @Override // java.util.NavigableSet
        public E pollLast() {
            return (E) k2.c(a().pollLastEntry());
        }
