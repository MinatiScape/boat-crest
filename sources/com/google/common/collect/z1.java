...
public final class z1<E> extends ImmutableSortedMultiset<E> {
    ...
    @VisibleForTesting
    public final transient a2<E> elementSet;
    private final transient int length;
    private final transient int offset;
    private static final long[] ZERO_CUMULATIVE_COUNTS = {0};
    public static final ImmutableSortedMultiset<Comparable> NATURAL_EMPTY_MULTISET = new z1(Ordering.natural());
    ...
    public ImmutableSortedMultiset<E> getSubMultiset(int i, int i2) {
        ...
        return (i == 0 && i2 == this.length) ? this : new z1(this.elementSet.getSubSet(i, i2), this.cumulativeCounts, this.offset + i, i2 - i);
    }
    ...
    public z1(a2<E> a2Var, long[] jArr, int i, int i2) {
