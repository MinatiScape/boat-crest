...
public final class l2<R, C, V> extends b2<R, C, V> {
    public static final ImmutableTable<Object, Object, Object> EMPTY = new l2(ImmutableList.of(), ImmutableSet.of(), ImmutableSet.of());
    ...
    public l2(ImmutableList<Table.Cell<R, C, V>> immutableList, ImmutableSet<R> immutableSet, ImmutableSet<C> immutableSet2) {
    ...
    public ImmutableTable.a createSerializedForm() {
        ImmutableMap u = Maps.u(columnKeySet());
        ...
        return ImmutableTable.a.create(this, this.cellRowIndices, iArr);
    }
