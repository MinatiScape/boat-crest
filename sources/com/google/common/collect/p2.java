...
public final class p2<T> {
    ...
    public p2(Comparator<? super T> comparator, int i) {
    ...
    public static <T> p2<T> a(int i, Comparator<? super T> comparator) {
        return new p2<>(comparator, i);
    }
