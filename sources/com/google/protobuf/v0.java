...
public class v0<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    public final int h;
    public List<v0<K, V>.e> i;
    public Map<K, V> j;
    public boolean k;
    public volatile v0<K, V>.g l;
    public Map<K, V> m;
    public volatile v0<K, V>.c n;
    ...
    public static class d {
        ...
        public static final Iterator<Object> f11756a = new a();
    ...
    public /* synthetic */ v0(int i, a aVar) {
        this(i);
    }

    public static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> v0<FieldDescriptorType, Object> r(int i) {
        return new a(i);
    }
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < l; i++) {
            if (!k(i).equals(v0Var.k(i))) {
                return false;
            }
        }
        if (l != size) {
            return this.j.equals(v0Var.j);
        }
        return true;
    }
    ...
    public V put(K k, V v) {
        ...
        int i2 = this.h;
        if (size == i2) {
            v0<K, V>.e remove = this.i.remove(i2 - 1);
    ...
    public class b implements Iterator<Map.Entry<K, V>> {
        ...
        public b() {
            this.h = v0.this.i.size();
        }

        public final Iterator<Map.Entry<K, V>> a() {
            if (this.i == null) {
                this.i = v0.this.m.entrySet().iterator();
            }
            return this.i;
        }
        ...
        public boolean hasNext() {
            int i = this.h;
            return (i > 0 && i <= v0.this.i.size()) || a().hasNext();
        }
    ...
    public class f implements Iterator<Map.Entry<K, V>> {
        ...
        public final Iterator<Map.Entry<K, V>> a() {
            if (this.j == null) {
                this.j = v0.this.j.entrySet().iterator();
            }
            return this.j;
        }
        ...
        public Map.Entry<K, V> next() {
            ...
            this.h = i;
            if (i < v0.this.i.size()) {
                return (Map.Entry) v0.this.i.get(this.h);
            }
            return a().next();
        }
        ...
        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.h + 1 >= v0.this.i.size()) {
                return !v0.this.j.isEmpty() && a().hasNext();
            }
            return true;
        }
