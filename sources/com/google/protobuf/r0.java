...
public final class r0 extends ByteString {
    ...
    public static final class c implements Iterator<ByteString.h> {
        ...
        public final ByteString.h b() {
            ByteString.h a2;
            do {
                ArrayDeque<r0> arrayDeque = this.h;
        ...
        public c(ByteString byteString) {
            if (byteString instanceof r0) {
                r0 r0Var = (r0) byteString;
                ArrayDeque<r0> arrayDeque = new ArrayDeque<>(r0Var.getTreeDepth());
                this.h = arrayDeque;
    ...
    public /* synthetic */ r0(ByteString byteString, ByteString byteString2, a aVar) {
    ...
    public static ByteString concatenate(ByteString byteString, ByteString byteString2) {
        ...
        if (byteString instanceof r0) {
            r0 r0Var = (r0) byteString;
            if (r0Var.right.size() + byteString2.size() < 128) {
                return new r0(r0Var.left, concatenateBytes(r0Var.right, byteString2));
            } else if (r0Var.left.getTreeDepth() > r0Var.right.getTreeDepth() && r0Var.getTreeDepth() > byteString2.getTreeDepth()) {
                return new r0(r0Var.left, new r0(r0Var.right, byteString2));
            }
        }
        if (size < minLength(Math.max(byteString.getTreeDepth(), byteString2.getTreeDepth()) + 1)) {
            return new b(null).b(byteString, byteString2);
        }
        return new r0(byteString, byteString2);
    }
    ...
    public static r0 newInstanceForTest(ByteString byteString, ByteString byteString2) {
        return new r0(byteString, byteString2);
    }
    ...
    public ByteString substring(int i, int i2) {
        ...
        return new r0(this.left.substring(i), this.right.substring(0, i2 - this.leftLength));
    }
    ...
    public static class b {
        ...
        public final ArrayDeque<ByteString> f11751a;

        public b() {
            this.f11751a = new ArrayDeque<>();
        }

        public final ByteString b(ByteString byteString, ByteString byteString2) {
            c(byteString);
            c(byteString2);
            ByteString pop = this.f11751a.pop();
            while (!this.f11751a.isEmpty()) {
                pop = new r0(this.f11751a.pop(), pop, null);
            }
            return pop;
        }
        ...
        public final void c(ByteString byteString) {
            if (byteString.isBalanced()) {
                e(byteString);
            } else if (byteString instanceof r0) {
                r0 r0Var = (r0) byteString;
                c(r0Var.left);
                c(r0Var.right);
            } else {
        ...
        public final void e(ByteString byteString) {
            ...
            int minLength = r0.minLength(d + 1);
            if (!this.f11751a.isEmpty() && this.f11751a.peek().size() < minLength) {
                int minLength2 = r0.minLength(d);
                ByteString pop = this.f11751a.pop();
                while (!this.f11751a.isEmpty() && this.f11751a.peek().size() < minLength2) {
                    pop = new r0(this.f11751a.pop(), pop, null);
                }
                r0 r0Var = new r0(pop, byteString, null);
                while (!this.f11751a.isEmpty()) {
                    if (this.f11751a.peek().size() >= r0.minLength(d(r0Var.size()) + 1)) {
                        break;
                    }
                    r0Var = new r0(this.f11751a.pop(), r0Var, null);
                }
                this.f11751a.push(r0Var);
                return;
            }
            this.f11751a.push(byteString);
        }
    ...
    private r0(ByteString byteString, ByteString byteString2) {
    ...
    public class d extends InputStream {
        ...
        public final int b() {
            return r0.this.size() - (this.l + this.k);
        }
