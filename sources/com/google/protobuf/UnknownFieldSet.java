...
public final class UnknownFieldSet implements MessageLite {
    ...
    public static final class Field {
        ...
        public ByteString toByteString(int i) {
            try {
                ByteString.g newCodedBuilder = ByteString.newCodedBuilder(getSerializedSize(i));
                writeTo(i, newCodedBuilder.b());
        ...
        public void writeTo(int i, Writer writer) throws IOException {
            writer.F(i, this.varint, false);
            writer.j(i, this.fixed32, false);
            writer.y(i, this.fixed64, false);
            writer.I(i, this.lengthDelimited);
