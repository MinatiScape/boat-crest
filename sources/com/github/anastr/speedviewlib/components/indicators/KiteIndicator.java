...
public final class KiteIndicator extends Indicator<KiteIndicator> {
    ...
    public KiteIndicator(@NotNull Context context) {
        super(context);
    ...
    public void updateIndicator() {
        ...
        this.g = (getViewSize() * 0.5f) + speedometer2.getPadding();
        this.f.lineTo(getCenterX() - getWidth(), this.g);
        this.f.lineTo(getCenterX(), this.g + getWidth());
        this.f.lineTo(getCenterX() + getWidth(), this.g);
