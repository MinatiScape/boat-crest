...
public class StandardUUIDsParser {
    ...
    public static final Map<String, String> f13531a;
    ...
    static {
        ...
        hashMap.put("1810", WatchfaceConstants.BP);
        ...
        hashMap.put("180D", WatchfaceConstants.HEART_RATE);
        ...
        f13531a = Collections.unmodifiableMap(hashMap);
        ...
        hashMap2.put("2A8C", EcgStyleReportUtil.UserInfoKey.GENDER);
        ...
        hashMap2.put("2A8E", EcgStyleReportUtil.UserInfoKey.HEIGHT);
        ...
        hashMap2.put("2A98", EcgStyleReportUtil.UserInfoKey.WEIGHT);
