...
public class f implements Runnable {
    ...
    public final /* synthetic */ c f2184a;
    ...
    public void run() {
        ...
        com.apex.bluetooth.data_package.b.b bVar6 = this.f2184a.j;
        if (bVar6 != null && !bVar6.f2207a) {
            this.f2184a.j.f2207a = true;
            EABleCallback eABleCallback = this.f2184a.M;
            if (eABleCallback != null) {
                eABleCallback.mutualFail(6);
            }
        }
        com.apex.bluetooth.data_package.b.b bVar7 = this.f2184a.g;
        if (bVar7 != null && !bVar7.f2207a) {
            this.f2184a.g.f2207a = true;
            DataResponseCallback dataResponseCallback = this.f2184a.K;
            if (dataResponseCallback != null) {
                dataResponseCallback.mutualFail(6);
            }
        }
        com.apex.bluetooth.data_package.b.b bVar8 = this.f2184a.h;
        if (bVar8 != null && !bVar8.f2207a && (motionDataResponseCallback = this.f2184a.L) != null) {
            motionDataResponseCallback.mutualFail(6);
        }
        com.apex.bluetooth.data_package.b.b bVar9 = this.f2184a.i;
        if (bVar9 != null && !bVar9.f2207a && (bVar5 = this.f2184a.X) != null) {
            bVar5.mutualFail(6);
        }
        ConcurrentLinkedQueue<l> concurrentLinkedQueue = this.f2184a.u;
        if (concurrentLinkedQueue != null && !concurrentLinkedQueue.isEmpty()) {
            Iterator<l> it = this.f2184a.u.iterator();
            while (it.hasNext()) {
                l next = it.next();
        ...
        ConcurrentLinkedQueue<l> concurrentLinkedQueue2 = this.f2184a.v;
        if (concurrentLinkedQueue2 != null && !concurrentLinkedQueue2.isEmpty()) {
            Iterator<l> it2 = this.f2184a.v.iterator();
            while (it2.hasNext()) {
                l next2 = it2.next();
        ...
        ConcurrentLinkedQueue<l> concurrentLinkedQueue3 = this.f2184a.w;
        if (concurrentLinkedQueue3 != null && !concurrentLinkedQueue3.isEmpty()) {
            Iterator<l> it3 = this.f2184a.w.iterator();
            while (it3.hasNext()) {
                l next3 = it3.next();
        ...
        ConcurrentLinkedQueue<l> concurrentLinkedQueue4 = this.f2184a.x;
        if (concurrentLinkedQueue4 != null && !concurrentLinkedQueue4.isEmpty()) {
            Iterator<l> it4 = this.f2184a.x.iterator();
            while (it4.hasNext()) {
                l next4 = it4.next();
        ...
        com.apex.bluetooth.core.n.a aVar = this.f2184a.H;
        if (aVar != null) {
            ((a.C0203a) aVar).a(2);
        }
    }
