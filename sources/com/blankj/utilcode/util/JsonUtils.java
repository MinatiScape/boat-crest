...
public final class JsonUtils {
    ...
    public static <T> T a(String str, String str2, T t, byte b) {
        if (str != null && str.length() != 0 && str2 != null && str2.length() != 0) {
            try {
                return (T) b(new JSONObject(str), str2, t, b);
    ...
    public static <T> T b(JSONObject jSONObject, String str, T t, byte b) {
    ...
    public static boolean getBoolean(JSONObject jSONObject, String str, boolean z) {
        return ((Boolean) b(jSONObject, str, Boolean.valueOf(z), (byte) 0)).booleanValue();
    }

    public static double getDouble(JSONObject jSONObject, String str, double d) {
        return ((Double) b(jSONObject, str, Double.valueOf(d), (byte) 3)).doubleValue();
    }

    public static int getInt(JSONObject jSONObject, String str, int i) {
        return ((Integer) b(jSONObject, str, Integer.valueOf(i), (byte) 1)).intValue();
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j) {
        return ((Long) b(jSONObject, str, Long.valueOf(j), (byte) 2)).longValue();
    }
