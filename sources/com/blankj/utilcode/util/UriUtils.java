...
public final class UriUtils {
    ...
    */
    public static java.io.File a(android.net.Uri r7) {
        /*
            ...
            com.blankj.utilcode.util.b.h1(r2, r7)     // Catch: java.io.FileNotFoundException -> L48 java.lang.Throwable -> L5f
            if (r7 == 0) goto L47
        ...
        L6a:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blankj.utilcode.util.UriUtils.a(android.net.Uri):java.io.File");
    }

    public static File b(Uri uri, String str) {
        return c(uri, null, null, str);
    }

    public static File c(Uri uri, String str, String[] strArr, String str2) {
    ...
    public static File d(Uri uri) {
        ...
        if (Build.VERSION.SDK_INT >= 24 && path != null) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                if (path.startsWith(str2)) {
                    File file2 = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + path.replace(str2, MqttTopic.TOPIC_LEVEL_SEPARATOR));
                    if (file2.exists()) {
            ...
            if (path.startsWith("/files_path/")) {
                file = new File(Utils.getApp().getFilesDir().getAbsolutePath() + path.replace("/files_path/", MqttTopic.TOPIC_LEVEL_SEPARATOR));
            } else if (path.startsWith("/cache_path/")) {
                file = new File(Utils.getApp().getCacheDir().getAbsolutePath() + path.replace("/cache_path/", MqttTopic.TOPIC_LEVEL_SEPARATOR));
            } else if (path.startsWith("/external_files_path/")) {
                file = new File(Utils.getApp().getExternalFilesDir(null).getAbsolutePath() + path.replace("/external_files_path/", MqttTopic.TOPIC_LEVEL_SEPARATOR));
            } else if (path.startsWith("/external_cache_path/")) {
                file = new File(Utils.getApp().getExternalCacheDir().getAbsolutePath() + path.replace("/external_cache_path/", MqttTopic.TOPIC_LEVEL_SEPARATOR));
            } else {
                file = null;
            }
        ...
        if ("file".equals(scheme)) {
            ...
            if ("com.android.externalstorage.documents".equals(authority)) {
                    ...
                    while (i2 < length) {
                        ...
                        if (!"mounted".equals(method3.invoke(obj, new Object[0])) && !"mounted_ro".equals(method3.invoke(obj, new Object[0]))) {
                            ...
                            if (z && ((!((Boolean) method5.invoke(obj, new Object[0])).booleanValue() || !((Boolean) method6.invoke(obj, new Object[0])).booleanValue()) && (str = (String) method2.invoke(obj, new Object[0])) != null && str.equals(str3))) {
                                return new File(method4.invoke(obj, new Object[0]) + MqttTopic.TOPIC_LEVEL_SEPARATOR + split[1]);
                            }
                            i2++;
                            invoke = obj2;
                        }
                ...
                if (TextUtils.isEmpty(documentId)) {
                    ...
                    try {
                        ...
                        for (int i3 = 0; i3 < 3; i3++) {
                            try {
                                b = b(ContentUris.withAppendedId(Uri.parse(strArr2[i3]), parseLong), "1_1");
                            } catch (Exception unused) {
                            }
                            if (b != null) {
                                return b;
                ...
                return c(uri2, "_id=?", new String[]{split2[1]}, "1_2");
    ...
    public static Uri res2Uri(String str) {
        return Uri.parse("android.resource://" + Utils.getApp().getPackageName() + MqttTopic.TOPIC_LEVEL_SEPARATOR + str);
    }
    ...
    */
    public static byte[] uri2Bytes(android.net.Uri r4) {
        ...
        L4:
            ...
            byte[] r0 = com.blankj.utilcode.util.b.m0(r4)     // Catch: java.io.FileNotFoundException -> L1f java.lang.Throwable -> L3d
            if (r4 == 0) goto L1e
