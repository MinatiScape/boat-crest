...
public final class EncryptUtils {
    ...
    public static byte[] d(byte[] bArr, byte[] bArr2, int i, String str, boolean z) {
    ...
    public static byte[] encryptHmacSHA224(byte[] bArr, byte[] bArr2) {
        return b(bArr, bArr2, "HmacSHA224");
    }
    ...
    public static byte[] encryptHmacSHA256(byte[] bArr, byte[] bArr2) {
        return b(bArr, bArr2, MacUtil.HMAC_SHA256);
    }
    ...
    public static byte[] encryptHmacSHA384(byte[] bArr, byte[] bArr2) {
        return b(bArr, bArr2, MacUtil.HMAC_SHA384);
    }
    ...
    public static byte[] encryptHmacSHA512(byte[] bArr, byte[] bArr2) {
        return b(bArr, bArr2, MacUtil.HMAC_SHA512);
    }
    ...
    public static byte[] encryptMD5File(String str) {
        return encryptMD5File(b.C0(str) ? null : new File(str));
    }

    public static String encryptMD5File2String(String str) {
        return encryptMD5File2String(b.C0(str) ? null : new File(str));
    }
    ...
    */
    ...
    public static String encryptMD5File2String(File file) {
        return b.l(encryptMD5File(file));
    }
    ...
    public static String encryptMD5ToString(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr == null) {
            return b.l(encryptMD5(bArr2));
        }
        byte[] bArr3 = new byte[bArr.length + bArr2.length];
        System.arraycopy(bArr, 0, bArr3, 0, bArr.length);
        System.arraycopy(bArr2, 0, bArr3, bArr.length, bArr2.length);
        return b.l(encryptMD5(bArr3));
    }
}
