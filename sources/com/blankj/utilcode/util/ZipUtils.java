    ...
    */
    public static boolean a(java.io.File r1, java.util.List<java.io.File> r2, java.util.zip.ZipFile r3, java.util.zip.ZipEntry r4, java.lang.String r5) throws java.io.IOException {
        /*
            ...
            if (r1 == 0) goto L13
            boolean r1 = com.blankj.utilcode.util.b.s(r0)
            return r1
        L13:
            boolean r1 = com.blankj.utilcode.util.b.t(r0)
            r2 = 0
            if (r1 != 0) goto L1b
            return r2
        L1b:
        ...
        L59:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blankj.utilcode.util.ZipUtils.a(java.io.File, java.util.List, java.util.zip.ZipFile, java.util.zip.ZipEntry, java.lang.String):boolean");
    }
    ...
    public static boolean b(File file, String str, ZipOutputStream zipOutputStream, String str2) throws IOException {
        ...
        sb.append(str);
        sb.append(b.C0(str) ? "" : File.separator);
    ...
    public static List<File> unzipFileByKeyword(String str, String str2, String str3) throws IOException {
        return unzipFileByKeyword(b.P(str), b.P(str2), str3);
    }

    public static boolean zipFile(String str, String str2) throws IOException {
        return zipFile(b.P(str), b.P(str2), (String) null);
    }
    ...
    public static boolean zipFile(String str, String str2, String str3) throws IOException {
        return zipFile(b.P(str), b.P(str2), str3);
    }
        ...
        try {
            ...
            try {
                for (String str3 : collection) {
                    if (!b(b.P(str3), "", zipOutputStream2, str2)) {
        ...
        try {
            ...
            try {
                for (File file2 : collection) {
                    if (!b(file2, "", zipOutputStream2, str)) {
                        zipOutputStream2.finish();
                        zipOutputStream2.close();
                        return false;
                    }
