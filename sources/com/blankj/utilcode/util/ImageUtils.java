...
public final class ImageUtils {
    ...
    public enum ImageType {
        TYPE_JPG("jpg"),
        TYPE_PNG(FileUtil.Format.PNG),
        TYPE_GIF("gif"),
        TYPE_TIFF("tiff"),
        TYPE_BMP("bmp"),
        TYPE_WEBP("webp"),
        TYPE_ICO(Constants.NOTIF_ICON),
    ...
    public static Bitmap a(Bitmap bitmap, @FloatRange(from = 1.0d) float f, @ColorInt int i, boolean z, float f2, boolean z2) {
        return b(bitmap, f, i, z, new float[]{f2, f2, f2, f2, f2, f2, f2, f2}, z2);
    }
    ...
    public static Bitmap b(Bitmap bitmap, @FloatRange(from = 1.0d) float f, @ColorInt int i, boolean z, float[] fArr, boolean z2) {
        if (e(bitmap)) {
            return null;
        }
        if (!z2) {
    ...
    public static ImageType c(InputStream inputStream) {
        if (inputStream == null) {
            return null;
        }
        try {
    ...
    public static ImageType d(byte[] bArr) {
        String upperCase = b.l(bArr).toUpperCase();
    ...
    public static Bitmap addCornerBorder(Bitmap bitmap, @FloatRange(from = 1.0d) float f, @ColorInt int i, float[] fArr) {
        return b(bitmap, f, i, false, fArr, false);
    }
    ...
    public static Bitmap addCornerBorder(Bitmap bitmap, @FloatRange(from = 1.0d) float f, @ColorInt int i, float[] fArr, boolean z) {
        return b(bitmap, f, i, false, fArr, z);
    }
    ...
    public static boolean save(Bitmap bitmap, String str, Bitmap.CompressFormat compressFormat, int i) {
        return save(bitmap, b.P(str), compressFormat, i, false);
    }
    ...
    public static boolean save(Bitmap bitmap, String str, Bitmap.CompressFormat compressFormat, int i, boolean z) {
        return save(bitmap, b.P(str), compressFormat, i, z);
    }
