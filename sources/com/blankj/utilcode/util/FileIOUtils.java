...
public final class FileIOUtils {
    ...
    public static int f2253a = 524288;
    ...
    public static byte[] readFile2BytesByChannel(String str) {
        return readFile2BytesByChannel(b.P(str));
    }

    public static byte[] readFile2BytesByMap(String str) {
        return readFile2BytesByMap(b.P(str));
    }

    public static byte[] readFile2BytesByStream(String str) {
        return readFile2BytesByStream(b.P(str), (OnProgressUpdateListener) null);
    }

    public static List<String> readFile2List(String str) {
        return readFile2List(b.P(str), (String) null);
    }

    public static String readFile2String(String str) {
        return readFile2String(b.P(str), (String) null);
    }
    ...
    public static boolean writeFileFromBytesByChannel(String str, byte[] bArr, boolean z) {
        return writeFileFromBytesByChannel(b.P(str), bArr, false, z);
    }
    ...
    public static boolean writeFileFromBytesByStream(String str, byte[] bArr) {
        return writeFileFromBytesByStream(b.P(str), bArr, false, (OnProgressUpdateListener) null);
    }

    public static boolean writeFileFromIS(String str, InputStream inputStream) {
        return writeFileFromIS(b.P(str), inputStream, false, (OnProgressUpdateListener) null);
    }

    public static boolean writeFileFromString(String str, String str2) {
        return writeFileFromString(b.P(str), str2, false);
    }
    ...
    public static byte[] readFile2BytesByChannel(File file) {
        ...
        try {
            ...
            try {
                fileChannel = new RandomAccessFile(file, RsaJsonWebKey.PRIME_FACTOR_OTHER_MEMBER_NAME).getChannel();
                try {
                    if (fileChannel == null) {
    ...
    */
    public static byte[] readFile2BytesByStream(java.io.File r10, com.blankj.utilcode.util.FileIOUtils.OnProgressUpdateListener r11) {
        /*
            boolean r0 = com.blankj.utilcode.util.b.t0(r10)
            r1 = 0
            if (r0 != 0) goto L8
            return r1
        L8:
            ...
            int r10 = com.blankj.utilcode.util.FileIOUtils.f2253a     // Catch: java.io.FileNotFoundException -> L90
            ...
            int r2 = com.blankj.utilcode.util.FileIOUtils.f2253a     // Catch: java.io.IOException -> L5f java.lang.Throwable -> L7c
            byte[] r2 = new byte[r2]     // Catch: java.io.IOException -> L5f java.lang.Throwable -> L7c
            r3 = -1
            r4 = 0
            if (r11 != 0) goto L2d
        L21:
            int r11 = com.blankj.utilcode.util.FileIOUtils.f2253a     // Catch: java.io.IOException -> L5f java.lang.Throwable -> L7c
        ...
        L2d:
            ...
            r7 = r4
        L38:
            int r8 = com.blankj.utilcode.util.FileIOUtils.f2253a     // Catch: java.io.IOException -> L5f java.lang.Throwable -> L7c
    ...
    public static List<String> readFile2List(String str, int i, int i2) {
        return readFile2List(b.P(str), i, i2, (String) null);
    }

    public static boolean writeFileFromBytesByStream(String str, byte[] bArr, OnProgressUpdateListener onProgressUpdateListener) {
        return writeFileFromBytesByStream(b.P(str), bArr, false, onProgressUpdateListener);
    }
    ...
    public static boolean writeFileFromIS(String str, InputStream inputStream, OnProgressUpdateListener onProgressUpdateListener) {
        return writeFileFromIS(b.P(str), inputStream, false, onProgressUpdateListener);
    }

    public static List<String> readFile2List(String str, int i, int i2, String str2) {
        return readFile2List(b.P(str), i, i2, str2);
    }
    ...
    public static boolean writeFileFromBytesByStream(String str, byte[] bArr, boolean z, OnProgressUpdateListener onProgressUpdateListener) {
        return writeFileFromBytesByStream(b.P(str), bArr, z, onProgressUpdateListener);
    }
    ...
    public static boolean writeFileFromIS(String str, InputStream inputStream, boolean z, OnProgressUpdateListener onProgressUpdateListener) {
        return writeFileFromIS(b.P(str), inputStream, z, onProgressUpdateListener);
    }
    ...
    */
    public static java.util.List<java.lang.String> readFile2List(java.io.File r6, int r7, int r8, java.lang.String r9) {
        /*
            boolean r0 = com.blankj.utilcode.util.b.t0(r6)
            r1 = 0
            if (r0 != 0) goto L8
            return r1
        L8:
        ...
        Lb:
            ...
            boolean r2 = com.blankj.utilcode.util.b.C0(r9)     // Catch: java.lang.Throwable -> L55 java.io.IOException -> L57
            r3 = 1
            if (r2 == 0) goto L27
    ...
    public static boolean writeFileFromIS(File file, InputStream inputStream, boolean z, OnProgressUpdateListener onProgressUpdateListener) {
        ...
        if (inputStream != null && b.t(file)) {
            BufferedOutputStream bufferedOutputStream2 = null;
            try {
                try {
                    bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(file, z), f2253a);
                } catch (Throwable th) {
                    th = th;
                }
            } catch (IOException e) {
