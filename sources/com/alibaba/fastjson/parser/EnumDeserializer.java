    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        try {
            ...
            if (i == 2) {
                ...
                throw new JSONException("parse enum " + this.f2116a.getName() + " error, value : " + intValue);
            } else if (i == 4) {
                ...
                throw new JSONException("parse enum " + this.f2116a.getName() + " error, value : " + parse);
            }
