...
public final class a implements ObjectSerializer {

    /* renamed from: a  reason: collision with root package name */
    public final Class<?> f2136a;
    public final ObjectSerializer b;

    public a(Class<?> cls, ObjectSerializer objectSerializer) {
        this.f2136a = cls;
        ...
        if (obj instanceof boolean[]) {
            ...
            try {
                ...
                while (i < length3) {
                    ...
                    } else if (obj3.getClass() == this.f2136a) {
                        this.b.write(jSONSerializer, obj3, Integer.valueOf(i), null);
                    } else {
