...
public final class FragmentFitCrewParticipants extends BaseFragment implements ViewAllParticipantsDetailsPagingAdapter.ChallengeClickListener {
    @NotNull
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final FragmentFitCrewParticipants newInstance(@NotNull BuddiesChallengeDetail buddiesChallengeDetail, boolean z) {
            Intrinsics.checkNotNullParameter(buddiesChallengeDetail, "buddiesChallengeDetail");
            FragmentFitCrewParticipants fragmentFitCrewParticipants = new FragmentFitCrewParticipants();
            fragmentFitCrewParticipants.setBuddiesChallengeDetail(buddiesChallengeDetail);
            fragmentFitCrewParticipants.setViewAllParticipants(z);
            return fragmentFitCrewParticipants;
        }
    }
    ...
    public static final class a extends Lambda implements Function1<PagingData<GetAllParticipantsFitnessChallengeRes.ParticipantsDetails>, Unit> {
        ...
        public final void invoke2(PagingData<GetAllParticipantsFitnessChallengeRes.ParticipantsDetails> pagingData) {
            ...
            if (!FragmentFitCrewParticipants.this.isAdded() || (viewAllParticipantsDetailsPagingAdapter = FragmentFitCrewParticipants.this.o) == null) {
                return;
            }
            Lifecycle lifecycle = FragmentFitCrewParticipants.this.getLifecycle();
    ...
    public static final class b extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final void invoke2(Boolean isEmpty) {
            if (FragmentFitCrewParticipants.this.isAdded()) {
                FragmentFitCrewParticipants fragmentFitCrewParticipants = FragmentFitCrewParticipants.this;
                View root = fragmentFitCrewParticipants.n().emptyChallengeView.getRoot();
                ...
                fragmentFitCrewParticipants.visibleIf(root, isEmpty.booleanValue());
                FragmentFitCrewParticipants.this.n().emptyChallengeView.tvNoChallengeVieTitle.setText(FragmentFitCrewParticipants.this.getString(R.string.no_fit_crew_members));
                FragmentFitCrewParticipants fragmentFitCrewParticipants2 = FragmentFitCrewParticipants.this;
                TextView textView = fragmentFitCrewParticipants2.n().emptyChallengeView.tvNoChallengeViewInfo;
                Intrinsics.checkNotNullExpressionValue(textView, "binding.emptyChallengeView.tvNoChallengeViewInfo");
                fragmentFitCrewParticipants2.inVisible(textView);
                FragmentFitCrewParticipants fragmentFitCrewParticipants3 = FragmentFitCrewParticipants.this;
                ConstraintLayout constraintLayout = fragmentFitCrewParticipants3.n().emptyChallengeView.btnCreateChallengeLayout;
                Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.emptyChallengeVi….btnCreateChallengeLayout");
                fragmentFitCrewParticipants3.gone(constraintLayout);
                FragmentFitCrewParticipants.this.dismissProgress();
            }
        }
    }
        ...
        public final void invoke2(Boolean shouldShowProgress) {
            if (FragmentFitCrewParticipants.this.isAdded()) {
                ...
                if (shouldShowProgress.booleanValue()) {
                    FragmentFitCrewParticipants.this.showProgress(true);
                } else {
                    FragmentFitCrewParticipants.this.dismissProgress();
                }
            }
    ...
    @JvmStatic
    @NotNull
    public static final FragmentFitCrewParticipants newInstance(@NotNull BuddiesChallengeDetail buddiesChallengeDetail, boolean z) {
    ...
    public final void initObservers() {
        ...
        final a aVar = new a();
        leaderboardRankingFitnessChallengeList.observe(viewLifecycleOwner, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.p0
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentFitCrewParticipants.o(Function1.this, obj);
            }
        });
        ...
        final b bVar = new b();
        showEmptyLayoutParticipants.observe(viewLifecycleOwner2, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.q0
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentFitCrewParticipants.p(Function1.this, obj);
            }
        });
        ...
        final c cVar = new c();
        shouldShowProgress.observe(viewLifecycleOwner3, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.r0
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentFitCrewParticipants.q(Function1.this, obj);
            }
        });
    }
        ...
        if (isAdded()) {
            if (AppUtils.isNetConnected(requireContext())) {
                if (this.p != null) {
                    ...
                    fitnessChallengeListViewModel.getFitnessChallengesLeaderboardRankingPagingData(challengeId, challengeType, FitnessChallengeConstants.BUDDIES_PARTICIPANTS);
                }
            } else {
