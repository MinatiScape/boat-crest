...
import com.coveiot.android.fitnesschallenges.databinding.FragmentBuddiesChallengesBinding;
...
public final class FragmentBuddiesChallenges extends BaseFragment implements FitnessChallengePagingAdapter.ChallengeClickListener, SuccessResultListener {
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    public Map<Integer, View> _$_findViewCache = new LinkedHashMap();
    public FragmentBuddiesChallengesBinding m;
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final FragmentBuddiesChallenges newInstance(@NotNull String param1, @NotNull String param2) {
            Intrinsics.checkNotNullParameter(param1, "param1");
            Intrinsics.checkNotNullParameter(param2, "param2");
            return new FragmentBuddiesChallenges();
        }
    }
    ...
    public static final class b extends Lambda implements Function1<PagingData<BuddiesChallengeRes.Item>, Unit> {
        ...
        public final void invoke2(PagingData<BuddiesChallengeRes.Item> pagingData) {
            if (FragmentBuddiesChallenges.this.isAdded()) {
                FitnessChallengePagingAdapter fitnessChallengePagingAdapter = FragmentBuddiesChallenges.this.n;
                ...
                Lifecycle lifecycle = FragmentBuddiesChallenges.this.getLifecycle();
    ...
    public static final class c extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final void invoke2(Boolean isEmpty) {
            if (FragmentBuddiesChallenges.this.isAdded()) {
                FragmentBuddiesChallenges fragmentBuddiesChallenges = FragmentBuddiesChallenges.this;
                View root = fragmentBuddiesChallenges.o().emptyChallengeView.getRoot();
                ...
                fragmentBuddiesChallenges.visibleIf(root, isEmpty.booleanValue());
                FragmentBuddiesChallenges.this.dismissProgress();
            }
        }
    }
        ...
        public final void invoke2(Boolean shouldShowProgress) {
            if (FragmentBuddiesChallenges.this.isAdded()) {
                ...
                if (shouldShowProgress.booleanValue()) {
                    FragmentBuddiesChallenges.this.showProgress(true);
                } else {
                    FragmentBuddiesChallenges.this.dismissProgress();
                }
            }
    ...
    @JvmStatic
    @NotNull
    public static final FragmentBuddiesChallenges newInstance(@NotNull String str, @NotNull String str2) {
    ...
    public static final void t(FragmentBuddiesChallenges this$0, View view) {
    ...
    public final void initObservers() {
        ...
        MutableLiveData<PagingData<BuddiesChallengeRes.Item>> buddiesFitnessChallengeList = fitnessChallengeListViewModel.getBuddiesFitnessChallengeList();
        LifecycleOwner viewLifecycleOwner = getViewLifecycleOwner();
        final b bVar = new b();
        buddiesFitnessChallengeList.observe(viewLifecycleOwner, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.g
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentBuddiesChallenges.q(Function1.this, obj);
            }
        });
        ...
        final c cVar = new c();
        showEmptyLayout.observe(viewLifecycleOwner2, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.h
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentBuddiesChallenges.r(Function1.this, obj);
            }
        });
        ...
        final d dVar = new d();
        shouldShowProgress.observe(viewLifecycleOwner3, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.f
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentBuddiesChallenges.s(Function1.this, obj);
            }
        });
    }
    ...
    public final FragmentBuddiesChallengesBinding o() {
        FragmentBuddiesChallengesBinding fragmentBuddiesChallengesBinding = this.m;
        if (fragmentBuddiesChallengesBinding == null) {
            Intrinsics.throwUninitializedPropertyAccessException("_binding");
            return null;
        }
        return fragmentBuddiesChallengesBinding;
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        FragmentBuddiesChallengesBinding inflate = FragmentBuddiesChallengesBinding.inflate(inflater, viewGroup, false);
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        o().emptyChallengeView.btnCreateChallengeLayout.setOnClickListener(new View.OnClickListener() { // from class: com.coveiot.android.fitnesschallenges.fragments.e
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentBuddiesChallenges.t(FragmentBuddiesChallenges.this, view2);
            }
        });
    }
    ...
    public final void p() {
        if (isAdded()) {
            if (AppUtils.isNetConnected(requireContext())) {
                ...
                fitnessChallengeListViewModel.getBuddyFitnessChallengesPagingData();
            } else {
                showNoInternetDialog();
                dismissProgress();
            }
