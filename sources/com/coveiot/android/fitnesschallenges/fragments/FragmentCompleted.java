...
import com.coveiot.android.fitnesschallenges.databinding.FragmentCompletedBinding;
...
public final class FragmentCompleted extends BaseFragment implements FitnessChallengePagingAdapter.ChallengeClickListener {
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    public Map<Integer, View> _$_findViewCache = new LinkedHashMap();
    public FragmentCompletedBinding m;
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final FragmentCompleted newInstance() {
    ...
    public static final class b extends Lambda implements Function1<PagingData<BuddiesChallengeRes.Item>, Unit> {
        ...
        public final void invoke2(PagingData<BuddiesChallengeRes.Item> pagingData) {
            if (FragmentCompleted.this.isAdded()) {
                FitnessChallengePagingAdapter fitnessChallengePagingAdapter = FragmentCompleted.this.n;
                ...
                Lifecycle lifecycle = FragmentCompleted.this.getLifecycle();
    ...
    public static final class c extends Lambda implements Function1<Boolean, Unit> {
        ...
        public final void invoke2(Boolean isEmpty) {
            if (FragmentCompleted.this.isAdded()) {
                FragmentCompleted.this.o().emptyChallengeView.tvNoChallengeVieTitle.setText(FragmentCompleted.this.getString(R.string.no_completed_challenges));
                FragmentCompleted.this.o().emptyChallengeView.tvNoChallengeViewInfo.setText(FragmentCompleted.this.getString(R.string.join_challenge_and_achieve_goals));
                FragmentCompleted.this.o().emptyChallengeView.btnCreateChallenge.setText(FragmentCompleted.this.getString(R.string.join_challenge));
                FragmentCompleted fragmentCompleted = FragmentCompleted.this;
                View root = fragmentCompleted.o().emptyChallengeView.getRoot();
                ...
                fragmentCompleted.visibleIf(root, isEmpty.booleanValue());
                FragmentCompleted.this.dismissProgress();
            }
        }
    }
        ...
        public final void invoke2(Boolean shouldShowProgress) {
            if (FragmentCompleted.this.isAdded()) {
                ...
                if (shouldShowProgress.booleanValue()) {
                    FragmentCompleted.this.showProgress(true);
                } else {
                    FragmentCompleted.this.dismissProgress();
                }
            }
    ...
    @JvmStatic
    @NotNull
    public static final FragmentCompleted newInstance() {
    ...
    public static final void t(FragmentCompleted this$0, View view) {
    ...
    public final void initObservers() {
        ...
        MutableLiveData<PagingData<BuddiesChallengeRes.Item>> myCompletedFitnessChallengeList = fitnessChallengeListViewModel.getMyCompletedFitnessChallengeList();
        LifecycleOwner viewLifecycleOwner = getViewLifecycleOwner();
        final b bVar = new b();
        myCompletedFitnessChallengeList.observe(viewLifecycleOwner, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.j
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentCompleted.q(Function1.this, obj);
            }
        });
        ...
        final c cVar = new c();
        showEmptyLayout.observe(viewLifecycleOwner2, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.l
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentCompleted.r(Function1.this, obj);
            }
        });
        ...
        final d dVar = new d();
        shouldShowProgress.observe(viewLifecycleOwner3, new Observer() { // from class: com.coveiot.android.fitnesschallenges.fragments.k
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                FragmentCompleted.s(Function1.this, obj);
            }
        });
    }
    ...
    public final FragmentCompletedBinding o() {
        FragmentCompletedBinding fragmentCompletedBinding = this.m;
        if (fragmentCompletedBinding == null) {
            Intrinsics.throwUninitializedPropertyAccessException("_binding");
            return null;
        }
        return fragmentCompletedBinding;
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        FragmentCompletedBinding inflate = FragmentCompletedBinding.inflate(inflater, viewGroup, false);
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        o().infoDetails.tvInfoText.setText(getString(R.string.challenges_you_have_participated));
        ...
        o().emptyChallengeView.btnCreateChallengeLayout.setOnClickListener(new View.OnClickListener() { // from class: com.coveiot.android.fitnesschallenges.fragments.i
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentCompleted.t(FragmentCompleted.this, view2);
            }
        });
    }
    ...
    public final void p() {
        if (isAdded()) {
            if (AppUtils.isNetConnected(requireContext())) {
                ...
                fitnessChallengeListViewModel.getMyCompletedFitnessChallengesPagingData();
            } else {
                showNoInternetDialog();
                dismissProgress();
            }
