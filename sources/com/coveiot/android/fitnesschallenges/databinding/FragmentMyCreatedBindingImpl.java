...
public class FragmentMyCreatedBindingImpl extends FragmentMyCreatedBinding {
    @Nullable
    ...
    public FragmentMyCreatedBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public FragmentMyCreatedBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
