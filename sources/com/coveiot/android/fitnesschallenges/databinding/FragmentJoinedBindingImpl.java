...
public class FragmentJoinedBindingImpl extends FragmentJoinedBinding {
    @Nullable
    ...
    public FragmentJoinedBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public FragmentJoinedBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
