...
@Entity(foreignKeys = {@ForeignKey(childColumns = {"sess_id"}, entity = EntityWorkoutSession.class, onDelete = 5, onUpdate = 1, parentColumns = {WorkoutConstants.SESSION_ID})}, indices = {@Index({"sess_id", "seg_id"})}, primaryKeys = {"sess_id", "timestamp"}, tableName = "climbing_sample")
/* loaded from: classes2.dex */
public final class ClimbingSample extends Sample {
    ...
    public final boolean contains(@NotNull ArrayList<ClimbingSample> sampleList, long j) {
