...
@Entity(foreignKeys = {@ForeignKey(childColumns = {"sess_id"}, entity = EntityWorkoutSession.class, onDelete = 5, onUpdate = 1, parentColumns = {WorkoutConstants.SESSION_ID})}, indices = {@Index({"sess_id", "seg_id"})}, primaryKeys = {"sess_id", "timestamp"}, tableName = "free_exercise_sample")
/* loaded from: classes2.dex */
public final class FreeExerciseSample extends Sample {
    ...
    public final boolean contains(@NotNull ArrayList<FreeExerciseSample> sampleList, long j) {
