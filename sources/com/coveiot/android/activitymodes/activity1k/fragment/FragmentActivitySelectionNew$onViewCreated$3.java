...
public final class FragmentActivitySelectionNew$onViewCreated$3 implements TextWatcher {
    public final /* synthetic */ FragmentActivitySelectionNew h;

    public FragmentActivitySelectionNew$onViewCreated$3(FragmentActivitySelectionNew fragmentActivitySelectionNew) {
    ...
    public void afterTextChanged(@NotNull final Editable s) {
        ...
        if (activity != null) {
            ...
            activity.runOnUiThread(new Runnable() { // from class: com.coveiot.android.activitymodes.activity1k.fragment.n
                @Override // java.lang.Runnable
                public final void run() {
                    FragmentActivitySelectionNew$onViewCreated$3.b(FragmentActivitySelectionNew.this, s);
                }
            });
        }
    }
