...
public final class CategoryAndActivityModel implements Serializable {
    @Nullable
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(CategoryAndActivityModel.class, obj != null ? obj.getClass() : null)) {
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type com.coveiot.android.activitymodes.activity1k.model.CategoryAndActivityModel");
            CategoryAndActivityModel categoryAndActivityModel = (CategoryAndActivityModel) obj;
            return Intrinsics.areEqual(this.activityId, categoryAndActivityModel.activityId) && this.fwActId == categoryAndActivityModel.fwActId;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((num != null ? num.intValue() : 0) * 31) + this.fwActId;
    }
