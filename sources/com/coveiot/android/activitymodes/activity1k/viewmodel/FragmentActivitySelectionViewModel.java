...
public final class FragmentActivitySelectionViewModel extends AndroidViewModel {
    @NotNull
    public Context d;
    @NotNull
    public LiveData<List<ActivitiesListModel>> e;
    @NotNull
    public LiveData<List<ActivityCategoriesModel>> f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FragmentActivitySelectionViewModel(@NotNull Application application) {
        super(application);
    ...
    public final void getActivityListFromDb() {
        this.e = PhysicalActivityRepository.Companion.getInstance(this.d).getPhysicalActivityList();
    }
    ...
    public final void getCategoryListFromDb() {
        this.f = PhysicalActivityRepository.Companion.getInstance(this.d).getActivitiesCategories();
    }
    ...
    public final void getActivityListFromDb(int i) {
        this.e = PhysicalActivityRepository.Companion.getInstance(this.d).getPhysicalActivityList(i);
    }
}
