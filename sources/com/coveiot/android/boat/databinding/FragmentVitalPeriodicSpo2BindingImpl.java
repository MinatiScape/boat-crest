...
public class FragmentVitalPeriodicSpo2BindingImpl extends FragmentVitalPeriodicSpo2Binding {
    @Nullable
    ...
    static {
        ...
        sparseIntArray.put(R.id.spo2Graph, 4);
        sparseIntArray.put(R.id.tvNoDataFound, 5);
        sparseIntArray.put(R.id.divider, 6);
        sparseIntArray.put(R.id.tv_what_is_spo2, 7);
        sparseIntArray.put(R.id.tvspo2description, 8);
        sparseIntArray.put(R.id.tvdisclaimer, 9);
    }

    public FragmentVitalPeriodicSpo2BindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public FragmentVitalPeriodicSpo2BindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (View) objArr[6], (ConstraintLayout) objArr[3], (RoundedBarChart) objArr[4], (TextView) objArr[5], (TextView) objArr[7], (TextView) objArr[9], (TextView) objArr[8], (VitalsDetailedLayoutBinding) objArr[2]);
        this.j = -1L;
