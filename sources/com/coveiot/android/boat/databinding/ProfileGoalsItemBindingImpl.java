...
public class ProfileGoalsItemBindingImpl extends ProfileGoalsItemBinding {
    @Nullable
    ...
    public ProfileGoalsItemBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    @Override // com.coveiot.android.boat.databinding.ProfileGoalsItemBinding
    ...
    public ProfileGoalsItemBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
