...
public final class FragmentPeriodicSpO2Share extends Fragment {
    @NotNull
    ...
    public static final class Companion {
        ...
        @NotNull
        public final FragmentPeriodicSpO2Share newInstance(@NotNull ShareData shareData) {
            Intrinsics.checkNotNullParameter(shareData, "shareData");
            FragmentPeriodicSpO2Share fragmentPeriodicSpO2Share = new FragmentPeriodicSpO2Share();
            Bundle bundle = new Bundle();
            bundle.putSerializable(AppConstants.SHARE_DATA.getValue(), shareData);
            fragmentPeriodicSpO2Share.setArguments(bundle);
            return fragmentPeriodicSpO2Share;
        }
    }
    ...
    public final void updateView() {
        ...
        ((TextView) _$_findCachedViewById(R.id.spo2_value)).setText(String.valueOf(this.h.getSpo2_max()));
        ...
        GlideUtils.loadScaledImage(getActivity(), SessionManager.getInstance(getActivity()).getUserDetails().getDpUrl(), new SimpleTarget<Bitmap>() { // from class: com.coveiot.android.leonardo.dashboard.health.fragments.FragmentPeriodicSpO2Share$updateView$1
            ...
            public void onResourceReady(@NotNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                ...
                FragmentPeriodicSpO2Share fragmentPeriodicSpO2Share = FragmentPeriodicSpO2Share.this;
                int i = R.id.user_pic;
                if (((ImageView) fragmentPeriodicSpO2Share._$_findCachedViewById(i)) == null || (circleBitmap = AppUtils.getCircleBitmap(resource)) == null) {
                    return;
                }
                ((ImageView) FragmentPeriodicSpO2Share.this._$_findCachedViewById(i)).setImageBitmap(circleBitmap);
            }
        });
    }
}
