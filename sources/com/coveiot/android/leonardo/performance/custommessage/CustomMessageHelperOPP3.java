...
public final class CustomMessageHelperOPP3 implements CustomMessageHelper {
    @NotNull
    public static final CustomMessageHelperOPP3 INSTANCE = new CustomMessageHelperOPP3();
    ...
    public ArrayList<DynamicSportsField> getEnergyScoreCustomMessageRequest(int i, @NotNull String message, int i2) {
        ...
        arrayList.add(new DynamicSportFieldText(2, convertHexTo5652, 90, 225, 32, 32, 38, 0, "Energy Meter"));
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 182, DfuException.ERROR_DFU_SPP_RWS_NOT_READY, 32, 32, 38, 0, String.valueOf(i)));
        arrayList.add(new DynamicSportFieldText(4, convertHexTo5652, 15, 330, 32, 32, 38, 0, message));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getGenericCustomMessageRequest(@NotNull String message, int i, @Nullable String str) {
        ...
        arrayList.add(new DynamicSportFieldText(2, convertHexTo565, 30, 225, 32, 32, 38, 0, message));
        return arrayList;
    }
