...
public final class CustomMessageHelperOPP1 implements CustomMessageHelper {
    @NotNull
    public static final CustomMessageHelperOPP1 INSTANCE = new CustomMessageHelperOPP1();
    ...
    public ArrayList<DynamicSportsField> getEnergyScoreCustomMessageRequest(int i, @NotNull String message, int i2) {
        ...
        arrayList.add(new DynamicSportFieldText(2, convertHexTo5652, 59, 110, 32, 32, 22, 0, "Energy Meter"));
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 109, 150, 32, 32, 32, 0, String.valueOf(i)));
        arrayList.add(new DynamicSportFieldText(4, convertHexTo5652, 15, 190, 32, 32, 22, 0, message));
        return arrayList;
    }
