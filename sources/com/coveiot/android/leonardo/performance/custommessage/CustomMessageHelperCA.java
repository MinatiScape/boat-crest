...
public final class CustomMessageHelperCA implements CustomMessageHelper {
    @NotNull
    public static final CustomMessageHelperCA INSTANCE = new CustomMessageHelperCA();
    ...
    public ArrayList<DynamicSportsField> getEnergyScoreCustomMessageRequest(int i, @NotNull String message, int i2) {
        ...
        arrayList.add(new DynamicSportFieldText(2, convertHexTo5652, 60, 150, 32, 32, 24, 0, "Energy Meter"));
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 150, 200, 32, 32, 32, 0, String.valueOf(i)));
        arrayList.add(new DynamicSportFieldText(4, convertHexTo5652, 15, 250, 32, 32, 24, 0, message));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getGenericCustomMessageRequest(@NotNull String message, int i, @Nullable String str) {
        ...
        arrayList.add(new DynamicSportFieldText(2, convertHexTo565, 15, 170, 32, 32, 0, 0, message));
        return arrayList;
    }
