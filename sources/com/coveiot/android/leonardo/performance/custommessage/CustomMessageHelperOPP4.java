...
public final class CustomMessageHelperOPP4 implements CustomMessageHelper {
    @NotNull
    public static final CustomMessageHelperOPP4 INSTANCE = new CustomMessageHelperOPP4();
    ...
    public ArrayList<DynamicSportsField> getEnergyScoreCustomMessageRequest(int i, @NotNull String message, int i2) {
        ...
        arrayList.add(new DynamicSportFieldText(2, convertHexTo5652, 118, 180, 32, 32, 38, 0, "Energy Meter"));
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, Command.CMD_RECEIVE_SPEECH_CANCEL, 233, 32, 32, 38, 0, String.valueOf(i)));
        arrayList.add(new DynamicSportFieldText(4, convertHexTo5652, 50, DfuException.ERROR_ENTER_OTA_MODE_FAILED, 32, 32, 38, 0, message));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getGenericCustomMessageRequest(@NotNull String message, int i, @Nullable String str) {
        ...
        arrayList.add(new DynamicSportFieldText(2, convertHexTo565, 78, 200, 32, 32, 38, 0, message));
        return arrayList;
    }
