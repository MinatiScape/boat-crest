...
@DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.ManageViewModel$suspendPaymentInstrumentTokens$1", f = "ManageViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes7.dex */
public final class ManageViewModel$suspendPaymentInstrumentTokens$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ManageViewModel$suspendPaymentInstrumentTokens$1(long j, long j2, String str, ManageViewModel manageViewModel, Continuation<? super ManageViewModel$suspendPaymentInstrumentTokens$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ManageViewModel$suspendPaymentInstrumentTokens$1(this.$userId, this.$paymentInstrumentTokenId, this.$reason, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((ManageViewModel$suspendPaymentInstrumentTokens$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            SSuspendPaymentInstrumentTokensRequest sSuspendPaymentInstrumentTokensRequest = new SSuspendPaymentInstrumentTokensRequest();
            sSuspendPaymentInstrumentTokensRequest.setEndUserId(this.$userId);
            sSuspendPaymentInstrumentTokensRequest.setPaymentInstrumentTokenId(this.$paymentInstrumentTokenId);
            sSuspendPaymentInstrumentTokensRequest.setReason(this.$reason);
            final ManageViewModel manageViewModel = this.this$0;
            TappyApiManager.suspendPaymentInstrumentTokens(sSuspendPaymentInstrumentTokensRequest, new CoveApiListener<SSuspendPaymentInstrumentTokensResponse, CoveApiErrorModel>() { // from class: com.coveiot.android.tappy.viewmodel.ManageViewModel$suspendPaymentInstrumentTokens$1.1

                @DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.ManageViewModel$suspendPaymentInstrumentTokens$1$1$onError$1", f = "ManageViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.tappy.viewmodel.ManageViewModel$suspendPaymentInstrumentTokens$1$1$a */
                /* loaded from: classes7.dex */
                public static final class a extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(@NotNull Object obj) {
                        ...
                        if (this.label == 0) {
                            ResultKt.throwOnFailure(obj);
                            this.this$0.getSuspendPaymentInstrumentTokenLiveData().setValue(null);
                ...
                @DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.ManageViewModel$suspendPaymentInstrumentTokens$1$1$onSuccess$1", f = "ManageViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.tappy.viewmodel.ManageViewModel$suspendPaymentInstrumentTokens$1$1$b */
                /* loaded from: classes7.dex */
                public static final class b extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    public final /* synthetic */ SSuspendPaymentInstrumentTokensResponse $p0;
                    private /* synthetic */ Object L$0;
                    public int label;
                    public final /* synthetic */ ManageViewModel this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public b(SSuspendPaymentInstrumentTokensResponse sSuspendPaymentInstrumentTokensResponse, ManageViewModel manageViewModel, Continuation<? super b> continuation) {
                        super(2, continuation);
                        this.$p0 = sSuspendPaymentInstrumentTokensResponse;
                        this.this$0 = manageViewModel;
                    }
                    ...
                    public final Object invokeSuspend(@NotNull Object obj) {
                        ...
                        if (this.label == 0) {
                            ...
                            SSuspendPaymentInstrumentTokensResponse sSuspendPaymentInstrumentTokensResponse = this.$p0;
                            if (sSuspendPaymentInstrumentTokensResponse != null) {
                                ManageViewModel manageViewModel = this.this$0;
                                SRegisteredProduct registeredProduct = sSuspendPaymentInstrumentTokensResponse.getRegisteredProduct();
                                if (registeredProduct != null) {
                                    Intrinsics.checkNotNullExpressionValue(registeredProduct, "registeredProduct");
                                    SuspendPaymentInstrumentTokenResponse suspendPaymentInstrumentTokenResponse = new SuspendPaymentInstrumentTokenResponse();
                                    ...
                                    suspendPaymentInstrumentTokenResponse.setRegisteredProductInfo(registeredProductInfo);
                                    manageViewModel.getSuspendPaymentInstrumentTokenLiveData().setValue(suspendPaymentInstrumentTokenResponse);
                                    unit2 = Unit.INSTANCE;
                                } else {
                                    unit2 = null;
                                }
                                if (unit2 == null) {
                                    manageViewModel.getSuspendPaymentInstrumentTokenLiveData().setValue(null);
                                }
                                unit = Unit.INSTANCE;
                            } else {
                                unit = null;
                            ...
                            this.this$0.getMListener().onSuccess();
                            return Unit.INSTANCE;
                        }
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                ...
                @Override // com.coveiot.coveaccess.CoveApiListener
                public void onSuccess(@Nullable SSuspendPaymentInstrumentTokensResponse sSuspendPaymentInstrumentTokensResponse) {
                    e.e(ViewModelKt.getViewModelScope(ManageViewModel.this), Dispatchers.getMain(), null, new b(sSuspendPaymentInstrumentTokensResponse, ManageViewModel.this, null), 2, null);
                }
            });
            return Unit.INSTANCE;
        }
