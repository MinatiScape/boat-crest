...
@DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.ManageViewModel$resumePaymentInstrumentTokens$1", f = "ManageViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes7.dex */
public final class ManageViewModel$resumePaymentInstrumentTokens$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ManageViewModel$resumePaymentInstrumentTokens$1(long j, long j2, String str, ManageViewModel manageViewModel, Continuation<? super ManageViewModel$resumePaymentInstrumentTokens$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ManageViewModel$resumePaymentInstrumentTokens$1(this.$userId, this.$paymentInstrumentTokenId, this.$reason, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((ManageViewModel$resumePaymentInstrumentTokens$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            SResumePaymentInstrumentTokensRequest sResumePaymentInstrumentTokensRequest = new SResumePaymentInstrumentTokensRequest();
            sResumePaymentInstrumentTokensRequest.setEndUserId(this.$userId);
            sResumePaymentInstrumentTokensRequest.setPaymentInstrumentTokenId(this.$paymentInstrumentTokenId);
            sResumePaymentInstrumentTokensRequest.setReason(this.$reason);
            final ManageViewModel manageViewModel = this.this$0;
            TappyApiManager.resumePaymentInstrumentTokens(sResumePaymentInstrumentTokensRequest, new CoveApiListener<SResumePaymentInstrumentTokensResponse, CoveApiErrorModel>() { // from class: com.coveiot.android.tappy.viewmodel.ManageViewModel$resumePaymentInstrumentTokens$1.1

                @DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.ManageViewModel$resumePaymentInstrumentTokens$1$1$onError$1", f = "ManageViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.tappy.viewmodel.ManageViewModel$resumePaymentInstrumentTokens$1$1$a */
                /* loaded from: classes7.dex */
                public static final class a extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(@NotNull Object obj) {
                        ...
                        if (this.label == 0) {
                            ResultKt.throwOnFailure(obj);
                            this.this$0.getResumePaymentInstrumentTokenLiveData().setValue(null);
                ...
                @DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.ManageViewModel$resumePaymentInstrumentTokens$1$1$onSuccess$1", f = "ManageViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.tappy.viewmodel.ManageViewModel$resumePaymentInstrumentTokens$1$1$b */
                /* loaded from: classes7.dex */
                public static final class b extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    public final /* synthetic */ SResumePaymentInstrumentTokensResponse $p0;
                    private /* synthetic */ Object L$0;
                    public int label;
                    public final /* synthetic */ ManageViewModel this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public b(SResumePaymentInstrumentTokensResponse sResumePaymentInstrumentTokensResponse, ManageViewModel manageViewModel, Continuation<? super b> continuation) {
                        super(2, continuation);
                        this.$p0 = sResumePaymentInstrumentTokensResponse;
                        this.this$0 = manageViewModel;
                    }
                    ...
                    public final Object invokeSuspend(@NotNull Object obj) {
                        ...
                        if (this.label == 0) {
                            ...
                            SResumePaymentInstrumentTokensResponse sResumePaymentInstrumentTokensResponse = this.$p0;
                            if (sResumePaymentInstrumentTokensResponse != null) {
                                ManageViewModel manageViewModel = this.this$0;
                                SRegisteredProduct registeredProduct = sResumePaymentInstrumentTokensResponse.getRegisteredProduct();
                                if (registeredProduct != null) {
                                    Intrinsics.checkNotNullExpressionValue(registeredProduct, "registeredProduct");
                                    ResumePaymentInstrumentTokenResponse resumePaymentInstrumentTokenResponse = new ResumePaymentInstrumentTokenResponse();
                                    ...
                                    resumePaymentInstrumentTokenResponse.setRegisteredProductInfo(registeredProductInfo);
                                    manageViewModel.getResumePaymentInstrumentTokenLiveData().setValue(resumePaymentInstrumentTokenResponse);
                                    unit2 = Unit.INSTANCE;
                                } else {
                                    unit2 = null;
                                }
                                if (unit2 == null) {
                                    manageViewModel.getResumePaymentInstrumentTokenLiveData().setValue(null);
                                }
                                unit = Unit.INSTANCE;
                            } else {
                                unit = null;
                ...
                @Override // com.coveiot.coveaccess.CoveApiListener
                public void onSuccess(@Nullable SResumePaymentInstrumentTokensResponse sResumePaymentInstrumentTokensResponse) {
                    e.e(ViewModelKt.getViewModelScope(ManageViewModel.this), Dispatchers.getMain(), null, new b(sResumePaymentInstrumentTokensResponse, ManageViewModel.this, null), 2, null);
