...
@DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.NfcStrapViewModel$getUserInfo$1", f = "NfcStrapViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes7.dex */
public final class NfcStrapViewModel$getUserInfo$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ NfcStrapViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NfcStrapViewModel$getUserInfo$1(NfcStrapViewModel nfcStrapViewModel, Continuation<? super NfcStrapViewModel$getUserInfo$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new NfcStrapViewModel$getUserInfo$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((NfcStrapViewModel$getUserInfo$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            TappyApiManager.getUserInfo(new CoveApiListener<SUserDataResponse, CoveApiErrorModel>() { // from class: com.coveiot.android.tappy.viewmodel.NfcStrapViewModel$getUserInfo$1.1

                @DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.NfcStrapViewModel$getUserInfo$1$1$onError$1", f = "NfcStrapViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.tappy.viewmodel.NfcStrapViewModel$getUserInfo$1$1$a */
                /* loaded from: classes7.dex */
                ...
                @DebugMetadata(c = "com.coveiot.android.tappy.viewmodel.NfcStrapViewModel$getUserInfo$1$1$onSuccess$1", f = "NfcStrapViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.tappy.viewmodel.NfcStrapViewModel$getUserInfo$1$1$b */
                /* loaded from: classes7.dex */
                    ...
                    public final Object invokeSuspend(@NotNull Object obj) {
                        ...
                        if (this.label == 0) {
                            ...
                            if (sUserDataResponse != null) {
                                ...
                                userDetails.setAccountStatus(sUserDataResponse.getAccountStatus());
