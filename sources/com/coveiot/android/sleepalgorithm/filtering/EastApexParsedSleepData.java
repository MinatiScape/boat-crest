...
public class EastApexParsedSleepData extends SleepData {
    ...
    public EastApexParsedSleepData(byte[] bArr, SleepData.SUPPORTED_ENCODING supported_encoding) throws Exception {
        ...
        SleepData.VALUE_AWAKE = 2;
        SleepData.VALUE_LIGHTSLEEP = 4;
        SleepData.VALUE_DEEPSLEEP = 5;
    ...
    public final void c() {
        ...
        if (this.e != -1 && (i = this.d) != -1 && this.h != -1 && this.f != -1) {
            ...
            int i5 = i2 + i3 + i4;
            this.i = i5;
            this.n = new SleepDataModel(this.o, this.d, this.e, this.f, this.h, i3, i2, this.k, i5, i4);
            return;
        }
    ...
    public FilteredSleepData getFilteredSleepData() {
        return new FilteredSleepData(getSleepDataModel().getFilteredSleepData(), Type.EastApex, this.q, this.p);
    }
