...
public class TouchELXParsedSleepData extends SleepData {
    ...
    public TouchELXParsedSleepData(byte[] bArr, SleepData.SUPPORTED_ENCODING supported_encoding) throws Exception {
    ...
    public FilteredSleepData getFilteredSleepData() {
        return new FilteredSleepData(getSleepDataModel().getFilteredSleepData(), Type.TouchELX, this.q, this.p);
    }
