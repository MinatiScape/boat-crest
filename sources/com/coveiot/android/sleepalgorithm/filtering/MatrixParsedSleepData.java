...
public class MatrixParsedSleepData extends SleepData {
    ...
    public MatrixParsedSleepData(byte[] bArr, SleepData.SUPPORTED_ENCODING supported_encoding) throws Exception {
    ...
    public final void c() {
        ...
        if (this.e != -1 && (i = this.d) != -1 && this.h != -1 && this.f != -1) {
            ...
            Arrays.fill(this.o, 0, intValue, (byte) 0);
            Arrays.fill(this.o, intValue2, bArr.length - 1, (byte) 0);
            this.k = 0;
            this.j = 0;
            this.l = 0;
            this.m = 0;
            ...
            int i4 = i2 + i3;
            this.i = i4;
            this.n = new SleepDataModel(this.o, this.d, this.e, this.f, this.h, i3, i2, this.k, i4, this.m);
            return;
        }
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if (intValue < bArr.length) {
                if (bArr[intValue] > 0 && bArr[intValue] != 3) {
                    this.q = intValue;
                    break;
                }
                intValue++;
        ...
        while (true) {
            ...
            byte[] bArr2 = this.o;
            if (bArr2[intValue2] > 0 && bArr2[intValue2] != 3) {
                this.p = intValue2 + 1;
                break;
            }
            intValue2--;
    ...
    public FilteredSleepData getFilteredSleepData() {
        return new FilteredSleepData(getSleepDataModel().getFilteredSleepData(), Type.Matrix, this.q, this.p);
    }
