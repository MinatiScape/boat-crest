...
public class CircularArcProgressBar extends View {
    ...
    public static final float GLOW_AREA = 15.0f;
    ...
    public OnCircularArcProgressBarChangeListener mOnCircularArcProgressBarChangeListener;
    ...
    /* loaded from: classes7.dex */
    public interface OnCircularArcProgressBarChangeListener {
        void onProgressChanged(CircularArcProgressBar circularArcProgressBar, int i, boolean z);

        void onStartTrackingTouch(CircularArcProgressBar circularArcProgressBar);

        void onStopTrackingTouch(CircularArcProgressBar circularArcProgressBar);
    }

    public CircularArcProgressBar(Context context) {
        super(context);
    ...
    public void init(AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.CircularArcProgressBar, i, 0);
    ...
    public void initAttributes(TypedArray typedArray) {
        this.mCircleXRadius = typedArray.getDimension(R.styleable.CircularArcProgressBar_circle_x_radius_, this.DPTOPX_SCALE * 30.0f);
        this.mCircleYRadius = typedArray.getDimension(R.styleable.CircularArcProgressBar_circle_y_radius_, this.DPTOPX_SCALE * 30.0f);
        this.mPointerRadius = typedArray.getDimension(R.styleable.CircularArcProgressBar_pointer_radius_, this.DPTOPX_SCALE * 7.0f);
        this.mPointerHaloWidth = typedArray.getDimension(R.styleable.CircularArcProgressBar_pointer_halo_width_, this.DPTOPX_SCALE * 6.0f);
        this.mPointerHaloBorderWidth = typedArray.getDimension(R.styleable.CircularArcProgressBar_pointer_halo_border_width_, this.DPTOPX_SCALE * 2.0f);
        this.mCircleStrokeWidth = typedArray.getDimension(R.styleable.CircularArcProgressBar_circle_stroke_width_, this.DPTOPX_SCALE * 5.0f);
        this.mPointerColor = typedArray.getColor(R.styleable.CircularArcProgressBar_pointer_color_, DEFAULT_POINTER_COLOR);
        this.mPointerHaloColor = typedArray.getColor(R.styleable.CircularArcProgressBar_pointer_halo_color_, DEFAULT_POINTER_HALO_COLOR);
        this.mPointerHaloColorOnTouch = typedArray.getColor(R.styleable.CircularArcProgressBar_pointer_halo_color_ontouch_, DEFAULT_POINTER_HALO_COLOR_ONTOUCH);
        this.mCircleColor = typedArray.getColor(R.styleable.CircularArcProgressBar_circle_color_, -12303292);
        this.mCircleProgressColor = typedArray.getColor(R.styleable.CircularArcProgressBar_circle_progress_color_, DEFAULT_CIRCLE_PROGRESS_COLOR);
        this.mCircleFillColor = typedArray.getColor(R.styleable.CircularArcProgressBar_circle_fill_, 0);
        this.mPointerAlpha = Color.alpha(this.mPointerHaloColor);
        int i = typedArray.getInt(R.styleable.CircularArcProgressBar_pointer_alpha_ontouch_, 100);
        this.mPointerAlphaOnTouch = i;
        if (i > 255 || i < 0) {
            this.mPointerAlphaOnTouch = 100;
        }
        this.mMax = typedArray.getInt(R.styleable.CircularArcProgressBar_max_, 100);
        this.mProgress = typedArray.getInt(R.styleable.CircularArcProgressBar_progress_, 0);
        this.mCustomRadii = typedArray.getBoolean(R.styleable.CircularArcProgressBar_use_custom_radii_, false);
        this.mMaintainEqualCircle = typedArray.getBoolean(R.styleable.CircularArcProgressBar_maintain_equal_circle_, true);
        this.mMoveOutsideCircle = typedArray.getBoolean(R.styleable.CircularArcProgressBar_move_outside_circle_, false);
        this.lockEnabled = typedArray.getBoolean(R.styleable.CircularArcProgressBar_lock_enabled_, true);
        this.mStartAngle = ((typedArray.getFloat(R.styleable.CircularArcProgressBar_start_angle_, 270.0f) % 360.0f) + 360.0f) % 360.0f;
        float f = ((typedArray.getFloat(R.styleable.CircularArcProgressBar_end_angle_, 270.0f) % 360.0f) + 360.0f) % 360.0f;
        this.mEndAngle = f;
    ...
    public void initPaints() {
        ...
        this.mCircleProgressGlowPaint.setMaskFilter(new BlurMaskFilter(this.DPTOPX_SCALE * 15.0f, BlurMaskFilter.Blur.OUTER));
        ...
        if (this.isTouchEnabled) {
            ...
            if (action == 0) {
                ...
                if (i >= 0 && sqrt <= max && (f7 <= max2 || f8 <= max2)) {
                    ...
                    recalculateAll();
                    invalidate();
                    OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener = this.mOnCircularArcProgressBarChangeListener;
                    if (onCircularArcProgressBarChangeListener != null) {
                        onCircularArcProgressBarChangeListener.onStartTrackingTouch(this);
                    }
                    ...
                    recalculateAll();
                    invalidate();
                    OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener2 = this.mOnCircularArcProgressBarChangeListener;
                    if (onCircularArcProgressBarChangeListener2 != null) {
                        onCircularArcProgressBarChangeListener2.onStartTrackingTouch(this);
                        this.mOnCircularArcProgressBarChangeListener.onProgressChanged(this, this.mProgress, true);
                    }
                    this.mUserIsMovingPointer = true;
                    this.lockAtEnd = false;
                    this.lockAtStart = false;
                ...
                this.mUserIsMovingPointer = false;
                invalidate();
                OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener3 = this.mOnCircularArcProgressBarChangeListener;
                if (onCircularArcProgressBarChangeListener3 != null) {
                    onCircularArcProgressBarChangeListener3.onStopTrackingTouch(this);
                }
            } else if (action != 2) {
                if (action == 3) {
                    this.mPointerHaloPaint.setAlpha(this.mPointerAlpha);
                ...
                if (this.lockAtStart && this.lockEnabled) {
                    ...
                    recalculateAll();
                    invalidate();
                    OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener4 = this.mOnCircularArcProgressBarChangeListener;
                    if (onCircularArcProgressBarChangeListener4 != null) {
                        onCircularArcProgressBarChangeListener4.onProgressChanged(this, this.mProgress, true);
                    }
                } else if (this.lockAtEnd && this.lockEnabled) {
                    this.mProgress = this.mMax;
                    recalculateAll();
                    invalidate();
                    OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener5 = this.mOnCircularArcProgressBarChangeListener;
                    if (onCircularArcProgressBarChangeListener5 != null) {
                        onCircularArcProgressBarChangeListener5.onProgressChanged(this, this.mProgress, true);
                    }
                    ...
                    recalculateAll();
                    invalidate();
                    OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener6 = this.mOnCircularArcProgressBarChangeListener;
                    if (onCircularArcProgressBarChangeListener6 != null) {
                        onCircularArcProgressBarChangeListener6.onProgressChanged(this, this.mProgress, true);
                    }
                }
                this.lastCWDistanceFromStart = this.cwDistanceFromStart;
            }
    ...
    public void setCircleProgressColor(int i) {
        ...
        paint.set(this.mCircleProgressPaint);
        this.mCircleProgressGlowPaint.setMaskFilter(new BlurMaskFilter(this.DPTOPX_SCALE * 15.0f, BlurMaskFilter.Blur.OUTER));
        invalidate();
    }

    public void setCircleProgressColorWithoutGlow(int i) {
        this.mCircleProgressColor = i;
        this.mCircleProgressPaint.setColor(i);
        Paint paint = new Paint();
        this.mCircleProgressGlowPaint = paint;
    ...
    public void setMax(int i) {
        if (i > 0) {
            if (i <= this.mProgress) {
                ...
                OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener = this.mOnCircularArcProgressBarChangeListener;
                if (onCircularArcProgressBarChangeListener != null) {
                    onCircularArcProgressBarChangeListener.onProgressChanged(this, 0, false);
                }
            }
            this.mMax = i;
            recalculateAll();
    ...
    public void setOnSeekBarChangeListener(OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener) {
        this.mOnCircularArcProgressBarChangeListener = onCircularArcProgressBarChangeListener;
    }
    ...
    public void setProgress(int i) {
        if (this.mProgress != i) {
            ...
            OnCircularArcProgressBarChangeListener onCircularArcProgressBarChangeListener = this.mOnCircularArcProgressBarChangeListener;
            if (onCircularArcProgressBarChangeListener != null) {
                onCircularArcProgressBarChangeListener.onProgressChanged(this, i, false);
            }
            recalculateAll();
            invalidate();
        }
    ...
    public CircularArcProgressBar(Context context, AttributeSet attributeSet) {
    ...
    public CircularArcProgressBar(Context context, AttributeSet attributeSet, int i) {
