...
public class BottomSheetDialogWithCustomLayout {
    @NotNull
    ...
    public BottomSheetDialogWithCustomLayout(@NotNull Context context, @NotNull String title, @NotNull String message, boolean z) {
        ...
        bottomSheetDialog.setContentView(R.layout.generic_dialog_two_buttons);
    ...
    public /* synthetic */ BottomSheetDialogWithCustomLayout(Context context, String str, String str2, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
