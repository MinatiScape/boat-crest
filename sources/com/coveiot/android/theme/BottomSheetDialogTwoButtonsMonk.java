...
public class BottomSheetDialogTwoButtonsMonk {
    @NotNull
    ...
    public BottomSheetDialogTwoButtonsMonk(@NotNull Context context, @NotNull String title, @NotNull String message) {
        ...
        bottomSheetDialog.setContentView(R.layout.generic_dialog_two_buttons_monk);
    ...
    public /* synthetic */ BottomSheetDialogTwoButtonsMonk(Context context, String str, String str2, int i, DefaultConstructorMarker defaultConstructorMarker) {
