...
public class BottomSheetDialogImageTitleMessageTwoBtnsWrapContent {
    @NotNull
    ...
    public BottomSheetDialogImageTitleMessageTwoBtnsWrapContent(@NotNull Context context, @NotNull Drawable drawable, @NotNull String title, @NotNull String message, boolean z) {
        ...
        dialog.setContentView(z ? R.layout.generic_dialog_img_two_msg_two_btns2 : R.layout.generic_dialog_img_title_msg_two_btns);
    ...
    public /* synthetic */ BottomSheetDialogImageTitleMessageTwoBtnsWrapContent(Context context, Drawable drawable, String str, String str2, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
