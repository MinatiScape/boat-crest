...
public class BottomSheetDialogOneButtonTitleMessageMonk {
    @NotNull
    ...
    public BottomSheetDialogOneButtonTitleMessageMonk(@NotNull Context context, @NotNull String title, @NotNull String message) {
        ...
        dialog.setContentView(R.layout.generic_dialog_one_button_title_message_monk);
