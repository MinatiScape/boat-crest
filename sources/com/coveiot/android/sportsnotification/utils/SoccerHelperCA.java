...
public final class SoccerHelperCA implements SoccerHelper {
    @NotNull
    public static final SoccerHelperCA INSTANCE = new SoccerHelperCA();
        ...
        if (event != null) {
            ...
            switch (type == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
                ...
                case 2:
                    ...
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, 80, 341, 24, 24, 0, 0, "Penalty Shootout"));
                    break;
                case 3:
                ...
                case 5:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, 45, TGEventListener.SLEEP_STOP, 24, 24, 0, 0, str5));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, 70, 341, 24, 24, 0, 0, "Yellow Red Card"));
                    break;
                case 6:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, 45, TGEventListener.SLEEP_STOP, 24, 24, 0, 0, str6));
                ...
                case 7:
                    ...
                    String str8 = str7;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, 184 - ((str8.length() / 2) * 14), TGEventListener.SLEEP_STOP, 24, 24, 0, 0, str8));
                    ...
                    String str10 = str9;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, 184 - ((str10.length() / 2) * 12), 341, 24, 24, 0, 0, str10));
                    ...
                    String str12 = str11;
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, 184 - ((str12.length() / 2) * 15), 381, 24, 24, 0, 0, str12));
                    break;
            }
        }
        return arrayList;
    ...
    */
    public final java.util.ArrayList<com.coveiot.android.bleabstract.models.DynamicSportsField> d(com.coveiot.android.sportsnotification.utils.SoccerData r19) {
        /*
            Method dump skipped, instructions count: 1475
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.sportsnotification.utils.SoccerHelperCA.d(com.coveiot.android.sportsnotification.utils.SoccerData):java.util.ArrayList");
    }
    ...
    public ArrayList<DynamicSportsField> getMatchCanceledRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, c(soccerData), 70, 24, 24, 0, 0, soccerData.getLeageName()));
    ...
    */
    public java.util.ArrayList<com.coveiot.android.bleabstract.models.DynamicSportsField> getSoccerEventRequest(@org.jetbrains.annotations.NotNull com.coveiot.android.sportsnotification.utils.SoccerData r14) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.sportsnotification.utils.SoccerHelperCA.getSoccerEventRequest(com.coveiot.android.sportsnotification.utils.SoccerData):java.util.ArrayList");
    }
    ...
    public ArrayList<DynamicSportsField> getSoccerSummaryRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, i, 192, 24, 24, 0, 0, str2));
