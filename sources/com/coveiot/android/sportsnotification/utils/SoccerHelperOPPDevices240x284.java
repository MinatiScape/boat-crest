...
public final class SoccerHelperOPPDevices240x284 implements SoccerHelper {
    @NotNull
    public static final SoccerHelperOPPDevices240x284 INSTANCE = new SoccerHelperOPPDevices240x284();

    /* renamed from: a  reason: collision with root package name */
    public static final int f5886a = BleUtils.convertHexTo565("#ffffff");
    ...
    public static /* synthetic */ void b(SoccerHelperOPPDevices240x284 soccerHelperOPPDevices240x284, SoccerData soccerData, ArrayList arrayList, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = 119;
        }
        soccerHelperOPPDevices240x284.a(soccerData, arrayList, i);
    }
        ...
        if (event != null) {
            ...
            switch (type == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
                case 1:
                    ...
                    FontLengthUtilityOPP1 fontLengthUtilityOPP1 = FontLengthUtilityOPP1.INSTANCE;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, str + " (" + event.getTeamName() + ") " + playerName, 0, 2, null)) / 2, 198, 0, 0, 22, 0, str + " (" + event.getTeamName() + ") " + playerName));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, "GOAL", 0, 2, null)) / 2, 229, 22, 22, 0, 0, "GOAL"));
                ...
                case 2:
                    ...
                    FontLengthUtilityOPP1 fontLengthUtilityOPP12 = FontLengthUtilityOPP1.INSTANCE;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP12, str2 + " (" + event.getTeamName() + ") " + playerName2, 0, 2, null)) / 2, 198, 0, 0, 22, 0, str2 + " (" + event.getTeamName() + ") " + playerName2));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP12, "Penalty Shootout", 0, 2, null)) / 2, 229, 22, 22, 0, 0, "Penalty Shootout"));
                ...
                case 3:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP13, str3 + " (" + event.getTeamName() + ") " + playerName3, 0, 2, null)) / 2, 198, 0, 0, 22, 0, str3 + " (" + event.getTeamName() + ") " + playerName3));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP13, "GOAL - PEN", 0, 2, null)) / 2, 229, 22, 22, 0, 0, "GOAL - PEN"));
                ...
                case 4:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str4 + " (" + event.getTeamName() + ") " + playerName4, 0, 2, null)) / 2, 198, 0, 0, 22, 0, str4 + " (" + event.getTeamName() + ") " + playerName4));
                ...
                case 5:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str5 + " (" + event.getTeamName() + ") " + playerName5, 0, 2, null)) / 2, 198, 0, 0, 22, 0, str5 + " (" + event.getTeamName() + ") " + playerName5));
                ...
                case 6:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str6 + " (" + event.getTeamName() + ") " + playerName6, 0, 2, null)) / 2, 198, 0, 0, 22, 0, str6 + " (" + event.getTeamName() + ") " + playerName6));
                ...
                case 7:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP14, str8, 0, 2, null)) / 2, 192, 0, 0, 22, 0, str8));
                    String str9 = "In " + playerIn;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo5653, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP14, str9, 0, 2, null)) / 2, 223, 22, 22, 22, 0, str9));
                    ...
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo5652, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP14, str10, 0, 2, null)) / 2, 254, 22, 22, 22, 0, str10));
                default:
    ...
    public final ArrayList<DynamicSportsField> e(SoccerData soccerData) {
        ...
        if (soccerData.getSoccerSummary() != null) {
            ...
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, "Possn", 0, 2, null)) / 2, 182, 22, 22, 22, 0, "Possn"));
            StringBuilder sb2 = new StringBuilder();
    ...
    public ArrayList<DynamicSportsField> getSoccerEventRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str, 0, 2, null)) / 2, 165, 22, 22, 22, 0, str));
