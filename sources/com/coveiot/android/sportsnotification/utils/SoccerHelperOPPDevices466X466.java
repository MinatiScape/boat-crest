...
public final class SoccerHelperOPPDevices466X466 implements SoccerHelper {
    @NotNull
    public static final SoccerHelperOPPDevices466X466 INSTANCE = new SoccerHelperOPPDevices466X466();

    /* renamed from: a  reason: collision with root package name */
    public static final int f5889a = BleUtils.convertHexTo565("#ffffff");
    public static final int b = BleUtils.convertHexTo565("#ffffff");
    public static final int c = BleUtils.convertHexTo565("#ffffff");
    public static final int d = BleUtils.convertHexTo565("#ffffff");
    public static final int e = BleUtils.convertHexTo565("#ffffff");
    public static final int f = BleUtils.convertHexTo565("#ffffff");
    public static final int g = BleUtils.convertHexTo565("#ffffff");
    public static final int h = 74;
    public static final int i = 466;
    public static final int j = 54;
    public static final int k = PressureParam.STATE_ALL_DAY;
    ...
    public static /* synthetic */ void b(SoccerHelperOPPDevices466X466 soccerHelperOPPDevices466X466, SoccerData soccerData, ArrayList arrayList, int i2, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            i2 = 181;
        }
        soccerHelperOPPDevices466X466.a(soccerData, arrayList, i2);
    }
        ...
        if (event != null) {
            ...
            switch (type == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
                case 1:
                    ...
                    int i4 = i;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (i4 - stringWidth$default) / 2, 286, 30, 30, 30, 0, str + " (" + event.getTeamName() + ") " + playerName));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (i4 - FontLengthUtilityOPP3.getStringWidth$default(fontLengthUtilityOPP3, "GOAL", 0, 2, null)) / 2, 328, 30, 30, 30, 0, "GOAL"));
                ...
                case 2:
                    ...
                    int i5 = i;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (i5 - stringWidth$default2) / 2, 286, 30, 30, 30, 0, str2 + " (" + event.getTeamName() + ") " + playerName2));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (i5 - FontLengthUtilityOPP3.getStringWidth$default(fontLengthUtilityOPP32, "Penalty Shootout", 0, 2, null)) / 2, 328, 30, 30, 30, 0, "Penalty Shootout"));
                ...
                case 3:
                    ...
                    int i6 = i;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (i6 - stringWidth$default3) / 2, 286, 30, 30, 30, 0, str3 + " (" + event.getTeamName() + ") " + playerName3));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (i6 - FontLengthUtilityOPP3.getStringWidth$default(fontLengthUtilityOPP33, "GOAL - PEN", 0, 2, null)) / 2, 328, 30, 30, 30, 0, "GOAL - PEN"));
                ...
                case 4:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (i - FontLengthUtilityOPP3.getStringWidth$default(FontLengthUtilityOPP3.INSTANCE, str4 + " (" + event.getTeamName() + ") " + playerName4, 0, 2, null)) / 2, TGEventListener.OTA_COMPLETED, 30, 30, 30, 0, str4 + " (" + event.getTeamName() + ") " + playerName4));
                    arrayList.add(new DynamicSportFieldRectangle(7, convertHexTo5654, 220, 391, 26, 31));
                ...
                case 5:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (i - FontLengthUtilityOPP3.getStringWidth$default(FontLengthUtilityOPP3.INSTANCE, str5 + " (" + event.getTeamName() + ") " + playerName5, 0, 2, null)) / 2, TGEventListener.OTA_COMPLETED, 30, 30, 30, 0, str5 + " (" + event.getTeamName() + ") " + playerName5));
                    arrayList.add(new DynamicSportFieldRectangle(7, convertHexTo5654, 230, 409, 26, 31));
                    arrayList.add(new DynamicSportFieldRectangle(8, convertHexTo5655, 220, 391, 26, 31));
                ...
                case 6:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (i - FontLengthUtilityOPP3.getStringWidth$default(FontLengthUtilityOPP3.INSTANCE, str6 + " (" + event.getTeamName() + ") " + playerName6, 0, 2, null)) / 2, TGEventListener.OTA_COMPLETED, 30, 30, 30, 0, str6 + " (" + event.getTeamName() + ") " + playerName6));
                    arrayList.add(new DynamicSportFieldRectangle(7, convertHexTo5655, 220, 391, 26, 31));
                ...
                case 7:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (i7 - FontLengthUtilityOPP3.getStringWidth$default(fontLengthUtilityOPP34, str8, 0, 2, null)) / 2, TGEventListener.SLEEP_START, 30, 30, 30, 0, str8));
                    String str9 = "In " + playerIn;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo5653, (i7 - FontLengthUtilityOPP3.getStringWidth$default(fontLengthUtilityOPP34, str9, 0, 2, null)) / 2, b.m1, 30, 30, 30, 0, str9));
                    ...
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo5652, (i7 - FontLengthUtilityOPP3.getStringWidth$default(fontLengthUtilityOPP34, str10, 0, 2, null)) / 2, 374, 30, 30, 30, 0, str10));
                default:
    ...
    public ArrayList<DynamicSportsField> getMatchCanceledRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (i - FontLengthUtilityOPP3.INSTANCE.getStringWidth("Match canceled", 30)) / 2, 328, 30, 30, 30, 0, "Match canceled"));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getMatchStartAtRequest(@NotNull SoccerData soccerData) {
        ...
        int i2 = i;
        FontLengthUtilityOPP3 fontLengthUtilityOPP3 = FontLengthUtilityOPP3.INSTANCE;
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (i2 - fontLengthUtilityOPP3.getStringWidth("Match will start at", 30)) / 2, b.i1, 30, 30, 30, 0, "Match will start at"));
        Intrinsics.checkNotNullExpressionValue(dateStr, "dateStr");
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (i2 - fontLengthUtilityOPP3.getStringWidth(dateStr, 30)) / 2, 364, 30, 30, 30, 0, dateStr));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getNoMatchSelectedRequest() {
        ...
        int convertHexTo565 = BleUtils.convertHexTo565("#ffffff");
        arrayList.add(new DynamicSportFieldImage(1, -1, 0, 0, -1, -1, 996));
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (i - FontLengthUtilityOPP3.INSTANCE.getStringWidth("No Match Selected", 30)) / 2, 328, 30, 30, 30, 0, "No Match Selected"));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getOfflineRequest() {
        ...
        int convertHexTo565 = BleUtils.convertHexTo565("#ffffff");
        arrayList.add(new DynamicSportFieldImage(1, -1, 0, 0, -1, -1, 996));
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (i - FontLengthUtilityOPP3.INSTANCE.getStringWidth("Offline", 30)) / 2, 328, 30, 30, 30, 0, "Offline"));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getSoccerEventRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, (i - FontLengthUtilityOPP3.getStringWidth$default(FontLengthUtilityOPP3.INSTANCE, str, 0, 2, null)) / 2, 244, 30, 30, 30, 0, str));
