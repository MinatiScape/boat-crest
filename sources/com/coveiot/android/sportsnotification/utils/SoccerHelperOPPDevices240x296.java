...
public final class SoccerHelperOPPDevices240x296 implements SoccerHelper {
    @NotNull
    public static final SoccerHelperOPPDevices240x296 INSTANCE = new SoccerHelperOPPDevices240x296();

    /* renamed from: a  reason: collision with root package name */
    public static final int f5887a = BleUtils.convertHexTo565("#ffffff");
    ...
    public static /* synthetic */ void b(SoccerHelperOPPDevices240x296 soccerHelperOPPDevices240x296, SoccerData soccerData, ArrayList arrayList, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = 128;
        }
        soccerHelperOPPDevices240x296.a(soccerData, arrayList, i);
    }
    ...
    public final void a(SoccerData soccerData, ArrayList<DynamicSportsField> arrayList, int i) {
        ...
        if (Integer.parseInt(soccerData.getTeamAPenaltyScore()) == 0 && Integer.parseInt(soccerData.getTeamBPenaltyScore()) == 0) {
            ...
            int i2 = f;
            FontLengthUtilityOPP1 fontLengthUtilityOPP1 = FontLengthUtilityOPP1.INSTANCE;
            arrayList.add(new DynamicSportFieldText(1, i2, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, str, 0, 2, null)) / 2, i, 22, 22, 22, 0, str));
            arrayList.add(new DynamicSportFieldText(1, convertHexTo5652, 230 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, soccerData.getTeamBShortName(), 0, 2, null), i, 22, 22, 22, 0, soccerData.getTeamBShortName()));
            return;
        }
        soccerData.getTeamAShortName().length();
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, 10, i, 22, 22, 22, 0, soccerData.getTeamAShortName()));
        ...
        int i3 = f;
        FontLengthUtilityOPP1 fontLengthUtilityOPP12 = FontLengthUtilityOPP1.INSTANCE;
        arrayList.add(new DynamicSportFieldText(1, i3, (240 - fontLengthUtilityOPP12.getStringWidth(str2, 22)) / 2, i, 22, 22, 22, 0, str2));
        arrayList.add(new DynamicSportFieldText(1, convertHexTo5652, 230 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP12, soccerData.getTeamBShortName(), 0, 2, null), i, 22, 22, 22, 0, soccerData.getTeamBShortName()));
    }
        ...
        if (event != null) {
            ...
            switch (type == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
                case 1:
                    ...
                    FontLengthUtilityOPP1 fontLengthUtilityOPP1 = FontLengthUtilityOPP1.INSTANCE;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, str + " (" + event.getTeamName() + ") " + playerName, 0, 2, null)) / 2, 194, 0, 0, 22, 0, str + " (" + event.getTeamName() + ") " + playerName));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, "GOAL", 0, 2, null)) / 2, 225, 22, 22, 0, 0, "GOAL"));
                ...
                case 2:
                    ...
                    FontLengthUtilityOPP1 fontLengthUtilityOPP12 = FontLengthUtilityOPP1.INSTANCE;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP12, str2 + " (" + event.getTeamName() + ") " + playerName2, 0, 2, null)) / 2, 194, 0, 0, 22, 0, str2 + " (" + event.getTeamName() + ") " + playerName2));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP12, "Penalty Shootout", 0, 2, null)) / 2, 225, 22, 22, 0, 0, "Penalty Shootout"));
                ...
                case 3:
                    ...
                    FontLengthUtilityOPP1 fontLengthUtilityOPP13 = FontLengthUtilityOPP1.INSTANCE;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP13, str3 + " (" + event.getTeamName() + ") " + playerName3, 0, 2, null)) / 2, 194, 0, 0, 22, 0, str3 + " (" + event.getTeamName() + ") " + playerName3));
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP13, "GOAL - PEN", 0, 2, null)) / 2, 225, 22, 22, 0, 0, "GOAL - PEN"));
                ...
                case 4:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str4 + " (" + event.getTeamName() + ") " + playerName4, 0, 2, null)) / 2, 194, 0, 0, 22, 0, str4 + " (" + event.getTeamName() + ") " + playerName4));
                ...
                case 5:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str5 + " (" + event.getTeamName() + ") " + playerName5, 0, 2, null)) / 2, 194, 0, 0, 22, 0, str5 + " (" + event.getTeamName() + ") " + playerName5));
                ...
                case 6:
                    ...
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str6 + " (" + event.getTeamName() + ") " + playerName6, 0, 2, null)) / 2, 194, 0, 0, 22, 0, str6 + " (" + event.getTeamName() + ") " + playerName6));
                ...
                case 7:
                    ...
                    FontLengthUtilityOPP1 fontLengthUtilityOPP14 = FontLengthUtilityOPP1.INSTANCE;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP14, str8, 0, 2, null)) / 2, 194, 0, 0, 22, 0, str8));
                    String str9 = "In " + playerIn;
                    arrayList.add(new DynamicSportFieldText(6, convertHexTo5653, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP14, str9, 0, 2, null)) / 2, 225, 22, 22, 22, 0, str9));
                    ...
                    arrayList.add(new DynamicSportFieldText(7, convertHexTo5652, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP14, str10, 0, 2, null)) / 2, 256, 22, 22, 22, 0, str10));
                default:
    ...
    public final int d(SoccerData soccerData) {
        return (240 - FontLengthUtilityOPP1.INSTANCE.getStringWidth(soccerData.getLeageName(), 22)) / 2;
    }
    ...
    public final ArrayList<DynamicSportsField> e(SoccerData soccerData) {
        ...
        if (soccerData.getSoccerSummary() != null) {
            ...
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 10, 161, 22, 22, 22, 0, String.valueOf(soccerSummary.getShotsOnTarget()[0].intValue())));
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 61, 161, 22, 22, 22, 0, "Shots on Tgt"));
            FontLengthUtilityOPP1 fontLengthUtilityOPP1 = FontLengthUtilityOPP1.INSTANCE;
            SoccerSummary soccerSummary2 = soccerData.getSoccerSummary();
            Intrinsics.checkNotNull(soccerSummary2);
            int stringWidth$default = 230 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, String.valueOf(soccerSummary2.getShotsOnTarget()[1].intValue()), 0, 2, null);
            SoccerSummary soccerSummary3 = soccerData.getSoccerSummary();
            Intrinsics.checkNotNull(soccerSummary3);
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, stringWidth$default, 161, 22, 22, 22, 0, String.valueOf(soccerSummary3.getShotsOnTarget()[1].intValue())));
            StringBuilder sb = new StringBuilder();
            ...
            sb.append('%');
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 10, 192, 22, 22, 22, 0, sb.toString()));
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, "Possn", 0, 2, null)) / 2, 192, 22, 22, 22, 0, "Possn"));
            StringBuilder sb2 = new StringBuilder();
            ...
            sb2.append('%');
            int stringWidth$default2 = 230 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, sb2.toString(), 0, 2, null);
            StringBuilder sb3 = new StringBuilder();
            ...
            sb3.append('%');
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, stringWidth$default2, 192, 22, 22, 22, 0, sb3.toString()));
            StringBuilder sb4 = new StringBuilder();
            ...
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 10, 223, 22, 22, 22, 0, sb4.toString()));
            arrayList.add(new DynamicSportFieldText(3, convertHexTo5652, 80, 223, 22, 22, 22, 0, "Y/R Card"));
            StringBuilder sb5 = new StringBuilder();
            ...
            int stringWidth$default3 = 230 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, sb5.toString(), 0, 2, null);
            StringBuilder sb6 = new StringBuilder();
            ...
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, stringWidth$default3, 223, 22, 22, 22, 0, sb6.toString()));
            SoccerSummary soccerSummary13 = soccerData.getSoccerSummary();
            Intrinsics.checkNotNull(soccerSummary13);
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, 10, 254, 22, 22, 22, 0, String.valueOf(soccerSummary13.getFouls()[0].intValue())));
            arrayList.add(new DynamicSportFieldText(3, g, 94, 254, 22, 22, 22, 0, "Fouls"));
            SoccerSummary soccerSummary14 = soccerData.getSoccerSummary();
            Intrinsics.checkNotNull(soccerSummary14);
            int stringWidth$default4 = 230 - FontLengthUtilityOPP1.getStringWidth$default(fontLengthUtilityOPP1, String.valueOf(soccerSummary14.getFouls()[1].intValue()), 0, 2, null);
            SoccerSummary soccerSummary15 = soccerData.getSoccerSummary();
            Intrinsics.checkNotNull(soccerSummary15);
            arrayList.add(new DynamicSportFieldText(3, convertHexTo565, stringWidth$default4, 254, 22, 22, 22, 0, String.valueOf(soccerSummary15.getFouls()[1].intValue())));
        }
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getMatchCanceledRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (240 - FontLengthUtilityOPP1.INSTANCE.getStringWidth("Match canceled", 22)) / 2, 220, 22, 22, 22, 0, "Match canceled"));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getMatchStartAtRequest(@NotNull SoccerData soccerData) {
        ...
        FontLengthUtilityOPP1 fontLengthUtilityOPP1 = FontLengthUtilityOPP1.INSTANCE;
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (240 - fontLengthUtilityOPP1.getStringWidth("Match will start at", 22)) / 2, 220, 22, 22, 22, 0, "Match will start at"));
        Intrinsics.checkNotNullExpressionValue(dateStr, "dateStr");
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (240 - fontLengthUtilityOPP1.getStringWidth(dateStr, 22)) / 2, 254, 22, 22, 22, 0, dateStr));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getNoMatchSelectedRequest() {
        ...
        int convertHexTo565 = BleUtils.convertHexTo565("#ffffff");
        arrayList.add(new DynamicSportFieldImage(1, -1, 0, 0, -1, -1, 996));
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (240 - FontLengthUtilityOPP1.INSTANCE.getStringWidth("No Match Selected", 22)) / 2, 220, 22, 22, 22, 0, "No Match Selected"));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getOfflineRequest() {
        ...
        int convertHexTo565 = BleUtils.convertHexTo565("#ffffff");
        arrayList.add(new DynamicSportFieldImage(1, -1, 0, 0, -1, -1, 996));
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, (240 - FontLengthUtilityOPP1.INSTANCE.getStringWidth("Offline", 22)) / 2, 220, 22, 22, 22, 0, "Offline"));
        return arrayList;
    }
    ...
    public ArrayList<DynamicSportsField> getSoccerEventRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(3, convertHexTo565, (240 - FontLengthUtilityOPP1.getStringWidth$default(FontLengthUtilityOPP1.INSTANCE, str, 0, 2, null)) / 2, 161, 22, 22, 22, 0, str));
    ...
    public ArrayList<DynamicSportsField> getSoccerSummaryRequest(@NotNull SoccerData soccerData) {
        ...
        arrayList.add(new DynamicSportFieldText(1, convertHexTo565, d(soccerData), h, 22, 22, 22, 0, soccerData.getLeageName()));
        a(soccerData, arrayList, 128);
