...
public class SoccerFilterItemBindingImpl extends SoccerFilterItemBinding {
    @Nullable
    ...
    public SoccerFilterItemBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public SoccerFilterItemBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
