...
public class ActivitySportsFilterBindingImpl extends ActivitySportsFilterBinding {
    @Nullable
    ...
    public ActivitySportsFilterBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public ActivitySportsFilterBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
