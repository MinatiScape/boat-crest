...
public final class ManageHealthBuddiesAdapter extends BaseExpandableListAdapter {
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    public List<String> f4569a;
    @Nullable
    ...
    public ManageHealthBuddiesAdapter(@NotNull Context context, @Nullable HashMap<String, List<HealthBuddy>> hashMap, @NotNull List<String> titles, @NotNull OnOptionSelectedListener itemClickInterface) {
    ...
    public static final void g(ManageHealthBuddiesAdapter this$0, HealthBuddy healthBuddy, View view) {
    ...
    public static final void h(ManageHealthBuddiesAdapter this$0, HealthBuddy healthBuddy, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        OnOptionSelectedListener onOptionSelectedListener = this$0.c;
        Integer num = healthBuddy.requestId;
        Intrinsics.checkNotNullExpressionValue(num, "buddyInfo.requestId");
    ...
    public static final void j(ManageHealthBuddiesAdapter this$0, HealthBuddy healthBuddy, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        OnOptionSelectedListener onOptionSelectedListener = this$0.c;
    ...
    */
    public android.view.View getChildView(int r17, int r18, boolean r19, @org.jetbrains.annotations.Nullable android.view.View r20, @org.jetbrains.annotations.Nullable android.view.ViewGroup r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.healthbuddies.adapters.ManageHealthBuddiesAdapter.getChildView(int, int, boolean, android.view.View, android.view.ViewGroup):android.view.View");
    }
    ...
    public int getChildrenCount(int i) {
        ...
        if (hashMap != null) {
            if ((hashMap != null ? hashMap.get(this.f4569a.get(i)) : null) != null) {
                HashMap<String, List<HealthBuddy>> hashMap2 = this.b;
                Intrinsics.checkNotNull(hashMap2);
                List<HealthBuddy> list = hashMap2.get(this.f4569a.get(i));
    ...
    public HealthBuddy getChild(int i, int i2) {
        ...
        if (!(hashMap == null || hashMap.isEmpty())) {
            String str = this.f4569a.get(i);
            if (!(str == null || str.length() == 0)) {
                HashMap<String, List<HealthBuddy>> hashMap2 = this.b;
                List<HealthBuddy> list = hashMap2 != null ? hashMap2.get(this.f4569a.get(i)) : null;
                if (list == null || list.isEmpty()) {
                    z = true;
                }
                if (!z) {
                    HashMap<String, List<HealthBuddy>> hashMap3 = this.b;
                    Intrinsics.checkNotNull(hashMap3);
                    List<HealthBuddy> list2 = hashMap3.get(this.f4569a.get(i));
