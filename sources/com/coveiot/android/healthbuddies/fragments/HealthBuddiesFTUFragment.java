...
public final class HealthBuddiesFTUFragment extends Fragment implements HealthBuddiesConsentFragment.ConsentListener, AddHealthBuddiesFragment.AddHealthBuddyListener {
    @NotNull
    public Map<Integer, View> _$_findViewCache = new LinkedHashMap();
    @Nullable
    public BottomSheetDialogWellnessCrew h;

    public static final void b(HealthBuddiesFTUFragment this$0, View view) {
    ...
    @Nullable
    public final BottomSheetDialogWellnessCrew getDialog() {
        return this.h;
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return inflater.inflate(R.layout.fragment_health_buddies_ftu, viewGroup, false);
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        ((TextView) view.findViewById(R.id.tvAddFriends)).setOnClickListener(new View.OnClickListener() { // from class: com.coveiot.android.healthbuddies.fragments.h
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                HealthBuddiesFTUFragment.b(HealthBuddiesFTUFragment.this, view2);
            }
        });
    }

    public final void setDialog(@Nullable BottomSheetDialogWellnessCrew bottomSheetDialogWellnessCrew) {
        this.h = bottomSheetDialogWellnessCrew;
    }
}
