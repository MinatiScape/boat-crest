...
public class MedicineReminder extends CustomReminder {
    private int advanceTime;
    private Calendar endDate;
    private Calendar startDate;
    private ArrayList<TimeInfo> timeInfos;

    public MedicineReminder(boolean z, RepeatModel repeatModel, String str, Calendar calendar, Calendar calendar2, int i, ArrayList<TimeInfo> arrayList) {
        super(repeatModel, str, z, ReminderType.MEDICINE.name());
    ...
    public MedicineReminder() {
        super(ReminderType.MEDICINE.name());
    }
}
