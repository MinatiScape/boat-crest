...
public class MeetingReminder extends CustomReminder {
    private int advanceTime;
    private Calendar endDate;
    private Calendar startDate;
    private ArrayList<TimeInfo> timeInfos;

    public MeetingReminder(boolean z, RepeatModel repeatModel, String str, Calendar calendar, Calendar calendar2, int i, ArrayList<TimeInfo> arrayList) {
        super(repeatModel, str, z, ReminderType.MEETING.name());
    ...
    public MeetingReminder() {
        super(ReminderType.MEETING.name());
    }
}
