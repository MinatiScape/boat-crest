...
public final class BpDataRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final BpDataRequest build() {
            BpDataRequest bpDataRequest = new BpDataRequest();
            bpDataRequest.setEndDate$bleabstract_release(this.b);
            bpDataRequest.setStartHour$bleabstract_release(this.c);
            bpDataRequest.setStartDate$bleabstract_release(this.f3478a);
            bpDataRequest.setEndHour$bleabstract_release(this.d);
            return bpDataRequest;
        }
