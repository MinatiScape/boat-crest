...
public final class RrHistoryRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final RrHistoryRequest build() {
            RrHistoryRequest rrHistoryRequest = new RrHistoryRequest();
            rrHistoryRequest.setEndDate$bleabstract_release(this.b);
            rrHistoryRequest.setStartHour$bleabstract_release(this.c);
            rrHistoryRequest.setStartDate$bleabstract_release(this.f3514a);
            rrHistoryRequest.setEndHour$bleabstract_release(this.d);
            return rrHistoryRequest;
        }
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_RR_HISTORY_DATA;
    }
