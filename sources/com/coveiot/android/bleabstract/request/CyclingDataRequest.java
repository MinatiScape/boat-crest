...
public final class CyclingDataRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final CyclingDataRequest build() {
            CyclingDataRequest cyclingDataRequest = new CyclingDataRequest();
            cyclingDataRequest.setEndDate$bleabstract_release(this.b);
            cyclingDataRequest.setStartHour$bleabstract_release(this.c);
            cyclingDataRequest.setStartDate$bleabstract_release(this.f3484a);
            cyclingDataRequest.setEndHour$bleabstract_release(this.d);
            return cyclingDataRequest;
        }
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_CYCLING_DATA;
    }
