...
public final class StressDataRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final StressDataRequest build() {
            StressDataRequest stressDataRequest = new StressDataRequest();
            stressDataRequest.setEndDate$bleabstract_release(this.b);
            stressDataRequest.setStartHour$bleabstract_release(this.c);
            stressDataRequest.setStartDate$bleabstract_release(this.f3566a);
            stressDataRequest.setEndHour$bleabstract_release(this.d);
            return stressDataRequest;
        }
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_STRESS_DATA;
    }
