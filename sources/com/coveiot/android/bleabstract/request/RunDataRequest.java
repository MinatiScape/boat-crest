...
public final class RunDataRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final RunDataRequest build() {
            RunDataRequest runDataRequest = new RunDataRequest();
            runDataRequest.setEndDate$bleabstract_release(this.b);
            runDataRequest.setStartHour$bleabstract_release(this.c);
            runDataRequest.setStartDate$bleabstract_release(this.f3515a);
            runDataRequest.setEndHour$bleabstract_release(this.d);
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_RUN_DATA;
    }
