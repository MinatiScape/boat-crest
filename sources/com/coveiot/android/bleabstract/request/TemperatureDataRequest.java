...
public final class TemperatureDataRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final TemperatureDataRequest build() {
            TemperatureDataRequest temperatureDataRequest = new TemperatureDataRequest();
            temperatureDataRequest.setEndDate$bleabstract_release(this.b);
            temperatureDataRequest.setStartHour$bleabstract_release(this.c);
            temperatureDataRequest.setStartDate$bleabstract_release(this.f3571a);
            temperatureDataRequest.setEndHour$bleabstract_release(this.d);
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_TEMPERATURE_DATA;
    }
