...
public final class ReadSedentaryDataRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final ReadSedentaryDataRequest build() {
            ReadSedentaryDataRequest readSedentaryDataRequest = new ReadSedentaryDataRequest();
            readSedentaryDataRequest.setEndDate$bleabstract_release(this.b);
            readSedentaryDataRequest.setStartHour$bleabstract_release(this.c);
            readSedentaryDataRequest.setStartDate$bleabstract_release(this.f3512a);
            readSedentaryDataRequest.setEndHour$bleabstract_release(this.d);
            return readSedentaryDataRequest;
        }
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_SEDENTARY_DATA;
    }
