...
public final class HeartRateDataRequest extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final HeartRateDataRequest build() {
            HeartRateDataRequest heartRateDataRequest = new HeartRateDataRequest();
            heartRateDataRequest.setEndDate$bleabstract_release(this.b);
            heartRateDataRequest.setStartHour$bleabstract_release(this.c);
            heartRateDataRequest.setStartDate$bleabstract_release(this.f3498a);
            heartRateDataRequest.setEndHour$bleabstract_release(this.d);
            return heartRateDataRequest;
        }
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_HEARTRATE_DATA;
    }
