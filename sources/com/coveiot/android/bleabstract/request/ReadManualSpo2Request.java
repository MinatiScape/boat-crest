...
public final class ReadManualSpo2Request extends BleBaseRequest {
    @Nullable
    public Date f;
    @Nullable
    public Date g;
    ...
    public static final class Builder {
        ...
        @NotNull
        public final ReadManualSpo2Request build() {
            ReadManualSpo2Request readManualSpo2Request = new ReadManualSpo2Request();
            readManualSpo2Request.setEndDate$bleabstract_release(this.b);
            readManualSpo2Request.setStartHour$bleabstract_release(this.c);
            readManualSpo2Request.setStartDate$bleabstract_release(this.f3509a);
            readManualSpo2Request.setEndHour$bleabstract_release(this.d);
            return readManualSpo2Request;
        }
    ...
    public BleCommand getBleCommand() {
        return BleCommand.GET_MANUAL_SPO2_DATA;
    }
