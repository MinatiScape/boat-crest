...
public final class WaveRegalBleApiImpl extends TFTWaveSigmaBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = WaveRegalBleApiImpl.class.getSimpleName();
    @Nullable
    public static WaveRegalBleApiImpl E;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final WaveRegalBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (WaveRegalBleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                WaveRegalBleApiImpl.E = new WaveRegalBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(WaveRegalBleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
