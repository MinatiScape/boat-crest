...
public class TFTStormCall2BleApiImpl extends ULC5UltimaConnectBleApiImpl {
    @Nullable
    public static TFTStormCall2BleApiImpl C;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String B = TFTStormCall2BleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final TFTStormCall2BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (TFTStormCall2BleApiImpl.C == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                TFTStormCall2BleApiImpl.C = new TFTStormCall2BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(TFTStormCall2BleApiImpl.B, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return TFTStormCall2BleApiImpl.C;
        }
    }
