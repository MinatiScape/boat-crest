...
public class CY1ABleApiImpl extends CY1BleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = CY1ABleApiImpl.class.getSimpleName();
    @Nullable
    public static CY1ABleApiImpl E;
    public final String C = CY1ABleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CY1ABleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CY1ABleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CY1ABleApiImpl.E = new CY1ABleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CY1ABleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, CY1ABleApiImpl this$0) {
            ...
            case 1:
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.h0
                            @Override // java.lang.Runnable
                            public final void run() {
                                CY1ABleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.g0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    CY1ABleApiImpl.a(CY1ABleApiImpl.this, liveStepsData);
                                }
                            });
                        }
    ...
    public static final void a(CY1ABleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
