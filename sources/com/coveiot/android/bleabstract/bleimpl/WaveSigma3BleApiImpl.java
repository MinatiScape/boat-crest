...
public class WaveSigma3BleApiImpl extends TFTWaveSigmaBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = WaveSigma3BleApiImpl.class.getSimpleName();
    @Nullable
    public static WaveSigma3BleApiImpl E;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final WaveSigma3BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (WaveSigma3BleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                WaveSigma3BleApiImpl.E = new WaveSigma3BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(WaveSigma3BleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
