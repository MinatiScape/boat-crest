...
public class WaveConvexBleApiImpl extends CA6BTABleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String G = WaveConvexBleApiImpl.class.getSimpleName();
    @Nullable
    public static WaveConvexBleApiImpl H;
    public final String F = WaveConvexBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final WaveConvexBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (WaveConvexBleApiImpl.H == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                WaveConvexBleApiImpl.H = new WaveConvexBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(WaveConvexBleApiImpl.G, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, WaveConvexBleApiImpl this$0) {
            ...
            case 1:
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.oa
                            @Override // java.lang.Runnable
                            public final void run() {
                                WaveConvexBleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.na
                                @Override // java.lang.Runnable
                                public final void run() {
                                    WaveConvexBleApiImpl.a(WaveConvexBleApiImpl.this, liveStepsData);
                                }
                            });
                        }
    ...
    public static final void a(WaveConvexBleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
