...
public final class ULC2WaveBeatPlusBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static ULC2WaveBeatPlusBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = ULC2WaveBeatPlusBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final ULC2WaveBeatPlusBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (ULC2WaveBeatPlusBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                ULC2WaveBeatPlusBleApiImpl.A = new ULC2WaveBeatPlusBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(ULC2WaveBeatPlusBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return ULC2WaveBeatPlusBleApiImpl.A;
        }
    }
