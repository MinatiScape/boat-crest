...
public final class TFTWaveActiveBleApiImpl extends ULC5UltimaConnectBleApiImpl {
    @Nullable
    public static TFTWaveActiveBleApiImpl C;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String B = TFTWaveActiveBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final TFTWaveActiveBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (TFTWaveActiveBleApiImpl.C == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                TFTWaveActiveBleApiImpl.C = new TFTWaveActiveBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(TFTWaveActiveBleApiImpl.B, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return TFTWaveActiveBleApiImpl.C;
        }
    }
