...
public final class EastApexStrideVoiceBleApiImpl extends EastApexBaseBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<EastApexStrideVoiceBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.EastApexStrideVoiceBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, EastApexStrideVoiceBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f2960a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, EastApexStrideVoiceBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public EastApexStrideVoiceBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new EastApexStrideVoiceBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f2960a);
        }
    ...
    public EastApexStrideVoiceBleApiImpl(@NotNull Context context) {
        super(context);
