...
public final class CRPY20BleApiImpl extends CRPBaseBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);

    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<CRPY20BleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.CRPY20BleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, CRPY20BleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f2929a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, CRPY20BleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public CRPY20BleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new CRPY20BleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f2929a);
        }
    ...
    public CRPY20BleApiImpl(@NotNull Context context) {
        super(context);
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        if (deviceSupportedFeat41 != null) {
            deviceSupportedFeat41.setManualSpo2SupportedOnBand(isManualSPO2SupportedOnBand());
        }
