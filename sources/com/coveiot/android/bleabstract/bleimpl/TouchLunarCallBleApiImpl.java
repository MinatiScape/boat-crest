...
public final class TouchLunarCallBleApiImpl extends TouchELXBaseBleImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<TouchLunarCallBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.TouchLunarCallBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, TouchLunarCallBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3284a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, TouchLunarCallBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public TouchLunarCallBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new TouchLunarCallBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3284a);
        }
    ...
    public TouchLunarCallBleApiImpl(@NotNull Context context) {
        super(context);
