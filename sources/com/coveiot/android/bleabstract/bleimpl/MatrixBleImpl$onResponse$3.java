...
@DebugMetadata(c = "com.coveiot.android.bleabstract.bleimpl.MatrixBleImpl$onResponse$3", f = "MatrixBleImpl.kt", i = {0, 0}, l = {1363}, m = "invokeSuspend", n = {"response", "bleBaseResponse"}, s = {"L$1", "L$2"})
/* loaded from: classes2.dex */
public final class MatrixBleImpl$onResponse$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.coveiot.android.bleabstract.bleimpl.MatrixBleImpl$onResponse$3$2", f = "MatrixBleImpl.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.coveiot.android.bleabstract.bleimpl.MatrixBleImpl$onResponse$3$2  reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ MatrixBleImpl f3192a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(MatrixBleImpl matrixBleImpl, Continuation<? super AnonymousClass2> continuation) {
            super(2, continuation);
            this.f3192a = matrixBleImpl;
        }
        ...
        public Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return new AnonymousClass2(this.f3192a, continuation).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            String macAddress = this.f3192a.getMacAddress();
            BleApiUtils bleApiUtils = BleApiUtils.INSTANCE;
            companion.getInstance(this.f3192a.getContext()).updateSleepDetailProcessedBefore(macAddress, bleApiUtils.getTodayStartTime().getTimeInMillis());
            companion.getInstance(this.f3192a.getContext()).updateSleepDataProcessedBefore(this.f3192a.getMacAddress(), bleApiUtils.getTodayStartTime().getTimeInMillis());
            return Unit.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MatrixBleImpl$onResponse$3(MatrixBaseRes matrixBaseRes, Ref.ObjectRef<BleBaseRequest> objectRef, MatrixBleImpl matrixBleImpl, DataResultListener dataResultListener, Continuation<? super MatrixBleImpl$onResponse$3> continuation) {
        super(2, continuation);
    ...
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new MatrixBleImpl$onResponse$3(this.e, this.f, this.g, this.h, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return new MatrixBleImpl$onResponse$3(this.e, this.f, this.g, this.h, continuation).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r12) {
        /*
            ...
            java.lang.Object r4 = r11.f3191a
        ...
        L6b:
            ...
            com.coveiot.android.bleabstract.bleimpl.h6 r7 = new com.coveiot.android.bleabstract.bleimpl.h6
            r7.<init>()
            r5.post(r7)
            ...
            com.coveiot.android.bleabstract.bleimpl.MatrixBleImpl$onResponse$3$2 r8 = new com.coveiot.android.bleabstract.bleimpl.MatrixBleImpl$onResponse$3$2
        ...
        La8:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.bleimpl.MatrixBleImpl$onResponse$3.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
