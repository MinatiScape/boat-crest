...
public class JC2305BBleApiImpl extends CA6BTABleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String H = JC2305BBleApiImpl.class.getSimpleName();
    @Nullable
    public static JC2305BBleApiImpl I;
    @NotNull
    public final DevicePlatformEnum F = DevicePlatformEnum.Realtek;
    public final String G = JC2305BBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final JC2305BBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (JC2305BBleApiImpl.I == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                JC2305BBleApiImpl.I = new JC2305BBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(JC2305BBleApiImpl.H, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, JC2305BBleApiImpl this$0) {
            ...
            case 1:
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.j3
                            @Override // java.lang.Runnable
                            public final void run() {
                                JC2305BBleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.i3
                                @Override // java.lang.Runnable
                                public final void run() {
                                    JC2305BBleApiImpl.a(JC2305BBleApiImpl.this, liveStepsData);
                                }
                            });
                        }
    ...
    public static final void a(JC2305BBleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
