...
public final class EastApexLunarCallAceBleApiImpl extends EastApexBaseBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<EastApexLunarCallAceBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.EastApexLunarCallAceBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, EastApexLunarCallAceBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f2956a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, EastApexLunarCallAceBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public EastApexLunarCallAceBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new EastApexLunarCallAceBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f2956a);
        }
    ...
    public EastApexLunarCallAceBleApiImpl(@NotNull Context context) {
        super(context);
