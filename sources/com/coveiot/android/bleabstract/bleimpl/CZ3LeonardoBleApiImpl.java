...
public final class CZ3LeonardoBleApiImpl extends CZ0LeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String r = CZ3LeonardoBleApiImpl.class.getSimpleName();
    @Nullable
    public static CZ3LeonardoBleApiImpl s;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CZ3LeonardoBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CZ3LeonardoBleApiImpl.s == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CZ3LeonardoBleApiImpl.s = new CZ3LeonardoBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CZ3LeonardoBleApiImpl.r, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CZ3LeonardoBleApiImpl.s;
        }
    }
