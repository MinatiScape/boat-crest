...
public final class ULC2WaveStylePlusBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static ULC2WaveStylePlusBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = ULC2WaveStylePlusBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final ULC2WaveStylePlusBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (ULC2WaveStylePlusBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                ULC2WaveStylePlusBleApiImpl.A = new ULC2WaveStylePlusBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(ULC2WaveStylePlusBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return ULC2WaveStylePlusBleApiImpl.A;
        }
    }
