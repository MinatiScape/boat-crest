...
public class CA2LeonardoBleApiImpl extends CA3LeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String w = CA2LeonardoBleApiImpl.class.getSimpleName();
    @Nullable
    public static CA2LeonardoBleApiImpl x;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA2LeonardoBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA2LeonardoBleApiImpl.x == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA2LeonardoBleApiImpl.x = new CA2LeonardoBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA2LeonardoBleApiImpl.w, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA2LeonardoBleApiImpl.x;
        }
    }
