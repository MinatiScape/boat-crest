...
public class SmaWaveGenesisProBleApiImpl extends SmaBaseBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<SmaWaveGenesisProBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.SmaWaveGenesisProBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, SmaWaveGenesisProBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3252a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, SmaWaveGenesisProBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public SmaWaveGenesisProBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new SmaWaveGenesisProBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3252a);
        }
    ...
    public SmaWaveGenesisProBleApiImpl(@NotNull Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        String simpleName = SmaWaveGenesisProBleApiImpl.class.getSimpleName();
        Intrinsics.checkNotNullExpressionValue(simpleName, "SmaWaveGenesisProBleApiImpl::class.java.simpleName");
        this.y = simpleName;
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        if (deviceSupportedFeat35 != null) {
            deviceSupportedFeat35.setMaxCharSupportedInNotification(240);
        }
        ...
        if (deviceSupportedFeat37 != null) {
            deviceSupportedFeat37.setScheduleReminderSupported(false);
        }
        ...
        if (deviceSupportedFeat43 != null) {
            deviceSupportedFeat43.setMaxContactsInOneRequest(20);
        }
        DeviceSupportedFeatures deviceSupportedFeat44 = getDeviceSupportedFeat();
        if (deviceSupportedFeat44 != null) {
            deviceSupportedFeat44.setContactSyncSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat45 = getDeviceSupportedFeat();
        if (deviceSupportedFeat45 != null) {
            deviceSupportedFeat45.setBTCallingSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat46 = getDeviceSupportedFeat();
        if (deviceSupportedFeat46 != null) {
            deviceSupportedFeat46.setNudgeSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat47 = getDeviceSupportedFeat();
        if (deviceSupportedFeat47 != null) {
            deviceSupportedFeat47.setSedentaryReminderSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat48 = getDeviceSupportedFeat();
        if (deviceSupportedFeat48 != null) {
            deviceSupportedFeat48.setVibrationAlarmSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat49 = getDeviceSupportedFeat();
        if (deviceSupportedFeat49 != null) {
            deviceSupportedFeat49.setWeatherSupportedInBand(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat50 = getDeviceSupportedFeat();
        if (deviceSupportedFeat50 != null) {
            deviceSupportedFeat50.setGenericActivityDataSampleSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat51 = getDeviceSupportedFeat();
        if (deviceSupportedFeat51 != null) {
            deviceSupportedFeat51.setDistanceGoalSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat52 = getDeviceSupportedFeat();
        if (deviceSupportedFeat52 != null) {
            deviceSupportedFeat52.setCalorieGoalSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat53 = getDeviceSupportedFeat();
        if (deviceSupportedFeat53 != null) {
            deviceSupportedFeat53.setChangeStepGoalFromWatchSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat54 = getDeviceSupportedFeat();
        if (deviceSupportedFeat54 != null) {
            deviceSupportedFeat54.setChangeDistanceGoalFromWatchSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat55 = getDeviceSupportedFeat();
        if (deviceSupportedFeat55 != null) {
            deviceSupportedFeat55.setChangeCalorieGoalFromWatchSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat56 = getDeviceSupportedFeat();
        if (deviceSupportedFeat56 != null) {
            deviceSupportedFeat56.setGetLiftWristToViewSettingsSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat57 = getDeviceSupportedFeat();
        if (deviceSupportedFeat57 != null) {
            deviceSupportedFeat57.setScheduledLiftWristViewSettingsSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat58 = getDeviceSupportedFeat();
        if (deviceSupportedFeat58 != null) {
            deviceSupportedFeat58.setWorldClockFeatureSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat59 = getDeviceSupportedFeat();
        if (deviceSupportedFeat59 != null) {
            deviceSupportedFeat59.setReadWorldClockFromWatchSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat60 = getDeviceSupportedFeat();
        if (deviceSupportedFeat60 != null) {
            deviceSupportedFeat60.setCalorieDistanceGoalGetSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat61 = getDeviceSupportedFeat();
        if (deviceSupportedFeat61 != null) {
            deviceSupportedFeat61.setSleepTargetSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat62 = getDeviceSupportedFeat();
        if (deviceSupportedFeat62 != null) {
            deviceSupportedFeat62.setScheduledDndSupported(true);
        }
        DeviceSupportedFeatures deviceSupportedFeat63 = getDeviceSupportedFeat();
        Intrinsics.checkNotNull(deviceSupportedFeat63);
        return deviceSupportedFeat63;
    }
    ...
    */
    public void onResponse(@org.jetbrains.annotations.NotNull com.coveiot.android.smasdk.api.SmaBaseRes r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.bleimpl.SmaWaveGenesisProBleApiImpl.onResponse(com.coveiot.android.smasdk.api.SmaBaseRes):void");
    }
