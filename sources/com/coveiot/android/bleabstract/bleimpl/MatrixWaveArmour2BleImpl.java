...
public final class MatrixWaveArmour2BleImpl extends MatrixWaveForceBleImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<MatrixWaveArmour2BleImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.MatrixWaveArmour2BleImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, MatrixWaveArmour2BleImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3200a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, MatrixWaveArmour2BleImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public MatrixWaveArmour2BleImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new MatrixWaveArmour2BleImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3200a);
        }
    ...
    public MatrixWaveArmour2BleImpl(@NotNull Context context) {
        super(context);
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        deviceSupportedFeatures.setWalletCardSupported(true);
