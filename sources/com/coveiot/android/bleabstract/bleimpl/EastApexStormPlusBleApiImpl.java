...
public final class EastApexStormPlusBleApiImpl extends EastApexBaseBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<EastApexStormPlusBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.EastApexStormPlusBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, EastApexStormPlusBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f2959a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, EastApexStormPlusBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public EastApexStormPlusBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new EastApexStormPlusBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f2959a);
        }
    ...
    public EastApexStormPlusBleApiImpl(@NotNull Context context) {
        super(context);
