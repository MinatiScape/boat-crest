...
public final class TouchLunarEmbraceBleApiImpl extends TouchELXBaseBleImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<TouchLunarEmbraceBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.TouchLunarEmbraceBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, TouchLunarEmbraceBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3288a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, TouchLunarEmbraceBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public TouchLunarEmbraceBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new TouchLunarEmbraceBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3288a);
        }
    ...
    public TouchLunarEmbraceBleApiImpl(@NotNull Context context) {
        super(context);
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        if (deviceSupportedFeatures43 != null) {
            TouchDeviceManager mTouchDeviceManager = getMTouchDeviceManager();
            if ((mTouchDeviceManager != null ? Integer.valueOf(mTouchDeviceManager.getGetContactCount()) : null) != null) {
                TouchDeviceManager mTouchDeviceManager2 = getMTouchDeviceManager();
                Integer valueOf = mTouchDeviceManager2 != null ? Integer.valueOf(mTouchDeviceManager2.getGetContactCount()) : null;
                Intrinsics.checkNotNull(valueOf);
                i = valueOf.intValue();
            }
            deviceSupportedFeatures43.setMaxContactsInOneRequest(i);
        }
        ...
        if (deviceSupportedFeatures52 != null) {
            ...
            Boolean valueOf2 = mTouchDeviceManager3 != null ? Boolean.valueOf(mTouchDeviceManager3.isAutoStressSupported()) : null;
            Intrinsics.checkNotNull(valueOf2);
            deviceSupportedFeatures52.setAutoStressSettingsSupported(valueOf2.booleanValue());
        }
        ...
        if (deviceSupportedFeatures53 != null) {
            ...
            Boolean valueOf3 = mTouchDeviceManager4 != null ? Boolean.valueOf(mTouchDeviceManager4.isAutoSPO2Supported()) : null;
            Intrinsics.checkNotNull(valueOf3);
            deviceSupportedFeatures53.setAutoSPO2SettingsSupported(valueOf3.booleanValue());
        }
        ...
        if (deviceSupportedFeatures54 != null) {
            ...
            Boolean valueOf4 = mTouchDeviceManager5 != null ? Boolean.valueOf(mTouchDeviceManager5.isQuickReplySupported()) : null;
            Intrinsics.checkNotNull(valueOf4);
            deviceSupportedFeatures54.setQuickReplySupported(valueOf4.booleanValue());
        }
        ...
        if (deviceSupportedFeatures55 != null) {
            ...
            Boolean valueOf5 = mTouchDeviceManager6 != null ? Boolean.valueOf(mTouchDeviceManager6.isFindDeviceSupported()) : null;
            Intrinsics.checkNotNull(valueOf5);
            deviceSupportedFeatures55.setFindMyBandSupported(valueOf5.booleanValue());
        }
        ...
        if (deviceSupportedFeatures56 != null) {
            ...
            Boolean valueOf6 = mTouchDeviceManager7 != null ? Boolean.valueOf(mTouchDeviceManager7.isSportModeSupported()) : null;
            Intrinsics.checkNotNull(valueOf6);
            deviceSupportedFeatures56.setActivityShowHideCommandSupported(valueOf6.booleanValue());
        }
        ...
        if (deviceSupportedFeatures57 != null) {
            ...
            Boolean valueOf7 = mTouchDeviceManager8 != null ? Boolean.valueOf(mTouchDeviceManager8.isQuickCardsSupported()) : null;
            Intrinsics.checkNotNull(valueOf7);
            deviceSupportedFeatures57.setShortcutMenuShowHideCommandSupported(valueOf7.booleanValue());
        }
        ...
        if (deviceSupportedFeatures58 != null) {
            ...
            Boolean valueOf8 = mTouchDeviceManager9 != null ? Boolean.valueOf(mTouchDeviceManager9.isFemaleWellnessSupported()) : null;
            Intrinsics.checkNotNull(valueOf8);
            deviceSupportedFeatures58.setFemaleWellnessSupported(valueOf8.booleanValue());
        }
        DeviceSupportedFeatures deviceSupportedFeatures59 = this.t;
        if (deviceSupportedFeatures59 != null) {
            TouchDeviceManager mTouchDeviceManager10 = getMTouchDeviceManager();
            Boolean valueOf9 = mTouchDeviceManager10 != null ? Boolean.valueOf(mTouchDeviceManager10.isBTCallingSupported()) : null;
            Intrinsics.checkNotNull(valueOf9);
            deviceSupportedFeatures59.setBTCallingSupported(valueOf9.booleanValue());
        }
        DeviceSupportedFeatures deviceSupportedFeatures60 = this.t;
        if (deviceSupportedFeatures60 != null) {
            TouchDeviceManager mTouchDeviceManager11 = getMTouchDeviceManager();
            Boolean valueOf10 = mTouchDeviceManager11 != null ? Boolean.valueOf(mTouchDeviceManager11.isEventReminderSupported()) : null;
            Intrinsics.checkNotNull(valueOf10);
            deviceSupportedFeatures60.setGenericEventReminderSupported(valueOf10.booleanValue());
        }
