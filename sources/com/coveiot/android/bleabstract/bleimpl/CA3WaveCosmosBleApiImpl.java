...
public final class CA3WaveCosmosBleApiImpl extends CA3LeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String w = CA3WaveCosmosBleApiImpl.class.getSimpleName();
    @Nullable
    public static CA3WaveCosmosBleApiImpl x;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA3WaveCosmosBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA3WaveCosmosBleApiImpl.x == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA3WaveCosmosBleApiImpl.x = new CA3WaveCosmosBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA3WaveCosmosBleApiImpl.w, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA3WaveCosmosBleApiImpl.x;
        }
    }
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        if (!AppUtils.isEmpty(PreferenceManagerAbstract.getInstance(LeonardoBleApiImpl.context).getDeviceVersionNumber())) {
            ...
            if (Integer.parseInt(kotlin.text.m.replace$default(kotlin.text.m.replace$default(kotlin.text.m.replace$default(version, CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_VALUE, "", false, 4, (Object) null), ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "", false, 4, (Object) null), ".", "", false, 4, (Object) null)) >= 110) {
