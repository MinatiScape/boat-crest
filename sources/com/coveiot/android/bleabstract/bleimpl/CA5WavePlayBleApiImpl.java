...
public class CA5WavePlayBleApiImpl extends CA3LeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String w = CA5WavePlayBleApiImpl.class.getSimpleName();
    @Nullable
    public static CA5WavePlayBleApiImpl x;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA5WavePlayBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA5WavePlayBleApiImpl.x == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA5WavePlayBleApiImpl.x = new CA5WavePlayBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA5WavePlayBleApiImpl.w, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA5WavePlayBleApiImpl.x;
        }
    }
