...
public class PrimiaCurvBleApiImpl extends CA6BTABleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String G = PrimiaCurvBleApiImpl.class.getSimpleName();
    @Nullable
    public static PrimiaCurvBleApiImpl H;
    public final String F = PrimiaCurvBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final PrimiaCurvBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (PrimiaCurvBleApiImpl.H == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                PrimiaCurvBleApiImpl.H = new PrimiaCurvBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(PrimiaCurvBleApiImpl.G, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, PrimiaCurvBleApiImpl this$0) {
            ...
            case 1:
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.s6
                            @Override // java.lang.Runnable
                            public final void run() {
                                PrimiaCurvBleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.r6
                                @Override // java.lang.Runnable
                                public final void run() {
                                    PrimiaCurvBleApiImpl.a(PrimiaCurvBleApiImpl.this, liveStepsData);
                                }
                            });
                        }
    ...
    public static final void a(PrimiaCurvBleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
