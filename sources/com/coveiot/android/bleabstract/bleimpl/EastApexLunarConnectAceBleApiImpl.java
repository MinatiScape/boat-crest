...
public final class EastApexLunarConnectAceBleApiImpl extends EastApexBaseBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<EastApexLunarConnectAceBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.EastApexLunarConnectAceBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, EastApexLunarConnectAceBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f2957a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, EastApexLunarConnectAceBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public EastApexLunarConnectAceBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new EastApexLunarConnectAceBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f2957a);
        }
    ...
    public EastApexLunarConnectAceBleApiImpl(@NotNull Context context) {
        super(context);
