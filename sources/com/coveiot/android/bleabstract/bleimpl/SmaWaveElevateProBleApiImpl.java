...
public final class SmaWaveElevateProBleApiImpl extends SmaWaveGenesisProBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<SmaWaveElevateProBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.SmaWaveElevateProBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, SmaWaveElevateProBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3251a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, SmaWaveElevateProBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public SmaWaveElevateProBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new SmaWaveElevateProBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3251a);
        }
    ...
    public SmaWaveElevateProBleApiImpl(@NotNull Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        String simpleName = SmaWaveElevateProBleApiImpl.class.getSimpleName();
        Intrinsics.checkNotNullExpressionValue(simpleName, "SmaWaveElevateProBleApiImpl::class.java.simpleName");
        this.z = simpleName;
    }
