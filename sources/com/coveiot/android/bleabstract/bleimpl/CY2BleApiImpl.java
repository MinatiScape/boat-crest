...
public final class CY2BleApiImpl extends CY1BleApiImpl {
    @Nullable
    public static CY2BleApiImpl D;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String C = CY2BleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CY2BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CY2BleApiImpl.D == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CY2BleApiImpl.D = new CY2BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CY2BleApiImpl.C, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
