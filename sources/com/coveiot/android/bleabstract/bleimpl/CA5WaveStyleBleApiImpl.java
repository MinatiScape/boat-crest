...
public final class CA5WaveStyleBleApiImpl extends CA3LeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String w = CA5WaveStyleBleApiImpl.class.getSimpleName();
    @Nullable
    public static CA5WaveStyleBleApiImpl x;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA5WaveStyleBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA5WaveStyleBleApiImpl.x == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA5WaveStyleBleApiImpl.x = new CA5WaveStyleBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA5WaveStyleBleApiImpl.w, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA5WaveStyleBleApiImpl.x;
        }
    }
