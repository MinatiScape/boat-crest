...
public class CY1BleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static CY1BleApiImpl B;
    public final String z = CY1BleApiImpl.class.getSimpleName();
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String A = CY1BleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CY1BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CY1BleApiImpl.B == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CY1BleApiImpl.B = new CY1BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CY1BleApiImpl.A, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, CY1BleApiImpl this$0) {
    ...
    public void getData(@NotNull BleBaseRequest request, @NotNull DataResultListener listener) {
        ...
        if (leonardoBleCmdService != null && leonardoBleCmdService.getConnectionState() == CloveBleState.BleState.CONNECTED) {
            if (request instanceof SendImageRequest) {
                ...
                request.setRequId(UUID.randomUUID().toString());
                addToQueue(request);
                sportsNotificationReq.setDevicePlatformEnum(DevicePlatformEnum.Apollo);
                ...
                customMessageReq.setDevicePlatformEnum(DevicePlatformEnum.Apollo);
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        deviceSupportedFeatures.setPlatform(DevicePlatformEnum.Apollo);
        Context context = LeonardoBleApiImpl.context;
        Intrinsics.checkNotNullExpressionValue(context, "context");
        ...
        switch (activityType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[activityType.ordinal()]) {
            case 1:
                ...
                if (fromQueue != null) {
                    ...
                    LogHelper.d(this.z, "DeleteImageRes is not empty");
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        LogHelper.d(this.z, "CustomWatchFaceBackgroundChangeRequest is non empty");
                        ...
                        final SendImageReq sendImageReq = new SendImageReq(null, customWatchFaceBackgroundChangeRequest.getImageId(), customWatchFaceBackgroundChangeRequest.getImageFile(), 0, 0, 0, 0, customWatchFaceBackgroundChangeRequest.getHeight(), customWatchFaceBackgroundChangeRequest.getWidth(), DevicePlatformEnum.Apollo);
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.j0
                            @Override // java.lang.Runnable
                            public final void run() {
                                CY1BleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                    LogHelper.d(this.z, "CustomWatchFaceBackgroundChangeRequest is ins");
                    return;
                }
                LogHelper.d(this.z, "CustomWatchFaceBackgroundChangeRequest is empty");
                return;
            case 2:
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.i0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    CY1BleApiImpl.a(CY1BleApiImpl.this, liveStepsData);
                                }
                            });
                        }
            ...
            case 10:
                ...
                if (fromQueuebasedOnDate != null) {
                    ...
                    LogHelper.d(A, "Sens AI summary Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 11:
                ...
                if (fromQueuebasedOnDate2 != null) {
                    ...
                    LogHelper.d(A, "Distance Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 12:
                ...
                if (fromQueuebasedOnDate3 != null) {
                    ...
                    LogHelper.d(A, "Calorie Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 13:
                ...
                if (fromQueue11 != null) {
                    ...
                    if (response instanceof GetSensAISummaryDetailsDataRes) {
                        ...
                        if (sensAISummaryDetailData != null) {
                            ...
                            LogHelper.d(A, "Sens AI summary details Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                            return;
                        }
                        return;
                    }
    ...
    public void setUserSettings(@NotNull BleBaseRequest request, @NotNull SettingsResultListener listener) {
        ...
        if (leonardoBleCmdService != null && leonardoBleCmdService.getConnectionState() == CloveBleState.BleState.CONNECTED) {
            ...
            if (request instanceof SetSensAIActivityConfigRequest) {
                ...
                build2.setReqId(request.getRequId());
                build2.setDevicePlatformEnum(DevicePlatformEnum.Apollo);
                LeonardoBleApiImpl.bleService.sendRequest(build2, this);
            } else {
    ...
    public static final void a(CY1BleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
