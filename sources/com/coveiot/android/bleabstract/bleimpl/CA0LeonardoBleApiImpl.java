...
public final class CA0LeonardoBleApiImpl extends CZ1WavePrimeLeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String t = CA0LeonardoBleApiImpl.class.getSimpleName();
    @Nullable
    public static CA0LeonardoBleApiImpl u;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA0LeonardoBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA0LeonardoBleApiImpl.u == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA0LeonardoBleApiImpl.u = new CA0LeonardoBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA0LeonardoBleApiImpl.t, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA0LeonardoBleApiImpl.u;
        }
    }
