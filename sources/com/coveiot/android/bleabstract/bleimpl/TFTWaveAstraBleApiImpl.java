...
public class TFTWaveAstraBleApiImpl extends ULC5UltimaConnectBleApiImpl {
    @Nullable
    public static TFTWaveAstraBleApiImpl C;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String B = TFTWaveAstraBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final TFTWaveAstraBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (TFTWaveAstraBleApiImpl.C == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                TFTWaveAstraBleApiImpl.C = new TFTWaveAstraBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(TFTWaveAstraBleApiImpl.B, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return TFTWaveAstraBleApiImpl.C;
        }
    }
