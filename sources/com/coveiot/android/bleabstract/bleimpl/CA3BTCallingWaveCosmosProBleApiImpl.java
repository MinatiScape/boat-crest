...
public final class CA3BTCallingWaveCosmosProBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static CA3BTCallingWaveCosmosProBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = CA3BTCallingWaveCosmosProBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA3BTCallingWaveCosmosProBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA3BTCallingWaveCosmosProBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA3BTCallingWaveCosmosProBleApiImpl.A = new CA3BTCallingWaveCosmosProBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA3BTCallingWaveCosmosProBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA3BTCallingWaveCosmosProBleApiImpl.A;
        }
    }
