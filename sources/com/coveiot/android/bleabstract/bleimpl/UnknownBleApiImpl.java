...
public class UnknownBleApiImpl implements BleApi {
    public static UnknownBleApiImpl b;

    /* renamed from: a  reason: collision with root package name */
    public BusyStatus f3296a = BusyStatus.IDLE;

    public static UnknownBleApiImpl getInstance() {
        if (b == null) {
            b = new UnknownBleApiImpl();
        }
        return b;
    }
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        return new DeviceSupportedFeatures();
    }
