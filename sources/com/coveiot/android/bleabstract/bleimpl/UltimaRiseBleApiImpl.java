...
public final class UltimaRiseBleApiImpl extends TFTWaveCall2BleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = UltimaRiseBleApiImpl.class.getSimpleName();
    @Nullable
    public static UltimaRiseBleApiImpl E;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final UltimaRiseBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (UltimaRiseBleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                UltimaRiseBleApiImpl.E = new UltimaRiseBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(UltimaRiseBleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
