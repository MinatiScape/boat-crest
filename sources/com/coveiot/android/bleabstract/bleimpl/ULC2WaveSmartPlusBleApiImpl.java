...
public final class ULC2WaveSmartPlusBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static ULC2WaveSmartPlusBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = ULC2WaveSmartPlusBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final ULC2WaveSmartPlusBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (ULC2WaveSmartPlusBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                ULC2WaveSmartPlusBleApiImpl.A = new ULC2WaveSmartPlusBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(ULC2WaveSmartPlusBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return ULC2WaveSmartPlusBleApiImpl.A;
        }
    }
