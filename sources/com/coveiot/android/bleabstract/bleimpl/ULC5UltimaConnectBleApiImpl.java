...
public class ULC5UltimaConnectBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static ULC5UltimaConnectBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = ULC5UltimaConnectBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final ULC5UltimaConnectBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (ULC5UltimaConnectBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                ULC5UltimaConnectBleApiImpl.A = new ULC5UltimaConnectBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(ULC5UltimaConnectBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return ULC5UltimaConnectBleApiImpl.A;
        }
    }
