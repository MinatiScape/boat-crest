...
public class UltimaPrismBleApiImpl extends CA6BTABleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String G = UltimaPrismBleApiImpl.class.getSimpleName();
    @Nullable
    public static UltimaPrismBleApiImpl H;
    public final String F = UltimaPrismBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final UltimaPrismBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (UltimaPrismBleApiImpl.H == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                UltimaPrismBleApiImpl.H = new UltimaPrismBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(UltimaPrismBleApiImpl.G, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return UltimaPrismBleApiImpl.H;
        }
    }
    ...
    public static final void a(SendImageReq sendImageReq1, UltimaPrismBleApiImpl this$0) {
            ...
            case 1:
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.ma
                            @Override // java.lang.Runnable
                            public final void run() {
                                UltimaPrismBleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.la
                                @Override // java.lang.Runnable
                                public final void run() {
                                    UltimaPrismBleApiImpl.a(UltimaPrismBleApiImpl.this, liveStepsData);
                                }
                            });
                        }
    ...
    public static final void a(UltimaPrismBleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
