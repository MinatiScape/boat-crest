...
public class LunarOrbBleApiImpl extends CA6BTABleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String H = LunarOrbBleApiImpl.class.getSimpleName();
    @Nullable
    public static LunarOrbBleApiImpl I;
    @NotNull
    public final DevicePlatformEnum F = DevicePlatformEnum.Realtek;
    public final String G = LunarOrbBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final LunarOrbBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (LunarOrbBleApiImpl.I == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                LunarOrbBleApiImpl.I = new LunarOrbBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(LunarOrbBleApiImpl.H, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, LunarOrbBleApiImpl this$0) {
    ...
    public void getData(@NotNull BleBaseRequest request, @NotNull DataResultListener listener) {
        ...
        if (leonardoBleCmdService != null && leonardoBleCmdService.getConnectionState() == CloveBleState.BleState.CONNECTED) {
            if (request instanceof SendImageRequest) {
                ...
                SendImageReq sendImageReq = new SendImageReq(null, sendImageRequest.getImageId(), sendImageRequest.getImageFile(), sendImageRequest.getCompression(), sendImageRequest.getTransparentChannel(), sendImageRequest.getxCoordinate(), sendImageRequest.getyCoordinate(), sendImageRequest.getHeight(), sendImageRequest.getWidth(), this.F);
                ...
                request.setRequId(UUID.randomUUID().toString());
                addToQueue(request);
                sportsNotificationReq.setDevicePlatformEnum(this.F);
                ...
                customMessageReq.setDevicePlatformEnum(this.F);
    ...
    @NotNull
    public final DevicePlatformEnum getDevicePlatForm() {
        return this.F;
    }
        ...
        switch (activityType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[activityType.ordinal()]) {
            case 1:
                ...
                if (fromQueue != null) {
                    ...
                    LogHelper.d(this.G, "DeleteImageRes is not empty");
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        LogHelper.d(this.G, "CustomWatchFaceBackgroundChangeRequest is non empty");
                        ...
                        final SendImageReq sendImageReq = new SendImageReq(null, customWatchFaceBackgroundChangeRequest.getImageId(), customWatchFaceBackgroundChangeRequest.getImageFile(), 0, 0, 0, 0, customWatchFaceBackgroundChangeRequest.getHeight(), customWatchFaceBackgroundChangeRequest.getWidth(), this.F);
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.o5
                            @Override // java.lang.Runnable
                            public final void run() {
                                LunarOrbBleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                    LogHelper.d(this.G, "CustomWatchFaceBackgroundChangeRequest is ins");
                    return;
                }
                LogHelper.d(this.G, "CustomWatchFaceBackgroundChangeRequest is empty");
                return;
            case 2:
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.n5
                                @Override // java.lang.Runnable
                                public final void run() {
                                    LunarOrbBleApiImpl.a(LunarOrbBleApiImpl.this, liveStepsData);
                                }
                            });
                        }
            ...
            case 10:
                ...
                if (fromQueuebasedOnDate != null) {
                    ...
                    LogHelper.d(H, "Sens AI summary Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 11:
                ...
                if (fromQueuebasedOnDate2 != null) {
                    ...
                    LogHelper.d(H, "Distance Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 12:
                ...
                if (fromQueuebasedOnDate3 != null) {
                    ...
                    LogHelper.d(H, "Calorie Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 13:
                ...
                if (fromQueue11 != null) {
                    ...
                    if (response instanceof GetSensAISummaryDetailsDataRes) {
                        ...
                        if (sensAISummaryDetailData != null) {
                            ...
                            LogHelper.d(H, "Sens AI summary details Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                            return;
                        }
                        return;
                    }
    ...
    public static final void a(LunarOrbBleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
