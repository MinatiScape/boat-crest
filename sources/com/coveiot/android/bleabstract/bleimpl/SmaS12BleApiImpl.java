...
public final class SmaS12BleApiImpl extends SmaBaseBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);

    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<SmaS12BleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.SmaS12BleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, SmaS12BleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3245a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, SmaS12BleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public SmaS12BleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new SmaS12BleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3245a);
        }
    ...
    public SmaS12BleApiImpl(@NotNull Context context) {
        super(context);
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        Intrinsics.checkNotNull(deviceSupportedFeat49);
        return deviceSupportedFeat49;
    }
    ...
    public SmaBaseReq getSmaBleReq(@NotNull BleBaseRequest request) {
        ...
        if (request instanceof ActivityModeWithSamplesRequest) {
            ...
            SmaWorkoutDataReq smaWorkoutDataReq = new SmaWorkoutDataReq();
    ...
    */
    public void onResponse(@org.jetbrains.annotations.NotNull com.coveiot.android.smasdk.api.SmaBaseRes r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.bleimpl.SmaS12BleApiImpl.onResponse(com.coveiot.android.smasdk.api.SmaBaseRes):void");
    }
