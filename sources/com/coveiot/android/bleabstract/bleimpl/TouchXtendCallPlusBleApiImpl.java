...
public final class TouchXtendCallPlusBleApiImpl extends TouchELXBaseBleImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<TouchXtendCallPlusBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.TouchXtendCallPlusBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, TouchXtendCallPlusBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3295a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, TouchXtendCallPlusBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public TouchXtendCallPlusBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new TouchXtendCallPlusBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3295a);
        }
    ...
    public TouchXtendCallPlusBleApiImpl(@NotNull Context context) {
        super(context);
