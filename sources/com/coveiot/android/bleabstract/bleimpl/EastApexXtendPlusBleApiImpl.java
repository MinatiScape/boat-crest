...
public final class EastApexXtendPlusBleApiImpl extends EastApexBaseBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<EastApexXtendPlusBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.EastApexXtendPlusBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, EastApexXtendPlusBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f2961a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, EastApexXtendPlusBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public EastApexXtendPlusBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new EastApexXtendPlusBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f2961a);
        }
    ...
    public EastApexXtendPlusBleApiImpl(@NotNull Context context) {
        super(context);
