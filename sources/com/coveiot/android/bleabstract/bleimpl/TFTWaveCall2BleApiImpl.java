...
public class TFTWaveCall2BleApiImpl extends ULC5UltimaConnectBleApiImpl {
    @Nullable
    public static TFTWaveCall2BleApiImpl C;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String B = TFTWaveCall2BleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final TFTWaveCall2BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (TFTWaveCall2BleApiImpl.C == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                TFTWaveCall2BleApiImpl.C = new TFTWaveCall2BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(TFTWaveCall2BleApiImpl.B, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return TFTWaveCall2BleApiImpl.C;
        }
    }
