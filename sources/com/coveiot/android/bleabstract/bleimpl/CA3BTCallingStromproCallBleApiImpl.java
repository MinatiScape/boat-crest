...
public final class CA3BTCallingStromproCallBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static CA3BTCallingStromproCallBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = CA3BTCallingStromproCallBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA3BTCallingStromproCallBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA3BTCallingStromproCallBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA3BTCallingStromproCallBleApiImpl.A = new CA3BTCallingStromproCallBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA3BTCallingStromproCallBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA3BTCallingStromproCallBleApiImpl.A;
        }
    }
    ...
    public DeviceSupportedFeatures getDeviceSupportedFeatures() {
        ...
        if (!AppUtils.isEmpty(PreferenceManagerAbstract.getInstance(LeonardoBleApiImpl.context).getDeviceVersionNumber())) {
            ...
            if (Integer.parseInt(kotlin.text.m.replace$default(kotlin.text.m.replace$default(kotlin.text.m.replace$default(version, CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_VALUE, "", false, 4, (Object) null), ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "", false, 4, (Object) null), ".", "", false, 4, (Object) null)) >= 17) {
