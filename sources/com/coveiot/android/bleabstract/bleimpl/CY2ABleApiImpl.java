...
public class CY2ABleApiImpl extends CY1BleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = CY2ABleApiImpl.class.getSimpleName();
    @Nullable
    public static CY2ABleApiImpl E;
    public final String C = CY2ABleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CY2ABleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CY2ABleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CY2ABleApiImpl.E = new CY2ABleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CY2ABleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, CY2ABleApiImpl this$0) {
            ...
            case 1:
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.l0
                            @Override // java.lang.Runnable
                            public final void run() {
                                CY2ABleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.k0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    CY2ABleApiImpl.a(CY2ABleApiImpl.this, liveStepsData);
                                }
                            });
                        }
    ...
    public static final void a(CY2ABleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
