...
public final class WaveAstra2BleApiImpl extends TFTWaveAstraBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = WaveAstra2BleApiImpl.class.getSimpleName();
    @Nullable
    public static WaveAstra2BleApiImpl E;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final WaveAstra2BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (WaveAstra2BleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                WaveAstra2BleApiImpl.E = new WaveAstra2BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(WaveAstra2BleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
