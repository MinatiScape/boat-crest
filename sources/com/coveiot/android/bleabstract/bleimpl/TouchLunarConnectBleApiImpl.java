...
public final class TouchLunarConnectBleApiImpl extends TouchELXBaseBleImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<TouchLunarConnectBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.TouchLunarConnectBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, TouchLunarConnectBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3286a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, TouchLunarConnectBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public TouchLunarConnectBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new TouchLunarConnectBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3286a);
        }
    ...
    public TouchLunarConnectBleApiImpl(@NotNull Context context) {
        super(context);
