...
public class BESEnigmaVirtuoBleApiImpl extends ULC5UltimaConnectBleApiImpl {
    @Nullable
    public static BESEnigmaVirtuoBleApiImpl C;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String B = BESEnigmaVirtuoBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final BESEnigmaVirtuoBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (BESEnigmaVirtuoBleApiImpl.C == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                BESEnigmaVirtuoBleApiImpl.C = new BESEnigmaVirtuoBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(BESEnigmaVirtuoBleApiImpl.B, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return BESEnigmaVirtuoBleApiImpl.C;
        }
    }
