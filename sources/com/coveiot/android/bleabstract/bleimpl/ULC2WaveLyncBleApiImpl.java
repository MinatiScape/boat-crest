...
public final class ULC2WaveLyncBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static ULC2WaveLyncBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = ULC2WaveLyncBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final ULC2WaveLyncBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (ULC2WaveLyncBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                ULC2WaveLyncBleApiImpl.A = new ULC2WaveLyncBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(ULC2WaveLyncBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return ULC2WaveLyncBleApiImpl.A;
        }
    }
