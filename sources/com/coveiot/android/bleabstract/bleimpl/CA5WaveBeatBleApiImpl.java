...
public final class CA5WaveBeatBleApiImpl extends CA3LeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String w = CA5WaveBeatBleApiImpl.class.getSimpleName();
    @Nullable
    public static CA5WaveBeatBleApiImpl x;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA5WaveBeatBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA5WaveBeatBleApiImpl.x == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA5WaveBeatBleApiImpl.x = new CA5WaveBeatBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA5WaveBeatBleApiImpl.w, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CA5WaveBeatBleApiImpl.x;
        }
    }
