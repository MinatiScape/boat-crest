...
public final class CZ1WaveEliteBleApiImpl extends CZ1WavePrimeLeonardoBleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String t = CZ1WaveEliteBleApiImpl.class.getSimpleName();
    @Nullable
    public static CZ1WaveEliteBleApiImpl u;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CZ1WaveEliteBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CZ1WaveEliteBleApiImpl.u == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CZ1WaveEliteBleApiImpl.u = new CZ1WaveEliteBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CZ1WaveEliteBleApiImpl.t, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return CZ1WaveEliteBleApiImpl.u;
        }
    }
