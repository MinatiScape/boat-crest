...
public final class TFTWaveNeoPlusBleApiImpl extends ULC5UltimaConnectBleApiImpl {
    @Nullable
    public static TFTWaveNeoPlusBleApiImpl C;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String B = TFTWaveNeoPlusBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final TFTWaveNeoPlusBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (TFTWaveNeoPlusBleApiImpl.C == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                TFTWaveNeoPlusBleApiImpl.C = new TFTWaveNeoPlusBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(TFTWaveNeoPlusBleApiImpl.B, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return TFTWaveNeoPlusBleApiImpl.C;
        }
    }
