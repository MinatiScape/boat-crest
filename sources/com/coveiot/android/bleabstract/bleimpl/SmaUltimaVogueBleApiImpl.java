...
public class SmaUltimaVogueBleApiImpl extends SmaBaseBleApiImpl {
    @NotNull
    ...
    /* loaded from: classes2.dex */
    public static final class Companion extends SingletonHolder<SmaUltimaVogueBleApiImpl, Context> {

        /* renamed from: com.coveiot.android.bleabstract.bleimpl.SmaUltimaVogueBleApiImpl$Companion$1  reason: invalid class name */
        /* loaded from: classes2.dex */
        public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<Context, SmaUltimaVogueBleApiImpl> {

            /* renamed from: a  reason: collision with root package name */
            public static final AnonymousClass1 f3247a = new AnonymousClass1();

            public AnonymousClass1() {
                super(1, SmaUltimaVogueBleApiImpl.class, "<init>", "<init>(Landroid/content/Context;)V", 0);
            }

            @Override // kotlin.jvm.functions.Function1
            public SmaUltimaVogueBleApiImpl invoke(Context context) {
                Context p0 = context;
                Intrinsics.checkNotNullParameter(p0, "p0");
                return new SmaUltimaVogueBleApiImpl(p0);
            }
        }

        public Companion() {
            super(AnonymousClass1.f3247a);
        }
    ...
    public SmaUltimaVogueBleApiImpl(@NotNull Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        String simpleName = SmaUltimaVogueBleApiImpl.class.getSimpleName();
        Intrinsics.checkNotNullExpressionValue(simpleName, "SmaUltimaVogueBleApiImpl::class.java.simpleName");
        this.y = simpleName;
    ...
    */
    public void onResponse(@org.jetbrains.annotations.NotNull com.coveiot.android.smasdk.api.SmaBaseRes r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.bleimpl.SmaUltimaVogueBleApiImpl.onResponse(com.coveiot.android.smasdk.api.SmaBaseRes):void");
    }
