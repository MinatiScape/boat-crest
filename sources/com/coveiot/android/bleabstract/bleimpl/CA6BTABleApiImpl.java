...
public class CA6BTABleApiImpl extends CY1BleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = CA6BTABleApiImpl.class.getSimpleName();
    @Nullable
    public static CA6BTABleApiImpl E;
    public final String C = CA6BTABleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final CA6BTABleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (CA6BTABleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                CA6BTABleApiImpl.E = new CA6BTABleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(CA6BTABleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
    ...
    public static final void a(SendImageReq sendImageReq1, CA6BTABleApiImpl this$0) {
        ...
        switch (activityType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[activityType.ordinal()]) {
            case 1:
                ...
                if (fromQueue != null) {
                    ...
                    LogHelper.d(this.C, "DeleteImageRes is not empty");
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        LogHelper.d(this.C, "CustomWatchFaceBackgroundChangeRequest is non empty");
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.f
                            @Override // java.lang.Runnable
                            public final void run() {
                                CA6BTABleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                    LogHelper.d(this.C, "CustomWatchFaceBackgroundChangeRequest is ins");
                    return;
                }
                LogHelper.d(this.C, "CustomWatchFaceBackgroundChangeRequest is empty");
                return;
            case 2:
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.e
                                @Override // java.lang.Runnable
                                public final void run() {
                                    CA6BTABleApiImpl.a(CA6BTABleApiImpl.this, liveStepsData);
                                }
                            });
                        }
            ...
            case 10:
                ...
                if (fromQueuebasedOnDate != null) {
                    ...
                    LogHelper.d(D, "Sens AI summary Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 11:
                ...
                if (fromQueuebasedOnDate2 != null) {
                    ...
                    LogHelper.d(D, "Distance Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 12:
                ...
                if (fromQueuebasedOnDate3 != null) {
                    ...
                    LogHelper.d(D, "Calorie Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                    return;
                }
                return;
            case 13:
                ...
                if (fromQueue11 != null) {
                    ...
                    if (response instanceof GetSensAISummaryDetailsDataRes) {
                        ...
                        if (sensAISummaryDetailData != null) {
                            ...
                            LogHelper.d(D, "Sens AI summary details Request onDataResponse", ModuleNames.BLEABSTRACT.getModuleName());
                            return;
                        }
                        return;
                    }
    ...
    public static final void a(CA6BTABleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
