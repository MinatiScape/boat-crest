...
public class UltimaChronosBleApiImpl extends CA6BTABleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String G = UltimaChronosBleApiImpl.class.getSimpleName();
    @Nullable
    public static UltimaChronosBleApiImpl H;
    public final String F = UltimaChronosBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final UltimaChronosBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (UltimaChronosBleApiImpl.H == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                UltimaChronosBleApiImpl.H = new UltimaChronosBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(UltimaChronosBleApiImpl.G, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return UltimaChronosBleApiImpl.H;
        }
    }
    ...
    public static final void a(SendImageReq sendImageReq1, UltimaChronosBleApiImpl this$0) {
            ...
            case 1:
                ...
                if (fromQueue2 != null) {
                    if (fromQueue2.f3181a instanceof CustomWatchFaceBackgroundChangeRequest) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.ka
                            @Override // java.lang.Runnable
                            public final void run() {
                                UltimaChronosBleApiImpl.a(SendImageReq.this, this);
                            }
                        }, 500L);
                        return;
                    }
                ...
                try {
                    if (((TodaysFitnessDataRes) response).isSuccess()) {
                        ...
                        if (this.liveStepsDataMutableLiveData != null) {
                            ...
                            this.uiHandler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.bleimpl.ja
                                @Override // java.lang.Runnable
                                public final void run() {
                                    UltimaChronosBleApiImpl.a(UltimaChronosBleApiImpl.this, liveStepsData);
                                }
                            });
                        }
    ...
    public static final void a(UltimaChronosBleApiImpl this$0, LiveStepsData liveStepsData1) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
