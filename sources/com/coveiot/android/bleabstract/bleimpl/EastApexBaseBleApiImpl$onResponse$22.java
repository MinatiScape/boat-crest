...
@DebugMetadata(c = "com.coveiot.android.bleabstract.bleimpl.EastApexBaseBleApiImpl$onResponse$22", f = "EastApexBaseBleApiImpl.kt", i = {0, 0}, l = {1321}, m = "invokeSuspend", n = {"response", "bleBaseResponse"}, s = {"L$1", "L$2"})
/* loaded from: classes2.dex */
public final class EastApexBaseBleApiImpl$onResponse$22 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.coveiot.android.bleabstract.bleimpl.EastApexBaseBleApiImpl$onResponse$22$2", f = "EastApexBaseBleApiImpl.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.coveiot.android.bleabstract.bleimpl.EastApexBaseBleApiImpl$onResponse$22$2  reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ EastApexBaseBleApiImpl f2944a;
        ...
        public AnonymousClass2(EastApexBaseBleApiImpl eastApexBaseBleApiImpl, Continuation<? super AnonymousClass2> continuation) {
            ...
            this.f2944a = eastApexBaseBleApiImpl;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new AnonymousClass2(this.f2944a, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return new AnonymousClass2(this.f2944a, continuation).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            KHEASleepRepository.Companion.getInstance(this.f2944a.getContext()).updateSleepDataProcessedBefore(this.f2944a.getMacAddress(), BleApiUtils.INSTANCE.getTodayStartTime().getTimeInMillis());
            return Unit.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EastApexBaseBleApiImpl$onResponse$22(EastApexBaseRes eastApexBaseRes, BleBaseRequest bleBaseRequest, EastApexBaseBleApiImpl eastApexBaseBleApiImpl, DataResultListener dataResultListener, Continuation<? super EastApexBaseBleApiImpl$onResponse$22> continuation) {
        super(2, continuation);
    ...
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new EastApexBaseBleApiImpl$onResponse$22(this.e, this.f, this.g, this.h, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return new EastApexBaseBleApiImpl$onResponse$22(this.e, this.f, this.g, this.h, continuation).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r12) {
        /*
            ...
            java.lang.Object r4 = r11.f2943a
        ...
        L61:
            ...
            com.coveiot.android.bleabstract.bleimpl.u1 r7 = new com.coveiot.android.bleabstract.bleimpl.u1
            r7.<init>()
            r5.post(r7)
            ...
            com.coveiot.android.bleabstract.bleimpl.EastApexBaseBleApiImpl$onResponse$22$2 r8 = new com.coveiot.android.bleabstract.bleimpl.EastApexBaseBleApiImpl$onResponse$22$2
        ...
        L95:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.bleimpl.EastApexBaseBleApiImpl$onResponse$22.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
