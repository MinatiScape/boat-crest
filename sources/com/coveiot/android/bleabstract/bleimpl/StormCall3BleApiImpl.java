...
public final class StormCall3BleApiImpl extends TFTStormCall2BleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = StormCall3BleApiImpl.class.getSimpleName();
    @Nullable
    public static StormCall3BleApiImpl E;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final StormCall3BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (StormCall3BleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                StormCall3BleApiImpl.E = new StormCall3BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(StormCall3BleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
