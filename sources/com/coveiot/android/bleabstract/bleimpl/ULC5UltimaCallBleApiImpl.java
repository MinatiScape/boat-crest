...
public final class ULC5UltimaCallBleApiImpl extends CA3BTCallingLeonardoBleApiImpl {
    @Nullable
    public static ULC5UltimaCallBleApiImpl A;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String z = ULC5UltimaCallBleApiImpl.class.getSimpleName();
    ...
    public static final class Companion {
        ...
        @Nullable
        public final ULC5UltimaCallBleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (ULC5UltimaCallBleApiImpl.A == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                ULC5UltimaCallBleApiImpl.A = new ULC5UltimaCallBleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(ULC5UltimaCallBleApiImpl.z, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
            ...
            return ULC5UltimaCallBleApiImpl.A;
        }
    }
