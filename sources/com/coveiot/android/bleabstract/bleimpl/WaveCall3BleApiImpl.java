...
public class WaveCall3BleApiImpl extends TFTWaveCall2BleApiImpl {
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final String D = WaveCall3BleApiImpl.class.getSimpleName();
    @Nullable
    public static WaveCall3BleApiImpl E;
    ...
    public static final class Companion {
        ...
        @Nullable
        public final WaveCall3BleApiImpl getInstance(@NotNull Context ctxt) {
            Intrinsics.checkNotNullParameter(ctxt, "ctxt");
            if (WaveCall3BleApiImpl.E == null) {
                LeonardoBleApiImpl.context = ctxt.getApplicationContext();
                WaveCall3BleApiImpl.E = new WaveCall3BleApiImpl();
            }
            ...
            if (!LeonardoBleApiImpl.checkIfServiceIsRunning()) {
                LogHelper.d(WaveCall3BleApiImpl.D, "service is not running ++ ", ModuleNames.BLEABSTRACT.getModuleName());
                try {
