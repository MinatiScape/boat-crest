...
public final class JStyle1963DFormatter {
    @Nullable

    /* renamed from: a  reason: collision with root package name */
    public String f3313a;
    public final String b = JStyle1963DFormatter.class.getSimpleName();
    @NotNull
    public final DecimalFormat c = new DecimalFormat("0.00");

    public JStyle1963DFormatter(@Nullable String str) {
        this.f3313a = str;
    }
    ...
    public final List<SleepHourData> b(Map<String, ? extends ArrayList<JstyleSleepData>> map) {
        ...
        while (true) {
            ...
            List sortedWith = arrayList3 != null ? CollectionsKt___CollectionsKt.sortedWith(arrayList3, new Comparator() { // from class: com.coveiot.android.bleabstract.formatter.JStyle1963DFormatter$convertRawResponseToSleepDayData$$inlined$compareBy$1
    ...
    public final List<StepsHourData> c(Map<String, ? extends ArrayList<JstyleStepData>> map) {
        ...
        JStyle1963DFormatter jStyle1963DFormatter = this;
        ArrayList arrayList2 = new ArrayList();
        ...
        while (it2.hasNext()) {
            ...
            if (arrayList3 == null || arrayList3.size() <= 0) {
                ...
                while (i3 < size) {
                    ...
                    jStyle1963DFormatter.c.setDecimalFormatSymbols(new DecimalFormatSymbols(Locale.ENGLISH));
                    String format = jStyle1963DFormatter.c.format(parseDouble);
                    Intrinsics.checkNotNullExpressionValue(format, "df.format(totalCaloriesPerHour)");
                    d2 = Double.parseDouble(format);
                    String format2 = jStyle1963DFormatter.c.format(d3 + Double.parseDouble(distance));
    ...
    public final DeviceSettingsInfoResponse convertToDeviceSettingsData(@NotNull Map<String, String> deviceSettings) {
        ...
        int parseInt = Integer.parseInt((String) s.getValue(deviceSettings, DeviceKey.WristOn));
        int parseInt2 = Integer.parseInt((String) s.getValue(deviceSettings, DeviceKey.TempUnit));
        int parseInt3 = Integer.parseInt((String) s.getValue(deviceSettings, DeviceKey.DistanceUnit));
        int parseInt4 = Integer.parseInt((String) s.getValue(deviceSettings, "NightMode"));
        int parseInt5 = Integer.parseInt((String) s.getValue(deviceSettings, DeviceKey.Dialinterface));
        int parseInt6 = Integer.parseInt((String) s.getValue(deviceSettings, DeviceKey.TimeUnit));
        int parseInt7 = Integer.parseInt((String) s.getValue(deviceSettings, "SocialDistancedwitch"));
        int parseInt8 = Integer.parseInt((String) s.getValue(deviceSettings, DeviceKey.ScreenBrightness));
        deviceSettingsInfoResponse.setLiftWristON(parseInt == 1);
        deviceSettingsInfoResponse.setDistanceUnitInMile(parseInt3 == 1);
        deviceSettingsInfoResponse.setTemperatureUnitInFahrenheit(parseInt2 == 1);
        deviceSettingsInfoResponse.setTimeIn12HRFormat(parseInt6 == 1);
        deviceSettingsInfoResponse.setSilentModeEnabled(parseInt7 == 1);
        deviceSettingsInfoResponse.setNightModeEnabled(parseInt4 == 1);
        deviceSettingsInfoResponse.setWatchFacePosition(parseInt5);
        deviceSettingsInfoResponse.setDisPlayScreenBrightness(parseInt8);
    ...
    public final List<HeartRateResponse> getHeartRateResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleHRData>> stepsArrayListMap) {
        ...
        for (String str : treeMap2.keySet()) {
            ...
            heartRateDayData.setmMacAddress(this.f3313a);
            HeartRateTimeLogBeanData heartRateTimeLogBeanData = new HeartRateTimeLogBeanData();
    ...
    public final List<SleepResponse> getSleepResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleSleepData>> sleepArrayListMap) {
        ...
        for (String str : treeMap.keySet()) {
            ...
            sleepDayData.setmMacAddress(this.f3313a);
            SleepTimeLogBeanData sleepTimeLogBeanData = new SleepTimeLogBeanData();
            ArrayList arrayList6 = new ArrayList();
            if (arrayList5 != null && arrayList5.size() > 0) {
    ...
    public final List<ActivityModeSummaryResponse> getSportModeHistoryData(@NotNull Object obj, @NotNull Context context) {
        ...
        while (it2.hasNext()) {
            ...
            if (str7 != null) {
                activityModeSummaryResponse.setActivityMode(JStyleUtils.getActivityModeFor1963D(Integer.parseInt(str7)));
            }
            if (str8 != null) {
            ...
            activityModeSummaryResponse.setMacAddress(this.f3313a);
    ...
    public final List<StepsResponse> getStepsResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleStepData>> stepsArrayListMap) {
        ...
        for (String str : treeMap.keySet()) {
            ...
            stepsDayData.setmMacAddress(this.f3313a);
            StepsTimeLogBeanData stepsTimeLogBeanData = new StepsTimeLogBeanData();
            ArrayList arrayList6 = new ArrayList();
            if (arrayList5 != null && arrayList5.size() > 0) {
                int size3 = arrayList5.size();
    ...
    */
    public final java.util.List<com.coveiot.android.bleabstract.response.TemperatureResponse> getTemperatureResponseFor1963YH(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, ? extends java.util.ArrayList<com.coveiot.android.jstyle1963dsdk.model.JstyleTemperatureData>> r25) {
        /*
            Method dump skipped, instructions count: 410
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.formatter.JStyle1963DFormatter.getTemperatureResponseFor1963YH(java.util.Map):java.util.List");
    }
}
