...
public final class JStyle1810GFormatter {
    @Nullable

    /* renamed from: a  reason: collision with root package name */
    public String f3311a;
    public final String b = JStyle1810GFormatter.class.getSimpleName();
    @NotNull
    public final DecimalFormat c = new DecimalFormat("0.00");

    public JStyle1810GFormatter(@Nullable String str) {
        this.f3311a = str;
    }
    ...
    public final List<SleepHourData> b(Map<String, ? extends ArrayList<JstyleSleepData>> map) {
        ...
        while (true) {
            ...
            List sortedWith = arrayList3 != null ? CollectionsKt___CollectionsKt.sortedWith(arrayList3, new Comparator() { // from class: com.coveiot.android.bleabstract.formatter.JStyle1810GFormatter$convertRawResponseToSleepDayData$$inlined$compareBy$1
    ...
    public final List<StepsHourData> c(Map<String, ? extends ArrayList<JstyleStepData>> map) {
        ...
        JStyle1810GFormatter jStyle1810GFormatter = this;
        ArrayList arrayList2 = new ArrayList();
        ...
        while (it2.hasNext()) {
            ...
            if (arrayList3 == null || arrayList3.size() <= 0) {
                ...
                while (i3 < size) {
                    ...
                    jStyle1810GFormatter.c.setDecimalFormatSymbols(new DecimalFormatSymbols(Locale.ENGLISH));
                    String format = jStyle1810GFormatter.c.format(parseDouble);
                    Intrinsics.checkNotNullExpressionValue(format, "df.format(totalCaloriesPerHour)");
                    d2 = Double.parseDouble(format);
                    String format2 = jStyle1810GFormatter.c.format(d3 + Double.parseDouble(distance));
    ...
    */
    public final com.coveiot.android.bleabstract.response.ECGResultResponse getECGResultResponse(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, java.lang.String> r11, @org.jetbrains.annotations.NotNull java.util.List<java.lang.Integer> r12, @org.jetbrains.annotations.NotNull java.util.List<java.lang.Float> r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.formatter.JStyle1810GFormatter.getECGResultResponse(java.util.Map, java.util.List, java.util.List):com.coveiot.android.bleabstract.response.ECGResultResponse");
    }
    ...
    public final List<HeartRateResponse> getHeartRateResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleHRData>> stepsArrayListMap) {
        ...
        for (String str : treeMap2.keySet()) {
            ...
            heartRateDayData.setmMacAddress(this.f3311a);
            HeartRateTimeLogBeanData heartRateTimeLogBeanData = new HeartRateTimeLogBeanData();
    ...
    public final List<SleepResponse> getSleepResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleSleepData>> sleepArrayListMap) {
        ...
        for (String str : treeMap.keySet()) {
            ...
            sleepDayData.setmMacAddress(this.f3311a);
            SleepTimeLogBeanData sleepTimeLogBeanData = new SleepTimeLogBeanData();
            ArrayList arrayList6 = new ArrayList();
            if (arrayList5 != null && arrayList5.size() > 0) {
    ...
    public final List<ActivityModeSummaryResponse> getSportModeHistoryData(@NotNull Object obj) {
        ...
        while (it2.hasNext()) {
            ...
            if (str7 != null) {
                activityModeSummaryResponse.setActivityMode(JStyleUtils.getActivityModeFor1810G(Integer.parseInt(str7)));
            }
            if (str8 != null) {
            ...
            activityModeSummaryResponse.setMacAddress(this.f3311a);
    ...
    public final List<StepsResponse> getStepsResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleStepData>> stepsArrayListMap) {
        ...
        for (String str : treeMap.keySet()) {
            ...
            stepsDayData.setmMacAddress(this.f3311a);
            StepsTimeLogBeanData stepsTimeLogBeanData = new StepsTimeLogBeanData();
            ArrayList arrayList6 = new ArrayList();
            if (arrayList5 != null && arrayList5.size() > 0) {
                int size3 = arrayList5.size();
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.util.List<com.coveiot.android.bleabstract.response.TemperatureResponse> getTemperatureResponseFor1810G(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, ? extends java.util.ArrayList<com.coveiot.android.jstyle1810gsdk.model.JstyleTemperatureData>> r25) {
        /*
            Method dump skipped, instructions count: 410
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.formatter.JStyle1810GFormatter.getTemperatureResponseFor1810G(java.util.Map):java.util.List");
    }
}
