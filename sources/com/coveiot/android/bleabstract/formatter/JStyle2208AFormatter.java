...
import com.coveiot.android.jstyle2208a.model.JstyleHRData;
import com.coveiot.android.jstyle2208a.model.JstyleHrvData;
import com.coveiot.android.jstyle2208a.model.JstyleSleepData;
import com.coveiot.android.jstyle2208a.model.JstyleSpo2Data;
import com.coveiot.android.jstyle2208a.model.JstyleStepData;
import com.coveiot.android.jstyle2208a.model.JstyleTemperatureData;
...
public final class JStyle2208AFormatter {
    @Nullable

    /* renamed from: a  reason: collision with root package name */
    public String f3314a;
    public final String b = JStyle2208AFormatter.class.getSimpleName();
    @NotNull
    public final DecimalFormat c = new DecimalFormat("0.00");

    public JStyle2208AFormatter(@Nullable String str) {
        this.f3314a = str;
    }
    ...
    public final List<SleepHourData> b(Map<String, ? extends ArrayList<JstyleSleepData>> map) {
        ...
        while (true) {
            ...
            List sortedWith = arrayList4 != null ? CollectionsKt___CollectionsKt.sortedWith(arrayList4, new Comparator() { // from class: com.coveiot.android.bleabstract.formatter.JStyle2208AFormatter$convertRawResponseToSleepDayData$$inlined$compareBy$1
    ...
    public final LiveHealthData convertToLiveHealthData(@NotNull Map<String, String> realTimeData) {
        ...
        String str = this.b;
        LogHelper.d(str, " Live data " + realTimeData);
        String str2 = realTimeData.get(DeviceKey.HeartRate);
        String str3 = this.b;
        LogHelper.d(str3, "LIVE DATA HEART RATE = " + str2, ModuleNames.BLEABSTRACT.getModuleName());
        LiveHealthData liveHealthData = new LiveHealthData();
        liveHealthData.setHeartRate(str2 != null ? Integer.parseInt(str2) : 0);
    ...
    public final List<StepsHourData> d(Map<String, ? extends ArrayList<JstyleStepData>> map) {
        ...
        JStyle2208AFormatter jStyle2208AFormatter = this;
        ArrayList arrayList2 = new ArrayList();
        ...
        while (it2.hasNext()) {
            ...
            if (arrayList3 == null || arrayList3.size() <= 0) {
                ...
                while (i3 < size) {
                    ...
                    jStyle2208AFormatter.c.setDecimalFormatSymbols(new DecimalFormatSymbols(Locale.ENGLISH));
                    String format = jStyle2208AFormatter.c.format(parseDouble);
                    Intrinsics.checkNotNullExpressionValue(format, "df.format(totalCaloriesPerHour)");
                    d2 = Double.parseDouble(format);
                    String format2 = jStyle2208AFormatter.c.format(d3 + Double.parseDouble(distance));
    ...
    */
    public final java.util.List<com.coveiot.android.bleabstract.response.StressResponse> getHRVResponseFor1790And1939(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, ? extends java.util.ArrayList<com.coveiot.android.jstyle2208a.model.JstyleHrvData>> r25) {
        /*
            Method dump skipped, instructions count: 802
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.formatter.JStyle2208AFormatter.getHRVResponseFor1790And1939(java.util.Map):java.util.List");
    }
    ...
    public final List<HeartRateResponse> getHeartRateResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleHRData>> stepsArrayListMap) {
        ...
        for (String str : treeMap2.keySet()) {
            ...
            heartRateDayData.setmMacAddress(this.f3314a);
            HeartRateTimeLogBeanData heartRateTimeLogBeanData = new HeartRateTimeLogBeanData();
    ...
    public final List<SleepResponse> getSleepResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleSleepData>> sleepArrayListMap) {
        ...
        for (String str : treeMap.keySet()) {
            ...
            sleepDayData.setmMacAddress(this.f3314a);
            SleepTimeLogBeanData sleepTimeLogBeanData = new SleepTimeLogBeanData();
            ArrayList arrayList6 = new ArrayList();
            if (arrayList5 != null && arrayList5.size() > 0) {
    ...
    public final List<PeriodicSpo2Response> getSpo2ResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleSpo2Data>> stepsArrayListMap) {
        ...
        while (it2.hasNext()) {
            ...
            spo2DayData.setmMacAddress(this.f3314a);
        ...
        while (it2.hasNext()) {
            ...
            if (str2 != null) {
                ...
                try {
                    ...
                    activityModeSummaryResponse.setDate(JStyleUtils.getFormattedDate(str10, str));
                }
            ...
            if (str9 != null) {
                i2 = i;
                activityModeSummaryResponse.setAvgPace((Integer.parseInt((String) StringsKt__StringsKt.split$default((CharSequence) str9, new String[]{"'"}, false, 0, 6, (Object) null).get(i2)) * 60) + Integer.parseInt(StringsKt__StringsKt.removeSuffix((String) StringsKt__StringsKt.split$default((CharSequence) str9, new String[]{"'"}, false, 0, 6, (Object) null).get(1), (CharSequence) "\"")));
                activityModeSummaryResponse.setPaceInSeconds((Integer.parseInt((String) StringsKt__StringsKt.split$default((CharSequence) str9, new String[]{"'"}, false, 0, 6, (Object) null).get(i2)) * 60) + Integer.parseInt(StringsKt__StringsKt.removeSuffix((String) StringsKt__StringsKt.split$default((CharSequence) str9, new String[]{"'"}, false, 0, 6, (Object) null).get(1), (CharSequence) "\"")));
            } else {
                i2 = i;
            }
            if (str7 != null) {
                activityModeSummaryResponse.setActivityMode(JStyleUtils.getActivityModeFor2208(Integer.parseInt(str7)));
            }
            if (str8 != null) {
                activityModeSummaryResponse.setHeartRate(Integer.parseInt(str8));
            }
            activityModeSummaryResponse.setMacAddress(this.f3314a);
            ...
            for (int i3 = i2; i3 < size; i3++) {
                ...
                activityHeartRateSample.setHrTimeStamp(hRDataListBetweenTime.get(i3).getHrTimeStamp());
                activityHeartRateSample.setHrValue(hRDataListBetweenTime.get(i3).getHrValue());
            ...
            for (int i4 = i2; i4 < size2; i4++) {
                ...
                arrayList3.add(Integer.valueOf(heartRateSampleList2.get(i4).getHrValue()));
            }
            ...
            for (int i8 = 0; i8 < size3; i8++) {
                new ArrayList();
                ArrayList<Integer> codevalue = hourlyStepsValueBetween.get(i8).getCodevalue();
                Intrinsics.checkNotNullExpressionValue(codevalue, "walkDataList.get(i).codevalue");
                arrayList5.addAll(codevalue);
            }
            int i9 = ((int) minutes) + i6 + 1;
            if (arrayList5.size() > i9) {
                arrayList6.addAll(arrayList5.subList(i6, i9));
            }
            ...
            for (int i11 = 0; i11 < size5; i11++) {
                ...
                activityStepsSample.setStepsTimeStamp(((SessionSteps) arrayList7.get(i11)).getStepsTimeStamp());
                activityStepsSample.setStepsValue(((SessionSteps) arrayList7.get(i11)).getStepsValue());
            ...
            for (int i12 = 0; i12 < size6; i12++) {
                ...
                activityGPSSample.setGpsTimeStamp(gPSDataListBetweenTime.get(i12).getGpsTimeStamp());
                activityGPSSample.setLocation(new LatLng(gPSDataListBetweenTime.get(i12).getLatitudeValue(), gPSDataListBetweenTime.get(i12).getLongitudeValue()));
    ...
    public final List<StepsResponse> getStepsResponseFor1790And1939(@NotNull Map<String, ? extends ArrayList<JstyleStepData>> stepsArrayListMap) {
        ...
        for (String str : treeMap.keySet()) {
            ...
            stepsDayData.setmMacAddress(this.f3314a);
            StepsTimeLogBeanData stepsTimeLogBeanData = new StepsTimeLogBeanData();
            ArrayList arrayList6 = new ArrayList();
            if (arrayList5 != null && arrayList5.size() > 0) {
                int size3 = arrayList5.size();
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.util.List<com.coveiot.android.bleabstract.response.TemperatureResponse> getTemperatureResponseFor1860(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, ? extends java.util.ArrayList<com.coveiot.android.jstyle2208a.model.JstyleTemperatureData>> r25) {
        /*
            Method dump skipped, instructions count: 410
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.bleabstract.formatter.JStyle2208AFormatter.getTemperatureResponseFor1860(java.util.Map):java.util.List");
    }
}
