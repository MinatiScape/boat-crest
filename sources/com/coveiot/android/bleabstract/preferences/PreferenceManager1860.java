...
public class PreferenceManager1860 {

    /* renamed from: a  reason: collision with root package name */
    public static PreferenceManager1860 f3462a;
    public static SharedPreferences b;
    public static SharedPreferences.Editor c;

    public static PreferenceManager1860 getInstance(Context context) {
        if (f3462a == null) {
            SharedPreferences sharedPreferences = context.getSharedPreferences("PREFERENCE_MANAGER_1860", 0);
            b = sharedPreferences;
            c = sharedPreferences.edit();
            f3462a = new PreferenceManager1860();
        }
        return f3462a;
    }
