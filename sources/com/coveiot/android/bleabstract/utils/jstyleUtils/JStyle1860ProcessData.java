...
import com.coveiot.android.jstyle1860Sdk.model.JstyleDynamicHRData;
...
public final class JStyle1860ProcessData {

    /* renamed from: a  reason: collision with root package name */
    public static String f4056a = "JStyle1860ProcessData";
    @NotNull
    public static final JStyle1860ProcessData INSTANCE = new JStyle1860ProcessData();
    @NotNull
    public static final SimpleDateFormat b = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss", Locale.ENGLISH);

    public static final ArrayList access$getEntityGPSSessionData(JStyle1860ProcessData jStyle1860ProcessData, ArrayList arrayList, String str) {
        jStyle1860ProcessData.getClass();
    ...
    public static final ArrayList access$getEntityHeartRateSessionData(JStyle1860ProcessData jStyle1860ProcessData, ArrayList arrayList, String str) {
        jStyle1860ProcessData.getClass();
        ArrayList arrayList2 = new ArrayList();
        Iterator it = arrayList.iterator();
        while (it.hasNext()) {
    ...
    public static final void insertHourlyStepsData(@NotNull Context context, @NotNull StepsDayData stepsDayData) {
        ...
        e.e(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new JStyle1860ProcessData$insertHourlyStepsData$1(stepsDayData, context, null), 2, null);
    }
    ...
    public static final void insertSessionGPSData(@NotNull Context context, @NotNull ArrayList<JstyleGpsData> gpsDataList, @NotNull String serialNo) {
        ...
        e.e(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new JStyle1860ProcessData$insertSessionGPSData$1(gpsDataList, serialNo, context, null), 2, null);
    }
    ...
    public static final void insertSessionHRData(@NotNull Context context, @NotNull ArrayList<JstyleDynamicHRData> hrDataList, @NotNull String serialNo) {
        ...
        Intrinsics.checkNotNullParameter(serialNo, "serialNo");
        e.e(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new JStyle1860ProcessData$insertSessionHRData$1(hrDataList, serialNo, context, null), 2, null);
    }
