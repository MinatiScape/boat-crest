...
import com.coveiot.android.jstyle2208a.model.JstyleDynamicHRData;
import com.coveiot.android.jstyle2208a.model.JstyleGpsData;
...
public final class JStyle2208AProcessData {
    @NotNull
    public static final JStyle2208AProcessData INSTANCE = new JStyle2208AProcessData();

    /* renamed from: a  reason: collision with root package name */
    public static String f4063a = "JStyle2208AProcessData";
    @NotNull
    ...
    public static final ArrayList access$getEntityGPSSessionData(JStyle2208AProcessData jStyle2208AProcessData, ArrayList arrayList, String str) {
        jStyle2208AProcessData.getClass();
    ...
    public static final ArrayList access$getEntityHeartRateSessionData(JStyle2208AProcessData jStyle2208AProcessData, ArrayList arrayList, String str) {
        jStyle2208AProcessData.getClass();
        ArrayList arrayList2 = new ArrayList();
        Iterator it = arrayList.iterator();
        while (it.hasNext()) {
    ...
    public static final void insertHourlyStepsData(@NotNull Context context, @NotNull StepsDayData stepsDayData) {
        ...
        e.e(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new JStyle2208AProcessData$insertHourlyStepsData$1(stepsDayData, context, null), 2, null);
    }
    ...
    public static final void insertSessionGPSData(@NotNull Context context, @NotNull ArrayList<JstyleGpsData> gpsDataList, @NotNull String serialNo) {
        ...
        e.e(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new JStyle2208AProcessData$insertSessionGPSData$1(gpsDataList, serialNo, context, null), 2, null);
    }
    ...
    public static final void insertSessionHRData(@NotNull Context context, @NotNull ArrayList<JstyleDynamicHRData> hrDataList, @NotNull String serialNo) {
        ...
        Intrinsics.checkNotNullParameter(serialNo, "serialNo");
        e.e(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new JStyle2208AProcessData$insertSessionHRData$1(hrDataList, serialNo, context, null), 2, null);
    }
    ...
    public final Map<String, ArrayList<JstyleTemperatureData>> processTemperatureData(@NotNull Object obj) {
        ...
        for (Map map : (List) obj) {
            ...
            String str = (String) map.get("date");
            String str2 = (String) map.get("axillaryTemperature");
            if (str2 == null) {
