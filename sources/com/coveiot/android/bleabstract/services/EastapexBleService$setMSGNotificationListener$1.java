...
public final class EastapexBleService$setMSGNotificationListener$1 implements GeneralCallback {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ EastapexBleService f3757a;

    public EastapexBleService$setMSGNotificationListener$1(EastapexBleService eastapexBleService) {
        this.f3757a = eastapexBleService;
    }

    public static final void a(EastapexBleService this$0, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        String tag = this$0.getTAG();
        LogHelper.i(tag, "setMSGNotificationListener->result-> " + z + "  khCurrentCommand " + this$0.getKhCurrentCommand(), ModuleNames.BLEABSTRACT.getModuleName());
        if (this$0.getKhCurrentCommand() == null || !(this$0.getKhCurrentCommand() instanceof EastApexSetMsgNotificationReq)) {
            return;
        }
    ...
    public void mutualFail(int i) {
        String tag = this.f3757a.getTAG();
        LogHelper.i(tag, "setMSGNotificationListener->mutualFail-> " + i + "  khCurrentCommand " + this.f3757a.getKhCurrentCommand(), ModuleNames.BLEABSTRACT.getModuleName());
        this.f3757a.a(String.valueOf(i));
    }

    @Override // com.apex.bluetooth.callback.GeneralCallback
    public void result(final boolean z) {
        Handler handler;
        handler = this.f3757a.j;
        final EastapexBleService eastapexBleService = this.f3757a;
        handler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.services.i1
            @Override // java.lang.Runnable
            public final void run() {
                EastapexBleService$setMSGNotificationListener$1.a(EastapexBleService.this, z);
            }
        });
    }
}
