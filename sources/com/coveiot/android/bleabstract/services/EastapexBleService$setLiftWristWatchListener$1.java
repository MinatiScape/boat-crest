...
public final class EastapexBleService$setLiftWristWatchListener$1 implements GeneralCallback {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ EastapexBleService f3756a;

    public EastapexBleService$setLiftWristWatchListener$1(EastapexBleService eastapexBleService) {
        this.f3756a = eastapexBleService;
    }

    public static final void a(EastapexBleService this$0, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        String tag = this$0.getTAG();
        LogHelper.i(tag, "setLiftWristWatchListener->result-> " + z + " khCurrentCommand " + this$0.getKhCurrentCommand(), ModuleNames.BLEABSTRACT.getModuleName());
        if (this$0.getKhCurrentCommand() == null || !(this$0.getKhCurrentCommand() instanceof EastApexSetLiftWristReq)) {
            return;
        }
    ...
    public void mutualFail(int i) {
        String tag = this.f3756a.getTAG();
        LogHelper.i(tag, "setLiftWristWatchListener->mutualFail-> " + i + "  khCurrentCommand " + this.f3756a.getKhCurrentCommand(), ModuleNames.BLEABSTRACT.getModuleName());
        this.f3756a.a(String.valueOf(i));
    }

    @Override // com.apex.bluetooth.callback.GeneralCallback
    public void result(final boolean z) {
        Handler handler;
        handler = this.f3756a.j;
        final EastapexBleService eastapexBleService = this.f3756a;
        handler.post(new Runnable() { // from class: com.coveiot.android.bleabstract.services.h1
            @Override // java.lang.Runnable
            public final void run() {
                EastapexBleService$setLiftWristWatchListener$1.a(EastapexBleService.this, z);
            }
        });
    }
}
