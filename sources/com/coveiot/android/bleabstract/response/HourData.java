...
public class HourData {
    ...
    public String getDate() {
        try {
            this.f3637a = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH).format(new SimpleDateFormat("yyyy-MM-dd").parse(this.f3637a));
    ...
    public long getTimeStamp() {
        ...
        try {
            this.b = simpleDateFormat.parse(this.f3637a + HexStringBuilder.DEFAULT_SEPARATOR + getStartHour()).getTime();
