...
@DebugMetadata(c = "com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2", f = "WatchFaceCloudViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes8.dex */
public final class WatchFaceCloudViewModel$sendWatchFaceToWatch$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WatchFaceCloudViewModel$sendWatchFaceToWatch$2(WatchFaceCloudViewModel watchFaceCloudViewModel, CustomWatchFaceFileImageRequest customWatchFaceFileImageRequest, Continuation<? super WatchFaceCloudViewModel$sendWatchFaceToWatch$2> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WatchFaceCloudViewModel$sendWatchFaceToWatch$2(this.this$0, this.$changeWatchFaceRequest, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((WatchFaceCloudViewModel$sendWatchFaceToWatch$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            bleApi.getData(changeWatchFaceRequest, new DataResultListener() { // from class: com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2.1

                @DebugMetadata(c = "com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$onDataError$1", f = "WatchFaceCloudViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$a */
                /* loaded from: classes8.dex */
                public static final class a extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public a(WatchFaceCloudViewModel watchFaceCloudViewModel, BleBaseError bleBaseError, Continuation<? super a> continuation) {
                        super(2, continuation);
                        this.this$0 = watchFaceCloudViewModel;
                ...
                @DebugMetadata(c = "com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$onDataResponse$1", f = "WatchFaceCloudViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$b */
                /* loaded from: classes8.dex */
                public static final class b extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(@NotNull Object obj) {
                        ...
                        if (this.label == 0) {
                            ...
                            value3.setVisible(false);
                            this.this$0.getProgressLiveData().postValue(this.this$0.getProgressLiveData().getValue());
                            this.this$0.getViewModelOnSuccessListener().onCloudWatchFaceSuccess(true);
                            return Unit.INSTANCE;
                        }
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                ...
                @DebugMetadata(c = "com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$onProgressUpdate$1", f = "WatchFaceCloudViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$c */
                /* loaded from: classes8.dex */
                public static final class c extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public c(WatchFaceCloudViewModel watchFaceCloudViewModel, ProgressData progressData, Continuation<? super c> continuation) {
                        super(2, continuation);
                        this.this$0 = watchFaceCloudViewModel;
                ...
                */
                public void onDataError(@org.jetbrains.annotations.NotNull com.coveiot.android.bleabstract.response.BleBaseError r9) {
                    /*
                        ...
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel r0 = com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel.this
                        kotlinx.coroutines.CoroutineScope r1 = androidx.lifecycle.ViewModelKt.getViewModelScope(r0)
                        kotlinx.coroutines.MainCoroutineDispatcher r2 = kotlinx.coroutines.Dispatchers.getMain()
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$a r4 = new com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$a
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel r0 = com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel.this
                        r7 = 0
                        r4.<init>(r0, r9, r7)
                        r3 = 0
                    ...
                    L3e:
                        ...
                        r9.printStackTrace()
                    L42:
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel r9 = com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel.this
                        kotlinx.coroutines.CoroutineScope r0 = androidx.lifecycle.ViewModelKt.getViewModelScope(r9)
                        kotlinx.coroutines.CoroutineDispatcher r1 = kotlinx.coroutines.Dispatchers.getIO()
                        r2 = 0
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$onDataError$2 r3 = new com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$onDataError$2
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel r9 = com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel.this
                        r3.<init>(r9, r7)
                        r4 = 2
                        r5 = 0
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2.AnonymousClass1.onDataError(com.coveiot.android.bleabstract.response.BleBaseError):void");
                }
                ...
                */
                public void onDataResponse(@org.jetbrains.annotations.NotNull com.coveiot.android.bleabstract.response.BleBaseResponse r7) {
                    /*
                        ...
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel r7 = com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel.this
                        kotlinx.coroutines.CoroutineScope r0 = androidx.lifecycle.ViewModelKt.getViewModelScope(r7)
                        kotlinx.coroutines.MainCoroutineDispatcher r1 = kotlinx.coroutines.Dispatchers.getMain()
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$b r3 = new com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2$1$b
                        com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel r7 = com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel.this
                        r2 = 0
                        r3.<init>(r7, r2)
                        r4 = 2
                    ...
                    L41:
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.coveiot.android.watchfaceui.viewmodel.WatchFaceCloudViewModel$sendWatchFaceToWatch$2.AnonymousClass1.onDataResponse(com.coveiot.android.bleabstract.response.BleBaseResponse):void");
                }

                @Override // com.coveiot.android.bleabstract.listeners.DataResultListener
                public void onProgressUpdate(@NotNull ProgressData progress) {
                    Intrinsics.checkNotNullParameter(progress, "progress");
                    e.e(ViewModelKt.getViewModelScope(WatchFaceCloudViewModel.this), Dispatchers.getMain(), null, new c(WatchFaceCloudViewModel.this, progress, null), 2, null);
                }
            });
            return Unit.INSTANCE;
        }
