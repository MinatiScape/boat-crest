...
public class WatchFaceHolderWaveBeatBindingImpl extends WatchFaceHolderWaveBeatBinding {
    @Nullable
    ...
    public WatchFaceHolderWaveBeatBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public WatchFaceHolderWaveBeatBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
