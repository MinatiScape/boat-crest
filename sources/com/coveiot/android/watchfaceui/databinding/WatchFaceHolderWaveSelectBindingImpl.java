...
public class WatchFaceHolderWaveSelectBindingImpl extends WatchFaceHolderWaveSelectBinding {
    @Nullable
    ...
    public WatchFaceHolderWaveSelectBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public WatchFaceHolderWaveSelectBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
