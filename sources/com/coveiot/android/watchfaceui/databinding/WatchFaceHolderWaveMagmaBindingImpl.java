...
public class WatchFaceHolderWaveMagmaBindingImpl extends WatchFaceHolderWaveMagmaBinding {
    @Nullable
    ...
    public WatchFaceHolderWaveMagmaBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public WatchFaceHolderWaveMagmaBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
