...
public class WatchFaceHolderWaveForceBindingImpl extends WatchFaceHolderWaveForceBinding {
    @Nullable
    ...
    public WatchFaceHolderWaveForceBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public WatchFaceHolderWaveForceBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
