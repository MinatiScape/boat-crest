...
public class BleDynamicSportFieldButtonImage extends BleDynamicSportsField {
    ...
    public BleDynamicSportFieldButtonImage(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, String str) {
        super(i2, i3, i4, i6, i7);
        this.dataType = (byte) 9;
        this.buttonId = i;
        this.sideBySide = i5;
        this.buttonAction = i8;
        this.buttonImageId = i9;
    ...
    public byte[] getDataBytes() {
        ...
        byte[] array4 = ByteBuffer.allocate(4).order(byteOrder).putInt(this.buttonImageId).array();
