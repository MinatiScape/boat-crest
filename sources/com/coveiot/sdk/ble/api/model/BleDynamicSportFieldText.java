...
public class BleDynamicSportFieldText extends BleDynamicSportsField {
    private byte dataType;
    public int font;
    public String text;
    public int typeFace;

    public BleDynamicSportFieldText(int i, int i2, int i3, int i4, int i5, int i6, int i7, String str) {
        super(i, i2, i3, i4, i5);
