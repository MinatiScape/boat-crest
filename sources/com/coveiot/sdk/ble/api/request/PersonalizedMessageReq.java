...
public class PersonalizedMessageReq extends BaseRequest {
    ...
    public PersonalizedMessageReq(Object obj, List<BleDynamicSportsField> list, short s, short s2, short s3, short s4, short s5) {
        super(obj);
        this.f = list;
        this.g = s;
        this.h = s2;
    ...
    public List<CommandBytes> getCommandBytes() {
        ...
        if (i + 4 > 150) {
            generateSinglePacketRequest = MultiPacketRequestGenerator.generateRequest((byte) 2, (byte) -92, bArr3, bArr2, false, false);
        } else {
            generateSinglePacketRequest = MultiPacketRequestGenerator.generateSinglePacketRequest((byte) 2, (byte) -92, bArr3, bArr2, false);
        }
    ...
    public CommandNames getCommandName() {
        return CommandNames.SEND_PERSONALIZED_MESSAGE;
    }
