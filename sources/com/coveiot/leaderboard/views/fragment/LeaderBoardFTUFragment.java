...
public class LeaderBoardFTUFragment extends Fragment {
    public TextView h;
    public TextView i;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            LeaderBoardFTUFragment.this.requireActivity().onBackPressed();
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            analyticsLog.setUiElementName(FirebaseEventParams.UiElementName.LEARN_ABOUT_BADGES.getValue());
            CoveAnalyticsManager.Companion.getInstance().logEvent(analyticsLog);
            LeaderBoardFTUFragment.this.onLearnAboutBadgeClick();
        }
    }
    ...
    public class c implements View.OnClickListener {
        ...
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            LeaderBoardFTUFragment.this.onSkipClick();
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.fragment_leader_board_ftu, viewGroup, false);
        ConstraintLayout constraintLayout = (ConstraintLayout) inflate.findViewById(R.id.toolbar);
        this.j = constraintLayout;
        ((TextView) constraintLayout.findViewById(R.id.toolbar_title)).setVisibility(8);
        this.j.setOnClickListener(new a());
        this.h = (TextView) inflate.findViewById(R.id.learnAboutBadges);
