...
public class WeeklyRankingFragment extends Fragment implements IRankItemClick {
    ...
    public class a implements CoveApiListener<RankHistoryModel, CoveApiErrorModel> {
        ...
        public void onError(CoveApiErrorModel coveApiErrorModel) {
            WeeklyRankingFragment.this.h.setVisibility(8);
            WeeklyRankingFragment.this.i.setVisibility(0);
        }
        ...
        public void onSuccess(RankHistoryModel rankHistoryModel) {
            if (rankHistoryModel != null) {
                if (rankHistoryModel.getData().getRanks() != null && rankHistoryModel.getData().getRanks().size() > 0) {
                    WeeklyRankingFragment.this.k.setData(rankHistoryModel.getData().getRanks());
                    WeeklyRankingFragment weeklyRankingFragment = WeeklyRankingFragment.this;
                    weeklyRankingFragment.h.setAdapter(weeklyRankingFragment.k);
                    WeeklyRankingFragment.this.h.setVisibility(0);
                    WeeklyRankingFragment.this.i.setVisibility(8);
                    return;
                }
                WeeklyRankingFragment.this.h.setVisibility(8);
                WeeklyRankingFragment.this.i.setVisibility(0);
    ...
    public final void a(FilterType filterType) {
        CoveLeaderboardApi.getRankHistory(RankType.WEEK, filterType, new a());
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.h = (RecyclerView) inflate.findViewById(R.id.weeklyRecyclerview);
