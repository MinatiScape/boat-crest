...
public final class TopRankersFilteredListAdapter extends RecyclerView.Adapter<ViewHolder> {
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    public final Context f7250a;
    @NotNull
    public final List<RankHistoryModel.DataBean.RanksBean> b;
    ...
    public final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final TopRankersListItemBinding f7251a;
        @NotNull
        ...
        public ViewHolder(@NotNull TopRankersFilteredListAdapter topRankersFilteredListAdapter, TopRankersListItemBinding binding) {
    ...
    public TopRankersFilteredListAdapter(@NotNull Context mContext, @NotNull List<? extends RankHistoryModel.DataBean.RanksBean> ranksList) {
    ...
    @NotNull
    public final List<RankHistoryModel.DataBean.RanksBean> getRanksList() {
        return this.b;
    }
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
        ...
        TextView rankerName = holder.getRankerName();
        Object userName = this.b.get(i).getUserName();
        rankerName.setText((userName == null || (r1 = userName.toString()) == null) ? "--" : "--");
        TextView rankerSteps = holder.getRankerSteps();
        String valueOf = String.valueOf(this.b.get(i).getSteps());
        rankerSteps.setText(valueOf != null ? valueOf : "--");
        if (this.b.get(i).getDpUrl() != null) {
            Glide.with(this.f7250a).m30load(this.b.get(i).getDpUrl()).apply((BaseRequestOptions<?>) new RequestOptions().circleCrop().placeholder(R.drawable.default_avatar)).into(holder.getProfileImage());
        } else {
            holder.getProfileImage().setImageDrawable(this.f7250a.getDrawable(R.drawable.default_avatar));
        }
    }
