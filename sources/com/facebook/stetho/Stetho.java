...
public class Stetho {
    ...
    public static abstract class Initializer {
        ...
        public final void start() {
            new ServerManager(new LocalSocketServer(Constants.MAIN_TAG, AddressNameHelper.createCustomAddress("_devtools_remote"), new LazySocketHandler(new RealSocketHandlerFactory()))).start();
        }
    }
