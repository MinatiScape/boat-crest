...
public final class a extends com.realsil.sdk.dfu.m.a {
    ...
    public void g() {
        ...
        if (bluetoothGattCharacteristic != null) {
            ...
            if (a(this.i, bluetoothGattCharacteristic, true)) {
                ...
                ZLogger.d(true, "readTempDeviceInfo failed");
            }
        }
        for (BluetoothGattCharacteristic bluetoothGattCharacteristic2 : this.n) {
            ...
            if (shortValue >= 65472 && shortValue <= 65487) {
                ...
                ZLogger.v(false, "read debug info :" + a9);
    ...
    public final void j() {
        if (this.k == null) {
            this.H = null;
            ZLogger.w(true, "not find DFU_SERVICE_UUID = " + com.realsil.sdk.dfu.q.g.f13644a);
            if (this.B != null) {
    ...
    public final void k() {
        ...
        BluetoothGattCharacteristic characteristic2 = this.j.getCharacteristic(h.b);
        ...
        if (characteristic5 == null) {
            ...
            ZLogger.v("find OTA_READ_PATCH_EXTENSION_CHARACTERISTIC_UUID = " + uuid2);
