...
public class GlobalGatt {
    ...
    public static GlobalGatt f13557a;
    public boolean b;
    public boolean c;
    ...
    public class a extends BluetoothGattCallback {
        ...
        public void onCharacteristicChanged(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
            ...
            List<BluetoothGattCallback> list = GlobalGatt.this.h.get(address);
        ...
        public void onCharacteristicRead(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, int i) {
            ...
            synchronized (GlobalGatt.this.k) {
                GlobalGatt.this.j = true;
                GlobalGatt.this.k.notifyAll();
            }
            List<BluetoothGattCallback> list = GlobalGatt.this.h.get(bluetoothGatt.getDevice().getAddress());
            if (list == null || list.size() <= 0) {
                return;
            }
            for (BluetoothGattCallback bluetoothGattCallback : list) {
        ...
        public void onConnectionStateChange(BluetoothGatt bluetoothGatt, int i, int i2) {
            ...
            if (i != 0) {
                GlobalGatt.this.i.put(address, 0);
            } else if (i2 == 2) {
                GlobalGatt.this.i.put(address, 2);
                GlobalGatt.this.g.put(address, bluetoothGatt);
            } else {
                GlobalGatt.this.i.put(address, 0);
            }
            List<BluetoothGattCallback> list = GlobalGatt.this.h.get(address);
    ...
    public static synchronized void initial(Context context) {
        synchronized (GlobalGatt.class) {
            if (f13557a == null) {
                synchronized (GlobalGatt.class) {
                    if (f13557a == null) {
                        f13557a = new GlobalGatt(context.getApplicationContext());
                    }
                }
            }
        }
    ...
    public boolean connect(String str, boolean z, int i, int i2, BluetoothGattCallback bluetoothGattCallback) {
        ...
        if (bluetoothAdapter == null) {
            ...
            if (this.f.contains(str) && (bluetoothGatt = this.g.get(str)) != null) {
                if (isConnected(str)) {
                    if (this.b) {
            ...
            if (i3 >= 26) {
                connectGatt = remoteDevice.connectGatt(this.l, z, new a(), i, i2);
            } else if (i3 >= 23) {
                connectGatt = remoteDevice.connectGatt(this.l, z, new a(), i);
            } else {
                connectGatt = remoteDevice.connectGatt(this.l, z, new a());
            }
            if (connectGatt == null) {
