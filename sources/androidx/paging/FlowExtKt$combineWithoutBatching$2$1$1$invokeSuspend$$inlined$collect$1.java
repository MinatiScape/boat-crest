...
public final class FlowExtKt$combineWithoutBatching$2$1$1$invokeSuspend$$inlined$collect$1 implements FlowCollector<Object> {
    ...
    */
    public java.lang.Object emit(java.lang.Object r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
    ...
    public Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        UnbatchedFlowCombiner unbatchedFlowCombiner = this.h;
        int i = this.i;
        InlineMarker.mark(0);
        unbatchedFlowCombiner.onNext(i, obj, continuation);
        InlineMarker.mark(1);
        InlineMarker.mark(0);
