...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public static final Logger l = Logger.getLogger(AbstractResolvableFuture.class.getName());
    ...
    public static final class d {
        ...
        public d(Throwable th) {
            this.f846a = (Throwable) AbstractResolvableFuture.c(th);
        }
    }
    ...
    public static final class f extends b {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<i, Thread> f848a;
        ...
        public f(AtomicReferenceFieldUpdater<i, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<i, i> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<AbstractResolvableFuture, i> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<AbstractResolvableFuture, e> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<AbstractResolvableFuture, Object> atomicReferenceFieldUpdater5) {
            super();
            this.f848a = atomicReferenceFieldUpdater;
        ...
        public void e(i iVar, Thread thread) {
            this.f848a.lazySet(iVar, thread);
        }
    }

    /* loaded from: classes.dex */
    public static final class g<V> implements Runnable {
        public final AbstractResolvableFuture<V> h;
        ...
        public g(AbstractResolvableFuture<V> abstractResolvableFuture, ListenableFuture<? extends V> listenableFuture) {
            this.h = abstractResolvableFuture;
        ...
        public void run() {
            ...
            if (AbstractResolvableFuture.m.b(this.h, this, AbstractResolvableFuture.h(this.i))) {
                AbstractResolvableFuture.e(this.h);
            }
        }
    }
    ...
    public static final class h extends b {
        ...
        public boolean a(AbstractResolvableFuture<?> abstractResolvableFuture, e eVar, e eVar2) {
            synchronized (abstractResolvableFuture) {
                if (abstractResolvableFuture.i == eVar) {
                    abstractResolvableFuture.i = eVar2;
                    return true;
                }
                return false;
            }
        ...
        public boolean b(AbstractResolvableFuture<?> abstractResolvableFuture, Object obj, Object obj2) {
            synchronized (abstractResolvableFuture) {
                if (abstractResolvableFuture.h == obj) {
                    abstractResolvableFuture.h = obj2;
                    return true;
                }
                return false;
            }
        ...
        public boolean c(AbstractResolvableFuture<?> abstractResolvableFuture, i iVar, i iVar2) {
            synchronized (abstractResolvableFuture) {
                if (abstractResolvableFuture.j == iVar) {
                    abstractResolvableFuture.j = iVar2;
                    return true;
                }
                return false;
            }
    ...
    public static final class i {
        ...
        public void a(i iVar) {
            AbstractResolvableFuture.m.d(this, iVar);
        }

        public void b() {
            Thread thread = this.f849a;
            if (thread != null) {
                this.f849a = null;
        ...
        public i() {
            AbstractResolvableFuture.m.e(this, Thread.currentThread());
        }
    }
    ...
    static {
        b hVar;
        try {
            hVar = new f(AtomicReferenceFieldUpdater.newUpdater(i.class, Thread.class, "a"), AtomicReferenceFieldUpdater.newUpdater(i.class, i.class, "b"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, i.class, "j"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, e.class, "i"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Object.class, "h"));
            th = null;
        } catch (Throwable th) {
            th = th;
            hVar = new h();
    ...
    public static void e(AbstractResolvableFuture<?> abstractResolvableFuture) {
        ...
        while (true) {
            ...
            while (d2 != null) {
                eVar = d2.c;
                Runnable runnable = d2.f847a;
                if (runnable instanceof g) {
                    g gVar = (g) runnable;
                    abstractResolvableFuture = gVar.h;
                    if (abstractResolvableFuture.h == gVar) {
                        if (m.b(abstractResolvableFuture, gVar, h(gVar.i))) {
                            break;
                        }
                    } else {
                        continue;
    ...
    public static Object h(ListenableFuture<?> listenableFuture) {
        if (listenableFuture instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) listenableFuture).h;
            if (obj instanceof c) {
                c cVar = (c) obj;
                return cVar.f845a ? cVar.b != null ? new c(false, cVar.b) : c.d : obj;
            }
            return obj;
        }
    ...
    public final boolean cancel(boolean z) {
        ...
        c cVar = k ? new c(z, new CancellationException("Future.cancel() was called.")) : z ? c.c : c.d;
        AbstractResolvableFuture<V> abstractResolvableFuture = this;
        boolean z2 = false;
        while (true) {
            if (m.b(abstractResolvableFuture, obj, cVar)) {
                if (z) {
                ...
                if (listenableFuture instanceof AbstractResolvableFuture) {
                    ...
                    obj = abstractResolvableFuture.h;
                    if (!(obj == null) && !(obj instanceof g)) {
                        return true;
                    }
                    z2 = true;
    ...
    public final V g(Object obj) throws ExecutionException {
        if (!(obj instanceof c)) {
            ...
            throw new ExecutionException(((d) obj).f846a);
        }
    ...
    public boolean setFuture(ListenableFuture<? extends V> listenableFuture) {
        ...
        if (obj == null) {
            ...
            if (m.b(this, null, gVar)) {
                try {
                    listenableFuture.addListener(gVar, androidx.concurrent.futures.a.INSTANCE);
                } catch (Throwable th) {
                    try {
                        dVar = new d(th);
        ...
        if (obj instanceof c) {
            listenableFuture.cancel(((c) obj).f845a);
        }
        return false;
    }
    ...
    public final boolean wasInterrupted() {
        Object obj = this.h;
        return (obj instanceof c) && ((c) obj).f845a;
    }
