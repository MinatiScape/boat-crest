...
public final class LifecycleKt {
    ...
    public static final LifecycleCoroutineScope getCoroutineScope(@NotNull Lifecycle lifecycle) {
        ...
        do {
            LifecycleCoroutineScopeImpl lifecycleCoroutineScopeImpl2 = (LifecycleCoroutineScopeImpl) lifecycle.f1352a.get();
        ...
        } while (!lifecycle.f1352a.compareAndSet(null, lifecycleCoroutineScopeImpl));
