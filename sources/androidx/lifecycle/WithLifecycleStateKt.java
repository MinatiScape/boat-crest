    ...
    public static final class b extends Lambda implements Function1<Throwable, Unit> {
        ...
        public final void invoke2(@Nullable Throwable th) {
            ...
            if (coroutineDispatcher.isDispatchNeeded(emptyCoroutineContext)) {
                this.$lifecycleDispatcher.dispatch(emptyCoroutineContext, new a(this.$this_suspendWithStateAtLeastUnchecked, this.$observer));
            } else {
            ...
            public void onStateChanged(@NotNull LifecycleOwner source, @NotNull Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m123constructorimpl = Result.m123constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                    ...
                    continuation3.resumeWith(Result.m123constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
            coroutineDispatcher.dispatch(EmptyCoroutineContext.INSTANCE, new a(lifecycle, r1));
        } else {
            lifecycle.addObserver(r1);
        }
        cancellableContinuationImpl.invokeOnCancellation(new b(coroutineDispatcher, lifecycle, r1));
