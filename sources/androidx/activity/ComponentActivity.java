...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost {
    ...
    public class b extends ActivityResultRegistry {
        ...
        public class a implements Runnable {
            ...
            public final /* synthetic */ ActivityResultContract.SynchronousResult i;

            public a(int i, ActivityResultContract.SynchronousResult synchronousResult) {
                this.h = i;
                this.i = synchronousResult;
            }
        ...
        public class RunnableC0105b implements Runnable {
            ...
            @Override // java.lang.Runnable
            public void run() {
                b.this.dispatchResult(this.h, 0, new Intent().setAction(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST).putExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_SEND_INTENT_EXCEPTION, this.i));
            }
        }
        ...
        public <I, O> void onLaunch(int i, @NonNull ActivityResultContract<I, O> activityResultContract, I i2, @Nullable ActivityOptionsCompat activityOptionsCompat) {
            ...
            if (ActivityResultContracts.RequestMultiplePermissions.ACTION_REQUEST_PERMISSIONS.equals(createIntent.getAction())) {
                ...
                try {
                    ...
                    new Handler(Looper.getMainLooper()).post(new RunnableC0105b(i, e));
                }
            } else {
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        e eVar2 = new e();
        eVar2.f342a = onRetainCustomNonConfigurationInstance;
