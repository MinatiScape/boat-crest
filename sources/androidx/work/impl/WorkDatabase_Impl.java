...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public class a extends RoomOpenHelper.Delegate {
        ...
        public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            hashMap3.put(HeaderParameterNames.AUTHENTICATION_TAG, new TableInfo.Column(HeaderParameterNames.AUTHENTICATION_TAG, "TEXT", true, 1, null, 1));
            ...
            hashMap7.put(Constants.KEY_KEY, new TableInfo.Column(Constants.KEY_KEY, "TEXT", true, 1, null, 1));
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new a(12), "c103703e120ae8cc73c9248622f3cd1e", "49f946663a8deb7054212b8adda248c6")).build());
    }
