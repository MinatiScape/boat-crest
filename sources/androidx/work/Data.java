...
public final class Data {
    ...
    public Map<String, Object> f1775a;
    ...
    public static final class Builder {
        ...
        /* renamed from: a  reason: collision with root package name */
        public Map<String, Object> f1776a = new HashMap();

        @NonNull
        public Data build() {
            Data data = new Data(this.f1776a);
        ...
        public Builder put(@NonNull String str, @Nullable Object obj) {
            if (obj == null) {
                this.f1776a.put(str, null);
            } else {
                Class<?> cls = obj.getClass();
                if (cls != Boolean.class && cls != Byte.class && cls != Integer.class && cls != Long.class && cls != Float.class && cls != Double.class && cls != String.class && cls != Boolean[].class && cls != Byte[].class && cls != Integer[].class && cls != Long[].class && cls != Float[].class && cls != Double[].class && cls != String[].class) {
                    if (cls == boolean[].class) {
                        this.f1776a.put(str, Data.convertPrimitiveBooleanArray((boolean[]) obj));
                    } else if (cls == byte[].class) {
                        this.f1776a.put(str, Data.convertPrimitiveByteArray((byte[]) obj));
                    } else if (cls == int[].class) {
                        this.f1776a.put(str, Data.convertPrimitiveIntArray((int[]) obj));
                    } else if (cls == long[].class) {
                        this.f1776a.put(str, Data.convertPrimitiveLongArray((long[]) obj));
                    } else if (cls == float[].class) {
                        this.f1776a.put(str, Data.convertPrimitiveFloatArray((float[]) obj));
                    } else if (cls == double[].class) {
                        this.f1776a.put(str, Data.convertPrimitiveDoubleArray((double[]) obj));
                    } else {
    ...
    */
    public static androidx.work.Data fromByteArray(@androidx.annotation.NonNull byte[] r7) {
        ...
        L2f:
            r7 = move-exception
            java.lang.String r3 = androidx.work.Data.b
        ...
        L44:
            ...
            r7 = r6
        L47:
            java.lang.String r4 = androidx.work.Data.b     // Catch: java.lang.Throwable -> L68
    ...
    public static byte[] toByteArrayInternal(@NonNull Data data) {
        ...
        try {
            ...
            for (Map.Entry<String, Object> entry : data.f1775a.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        Data data = (Data) obj;
        Set<String> keySet = this.f1775a.keySet();
        if (keySet.equals(data.f1775a.keySet())) {
            for (String str : keySet) {
                Object obj2 = this.f1775a.get(str);
                Object obj3 = data.f1775a.get(str);
    ...
    public boolean getBoolean(@NonNull String str, boolean z) {
        Object obj = this.f1775a.get(str);
    ...
    public Map<String, Object> getKeyValueMap() {
        return Collections.unmodifiableMap(this.f1775a);
    }
    ...
    public int hashCode() {
        return this.f1775a.hashCode() * 31;
    }
    ...
    public String toString() {
        ...
        if (!this.f1775a.isEmpty()) {
            for (String str : this.f1775a.keySet()) {
                sb.append(str);
                sb.append(" : ");
                Object obj = this.f1775a.get(str);
    ...
    public Data(@NonNull Data data) {
        this.f1775a = new HashMap(data.f1775a);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public Data(@NonNull Map<String, ?> map) {
        this.f1775a = new HashMap(map);
    }
