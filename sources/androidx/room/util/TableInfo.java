...
public class TableInfo {
    ...
    public static class Column {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.name.equals(column.name) && this.notNull == column.notNull) {
                if (this.f1672a != 1 || column.f1672a != 2 || (str3 = this.defaultValue) == null || str3.equals(column.defaultValue)) {
                    if (this.f1672a != 2 || column.f1672a != 1 || (str2 = column.defaultValue) == null || str2.equals(this.defaultValue)) {
                        int i = this.f1672a;
                        return (i == 0 || i != column.f1672a || ((str = this.defaultValue) == null ? column.defaultValue == null : str.equals(column.defaultValue))) && this.affinity == column.affinity;
                    }
                    return false;
                }
                return false;
    ...
    public static Map<String, Column> a(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
    ...
    public static Set<ForeignKey> c(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
    ...
    @Nullable
    public static Index d(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z) {
    ...
    @Nullable
    public static Set<Index> e(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            if (columnIndex != -1 && columnIndex2 != -1 && columnIndex3 != -1) {
                HashSet hashSet = new HashSet();
                while (query.moveToNext()) {
                    if (c.f10260a.equals(query.getString(columnIndex2))) {
                        String string = query.getString(columnIndex);
                        boolean z = true;
