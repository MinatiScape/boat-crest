...
public class TransitionInflater {
        ...
        if (attributeValue != null) {
            try {
                ...
                synchronized (arrayMap) {
                    ...
                    if (constructor == null && (asSubclass = Class.forName(attributeValue, false, this.f1703a.getClassLoader()).asSubclass(cls)) != 0) {
                        constructor = asSubclass.getConstructor(b);
                        constructor.setAccessible(true);
                        arrayMap.put(attributeValue, constructor);
                    }
                    newInstance = constructor.newInstance(this.f1703a, attributeSet);
                }
                return newInstance;
            } catch (Exception e) {
    ...
    */
    public final androidx.transition.Transition b(org.xmlpull.v1.XmlPullParser r8, android.util.AttributeSet r9, androidx.transition.Transition r10) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final androidx.transition.TransitionManager c(org.xmlpull.v1.XmlPullParser r5, android.util.AttributeSet r6, android.view.ViewGroup r7) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            r4 = this;
            int r0 = r5.getDepth()
            r1 = 0
        ...
        while (true) {
            ...
            if (next == 2) {
                if (xmlPullParser.getName().equals(TypedValues.AttributesType.S_TARGET)) {
                    TypedArray obtainStyledAttributes = this.f1703a.obtainStyledAttributes(attributeSet, o.f1718a);
    ...
    @SuppressLint({"RestrictedApi"})
    public final void e(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        Transition inflateTransition;
        TypedArray obtainStyledAttributes = this.f1703a.obtainStyledAttributes(attributeSet, o.b);
        ...
        Scene sceneForLayout = namedResourceId2 < 0 ? null : Scene.getSceneForLayout(viewGroup, namedResourceId2, this.f1703a);
        int namedResourceId3 = TypedArrayUtils.getNamedResourceId(obtainStyledAttributes, xmlPullParser, "toScene", 1, -1);
        Scene sceneForLayout2 = namedResourceId3 >= 0 ? Scene.getSceneForLayout(viewGroup, namedResourceId3, this.f1703a) : null;
    ...
    public Transition inflateTransition(int i) {
        XmlResourceParser xml = this.f1703a.getResources().getXml(i);
        try {
            try {
