...
public class SidePropagation extends VisibilityPropagation {
    ...
    */
    public final int b(android.view.View r7, int r8, int r9, int r10, int r11, int r12, int r13, int r14, int r15) {
        /*
            r6 = this;
            int r0 = r6.c
            r1 = 5
    ...
    public long getStartDelay(ViewGroup viewGroup, Transition transition, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        float b = b(viewGroup, viewX, viewY, i2, i3, round, round2, width, height) / c(viewGroup);
