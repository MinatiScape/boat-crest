...
public class BasicMeasure {
    ...
    public final ArrayList<ConstraintWidget> f923a = new ArrayList<>();
    ...
    */
    public final void b(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r13) {
        ...
        L30:
            ...
            if (r7 == 0) goto L48
            androidx.constraintlayout.core.widgets.analyzer.b r6 = r6.c
            boolean r6 = r6.resolved
            if (r6 == 0) goto L48
            androidx.constraintlayout.core.widgets.analyzer.b r6 = r7.c
            boolean r6 = r6.resolved
            if (r6 == 0) goto L48
            goto Lac
        L48:
    ...
    public long solverMeasure(ConstraintWidgetContainer constraintWidgetContainer, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (size2 > 0) {
            ...
            boolean z9 = false;
            while (i18 < size2) {
                ConstraintWidget constraintWidget2 = this.f923a.get(i18);
                if (constraintWidget2 instanceof VirtualLayout) {
                    int width2 = constraintWidget2.getWidth();
                    i13 = optimizationLevel;
                    int height2 = constraintWidget2.getHeight();
                    i14 = height;
                    boolean a2 = a(measurer2, constraintWidget2, Measure.TRY_GIVEN_DIMENSIONS) | z9;
            ...
            while (i23 < i22) {
                int i24 = 0;
                while (i24 < size2) {
                    ConstraintWidget constraintWidget3 = this.f923a.get(i24);
                    if (((constraintWidget3 instanceof Helper) && !(constraintWidget3 instanceof VirtualLayout)) || (constraintWidget3 instanceof Guideline) || constraintWidget3.getVisibility() == 8 || ((z6 && constraintWidget3.horizontalRun.c.resolved && constraintWidget3.verticalRun.c.resolved) || (constraintWidget3 instanceof VirtualLayout))) {
                        z2 = z6;
                        i12 = size2;
                        measurer = measurer2;
                    } else {
                        ...
                        boolean a3 = a(measurer2, constraintWidget3, i25) | z9;
                        ...
                        z9 = (!constraintWidget3.hasBaseline() || baselineDistance == constraintWidget3.getBaselineDistance()) ? a3 : true;
                    }
                    i24++;
                    measurer2 = measurer;
                    z6 = z2;
    ...
    public void updateHierarchy(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (horizontalDimensionBehaviour == dimensionBehaviour || constraintWidget.getVerticalDimensionBehaviour() == dimensionBehaviour) {
                this.f923a.add(constraintWidget);
            }
        }
        constraintWidgetContainer.invalidateGraph();
    }
