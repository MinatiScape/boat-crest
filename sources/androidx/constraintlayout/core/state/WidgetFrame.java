...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            Transition.a findPreviousPosition = transition.findPreviousPosition(widgetFrame.widget.stringId, i11);
            i5 = i12;
            Transition.a findNextPosition = transition.findNextPosition(widgetFrame.widget.stringId, i11);
            if (findPreviousPosition == findNextPosition) {
                findNextPosition = null;
            }
            if (findPreviousPosition != null) {
                i5 = (int) (findPreviousPosition.b * i);
                i8 = i2;
                i13 = (int) (findPreviousPosition.c * i8);
                i9 = findPreviousPosition.f901a;
                i7 = i;
            } else {
                i7 = i;
                i8 = i2;
            ...
            if (findNextPosition != null) {
                i14 = (int) (findNextPosition.b * i7);
                i15 = (int) (findNextPosition.c * i8);
                i10 = findNextPosition.f901a;
            } else {
                i10 = 100;
            }
            f5 = (f6 - i9) / (i10 - i9);
        ...
        widgetFrame.pivotX = c(widgetFrame2.pivotX, widgetFrame3.pivotX, 0.5f, f);
        widgetFrame.pivotY = c(widgetFrame2.pivotY, widgetFrame3.pivotY, 0.5f, f);
        widgetFrame.rotationX = c(widgetFrame2.rotationX, widgetFrame3.rotationX, 0.0f, f);
        widgetFrame.rotationY = c(widgetFrame2.rotationY, widgetFrame3.rotationY, 0.0f, f);
        widgetFrame.rotationZ = c(widgetFrame2.rotationZ, widgetFrame3.rotationZ, 0.0f, f);
        widgetFrame.scaleX = c(widgetFrame2.scaleX, widgetFrame3.scaleX, 1.0f, f);
        widgetFrame.scaleY = c(widgetFrame2.scaleY, widgetFrame3.scaleY, 1.0f, f);
        widgetFrame.translationX = c(widgetFrame2.translationX, widgetFrame3.translationX, 0.0f, f);
        widgetFrame.translationY = c(widgetFrame2.translationY, widgetFrame3.translationY, 0.0f, f);
        widgetFrame.translationZ = c(widgetFrame2.translationZ, widgetFrame3.translationZ, 0.0f, f);
        widgetFrame.alpha = c(f3, f9, 1.0f, f);
        ...
        for (String str : keySet) {
            if (widgetFrame2.mCustom.containsKey(str)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    customVariable3.setValue(Float.valueOf(c(customVariable.getValueToInterpolate(), customVariable2.getValueToInterpolate(), 0.0f, f)));
                } else {
                    ...
                    for (int i22 = 0; i22 < numberOfInterpolatedValues; i22++) {
                        fArr[i22] = c(fArr[i22], fArr2[i22], 0.0f, f);
    ...
    public void d(CLElement cLElement) throws CLParsingException {
