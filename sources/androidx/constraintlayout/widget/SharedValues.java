...
public class SharedValues {
    ...
    public SparseIntArray f990a = new SparseIntArray();
    public HashMap<Integer, HashSet<WeakReference<SharedValuesListener>>> b = new HashMap<>();
