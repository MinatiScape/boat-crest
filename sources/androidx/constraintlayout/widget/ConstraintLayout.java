...
public class ConstraintLayout extends ViewGroup {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f976a[ConstraintWidget.DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f976a[ConstraintWidget.DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f976a[ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
        ...
        public final void didMeasures() {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt instanceof Placeholder) {
                    ((Placeholder) childAt).updatePostMeasure(this.f977a);
                }
            }
            int size = this.f977a.mConstraintHelpers.size();
            if (size > 0) {
                for (int i2 = 0; i2 < size; i2++) {
                    ((ConstraintHelper) this.f977a.mConstraintHelpers.get(i2)).updatePostMeasure(this.f977a);
                }
            }
        }
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                ...
                if (i8 == 1) {
                    ...
                    makeMeasureSpec = ViewGroup.getChildMeasureSpec(this.f, i7 + constraintWidget.getHorizontalMargin(), -1);
                } else if (i8 != 4) {
                    makeMeasureSpec = 0;
                } else {
                    makeMeasureSpec = ViewGroup.getChildMeasureSpec(this.f, i7, -2);
                ...
                if (i10 == 1) {
                    ...
                    makeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.g, i6 + constraintWidget.getVerticalMargin(), -1);
                } else if (i10 != 4) {
                    makeMeasureSpec2 = 0;
                } else {
                    makeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.g, i6, -2);
                ...
                if (constraintWidgetContainer != null && Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 256) && view.getMeasuredWidth() == constraintWidget.getWidth() && view.getMeasuredWidth() < constraintWidgetContainer.getWidth() && view.getMeasuredHeight() == constraintWidget.getHeight() && view.getMeasuredHeight() < constraintWidgetContainer.getHeight() && view.getBaseline() == constraintWidget.getBaselineDistance() && !constraintWidget.isMeasureRequested()) {
                    if (b(constraintWidget.getLastHorizontalMeasureSpec(), makeMeasureSpec, constraintWidget.getWidth()) && b(constraintWidget.getLastVerticalMeasureSpec(), makeMeasureSpec2, constraintWidget.getHeight())) {
    ...
    public void applyConstraintsFromLayoutParams(boolean z, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (layoutParams.h) {
            ...
            int i6 = layoutParams.t;
            float f2 = layoutParams.u;
        ...
        int i8 = layoutParams.m;
        int i9 = layoutParams.n;
        int i10 = layoutParams.o;
        int i11 = layoutParams.p;
        int i12 = layoutParams.q;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public static class a {
            ...
            /* renamed from: a  reason: collision with root package name */
            public static final SparseIntArray f975a;

            static {
                SparseIntArray sparseIntArray = new SparseIntArray();
                f975a = sparseIntArray;
