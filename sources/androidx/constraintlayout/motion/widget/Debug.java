...
public class Debug {
            ...
            for (int i2 = 0; i2 < fields.length; i2++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals("-1")) {
                        System.out.println(str2 + "       " + field.getName() + HexStringBuilder.DEFAULT_SEPARATOR + obj);
                    }
    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals("-1")) && ((!(obj2 instanceof Integer) || !obj2.toString().equals(BleConst.GetDeviceTime)) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
                    System.out.println(str + "    " + field.getName() + HexStringBuilder.DEFAULT_SEPARATOR + obj2);
                }
            } catch (IllegalAccessException unused) {
            }
        }
    ...
    public static void logStack(String str, String str2, int i) {
        ...
        String str3 = HexStringBuilder.DEFAULT_SEPARATOR;
        for (int i2 = 1; i2 <= min; i2++) {
            StackTraceElement stackTraceElement = stackTrace[i2];
            str3 = str3 + HexStringBuilder.DEFAULT_SEPARATOR;
    ...
    public static String getName(Context context, int[] iArr) {
        ...
        try {
            ...
            while (i < iArr.length) {
                ...
                sb.append(str2);
                sb.append(i == 0 ? "" : HexStringBuilder.DEFAULT_SEPARATOR);
                String sb2 = sb.toString();
                try {
                    str = context.getResources().getResourceEntryName(iArr[i]);
                } catch (Resources.NotFoundException unused) {
                    str = "? " + iArr[i] + HexStringBuilder.DEFAULT_SEPARATOR;
                }
                str2 = sb2 + str;
                i++;
            }
        ...
        for (Field field : layoutParams.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals("-1")) {
                    System.out.println(str2 + "       " + name + HexStringBuilder.DEFAULT_SEPARATOR + obj);
                }
            } catch (IllegalAccessException unused) {
            }
        }
