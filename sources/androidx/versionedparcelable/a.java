...
public class a extends VersionedParcel {
    ...
    public final SparseIntArray f1740a;
    ...
    public VersionedParcel createSubParcel() {
        ...
        int i2 = i;
        return new a(parcel, dataPosition, i2, this.e + "  ", this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
    ...
    public void setOutputField(int i) {
        closeField();
        this.f = i;
        this.f1740a.put(i, this.b.dataPosition());
        writeInt(0);
        writeInt(i);
    }
