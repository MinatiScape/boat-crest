        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (Utf8.a.g(b2)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        Utf8.a.c(b2, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    Utf8.a.a(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
        ...
        if ((i | i2 | ((byteBuffer.limit() - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (Utf8.a.g(b2)) {
                    ...
                    if (i6 < i3) {
                        Utf8.a.d(b2, byteBuffer.get(i6), cArr, i5);
                        i = i6 + 1;
                        i5++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        Utf8.a.c(b2, byteBuffer.get(i6), byteBuffer.get(i8), cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    int i10 = i9 + 1;
                    Utf8.a.a(b2, b4, byteBuffer.get(i9), byteBuffer.get(i10), cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
