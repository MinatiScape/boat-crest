...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public class e extends FragmentContainer {
        ...
        public final /* synthetic */ FragmentContainer f1296a;

        public e(FragmentContainer fragmentContainer) {
            this.f1296a = fragmentContainer;
        }

        @Override // androidx.fragment.app.FragmentContainer
        @Nullable
        public View onFindViewById(int i) {
            if (this.f1296a.onHasView()) {
                return this.f1296a.onFindViewById(i);
            }
        ...
        public boolean onHasView() {
            return this.f1296a.onHasView() || DialogFragment.this.onHasView();
        }
    }
