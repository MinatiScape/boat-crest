...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public class f implements Function<Void, ActivityResultRegistry> {
        ...
        public final /* synthetic */ ActivityResultRegistry f1299a;

        public f(Fragment fragment, ActivityResultRegistry activityResultRegistry) {
            this.f1299a = activityResultRegistry;
        }
    ...
    public class g extends j {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ Function f1300a;
        ...
        public void a() {
            this.b.set(((ActivityResultRegistry) this.f1300a.apply(null)).register(Fragment.this.generateActivityResultKey(), Fragment.this, this.c, this.d));
        }
    }
    ...
    public class h<I> extends ActivityResultLauncher<I> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ AtomicReference f1301a;
        public final /* synthetic */ ActivityResultContract b;

        public h(Fragment fragment, AtomicReference atomicReference, ActivityResultContract activityResultContract) {
        ...
        public void launch(I i, @Nullable ActivityOptionsCompat activityOptionsCompat) {
            ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) this.f1301a.get();
        ...
        public void unregister() {
            ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) this.f1301a.getAndSet(null);
            if (activityResultLauncher != null) {
    ...
    public Fragment() {
        ...
        this.mChildFragmentManager = new androidx.fragment.app.f();
    ...
    public void callStartTransitionListener(boolean z) {
        ...
        if (kVar != null) {
            ...
            n.p();
            if (z) {
                this.mHost.c().post(new c(this, n));
            } else {
                n.g();
            }
        }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        if (Z0 != null) {
            bundle.putParcelable(FragmentActivity.FRAGMENTS_TAG, Z0);
        }
    }
    ...
    public void setAnimatingAway(View view) {
        ensureAnimationInfo().f1302a = view;
    }
    ...
    public void setInitialSavedState(@Nullable SavedState savedState) {
        if (this.mFragmentManager == null) {
            this.mSavedFragmentState = (savedState == null || (r2 = savedState.h) == null) ? null : null;
            return;
        }
    ...
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(@NonNull ActivityResultContract<I, O> activityResultContract, @NonNull ActivityResultRegistry activityResultRegistry, @NonNull ActivityResultCallback<O> activityResultCallback) {
        return prepareCallInternal(activityResultContract, new f(this, activityResultRegistry), activityResultCallback);
    }
