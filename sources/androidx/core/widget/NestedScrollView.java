...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public final boolean A(@NonNull EdgeEffect edgeEffect, int i) {
        if (i > 0) {
            return true;
        }
        return j(-i) < EdgeEffectCompat.getDistance(edgeEffect) * ((float) getHeight());
    }
    ...
    public boolean arrowScroll(int i) {
        ...
        if (findNextFocus != null && q(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            f(computeScrollDeltaToGetChildRectOnScreen(this.j));
    ...
    public void computeScroll() {
        ...
        int e = e(currY - this.A);
        this.A = currY;
        int[] iArr = this.y;
        boolean z = false;
        iArr[1] = 0;
        dispatchNestedPreScroll(0, e, iArr, null, 1);
        int i = e - this.y[1];
        ...
        if (i != 0) {
            ...
            int[] iArr2 = this.y;
            iArr2[1] = 0;
            dispatchNestedScroll(0, scrollY2, 0, i2, this.x, 1, iArr2);
            i = i2 - this.y[1];
        }
        if (i != 0) {
            int overScrollMode = getOverScrollMode();
            ...
            if (z) {
                if (i < 0) {
                    if (this.mEdgeGlowTop.isFinished()) {
                        this.mEdgeGlowTop.onAbsorb((int) this.k.getCurrVelocity());
                    }
                } else if (this.mEdgeGlowBottom.isFinished()) {
                    this.mEdgeGlowBottom.onAbsorb((int) this.k.getCurrVelocity());
                }
            }
            a();
        }
    ...
    public final View i(boolean z, int i, int i2) {
    ...
    public final float j(int i) {
        double log = Math.log((Math.abs(i) * 0.35f) / (this.h * 0.015f));
        float f = G;
        return (float) (this.h * 0.015f * Math.exp((f / (f - 1.0d)) * log));
    }
        ...
        if (motionEvent.getAction() == 8 && !this.p) {
            ...
            if (axisValue != 0.0f) {
                ...
                if (verticalScrollFactorCompat < 0) {
                    if (b() && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
    ...
    public boolean onInterceptTouchEvent(@NonNull MotionEvent motionEvent) {
        ...
        if (i != 0) {
            ...
            if (!k((int) motionEvent.getX(), y2)) {
                if (!E(motionEvent) && this.k.isFinished()) {
                    z = false;
                }
                this.p = z;
                u();
    ...
    */
    ...
    public final void r(int i, int i2, @Nullable int[] iArr) {
        int scrollY = getScrollY();
        scrollBy(0, i);
        int scrollY2 = getScrollY() - scrollY;
        if (iArr != null) {
        ...
        this.D.dispatchNestedScroll(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int v(int r4, float r5) {
        /*
            r3 = this;
            int r0 = r3.getWidth()
            float r0 = (float) r0
        ...
        L63:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.NestedScrollView.v(int, float):int");
    }
    ...
    public final void y(View view) {
        view.getDrawingRect(this.j);
        offsetDescendantRectToMyCoords(view, this.j);
        int computeScrollDeltaToGetChildRectOnScreen = computeScrollDeltaToGetChildRectOnScreen(this.j);
