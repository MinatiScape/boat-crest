...
public class a extends Socket {
    ...
    /* loaded from: classes.dex */
    public static class C0129a extends SocketImpl {
        public C0129a(DatagramSocket datagramSocket, FileDescriptor fileDescriptor) {
    ...
    public a(DatagramSocket datagramSocket, FileDescriptor fileDescriptor) throws SocketException {
        super(new C0129a(datagramSocket, fileDescriptor));
    }
}
