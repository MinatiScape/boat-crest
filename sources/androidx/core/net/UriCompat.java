...
public final class UriCompat {
    ...
    public static String toSafeString(@NonNull Uri uri) {
        ...
        if (scheme != null) {
            if (!scheme.equalsIgnoreCase(BleNotificationSettings.CALL) && !scheme.equalsIgnoreCase("sip") && !scheme.equalsIgnoreCase(BleNotificationSettings.SMS) && !scheme.equalsIgnoreCase("smsto") && !scheme.equalsIgnoreCase(BleNotificationSettings.EMAIL) && !scheme.equalsIgnoreCase("nfc")) {
