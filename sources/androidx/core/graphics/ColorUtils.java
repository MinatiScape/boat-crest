...
public final class ColorUtils {
    ...
    public static final ThreadLocal<double[]> f1037a = new ThreadLocal<>();
    ...
    public static int compositeColors(@ColorInt int i, @ColorInt int i2) {
        ...
        return Color.argb(b, c(Color.red(i), alpha2, Color.red(i2), alpha, b), c(Color.green(i), alpha2, Color.green(i2), alpha, b), c(Color.blue(i), alpha2, Color.blue(i2), alpha, b));
    }
    ...
    public static double[] f() {
        ThreadLocal<double[]> threadLocal = f1037a;
