...
public final class PointerIconCompat {
    ...
    public final PointerIcon f1147a;
    ...
    public static PointerIconCompat getSystemIcon(@NonNull Context context, int i) {
        if (Build.VERSION.SDK_INT >= 24) {
            return new PointerIconCompat(a.b(context, i));
        }
        return new PointerIconCompat(null);
    }
    ...
    public static PointerIconCompat load(@NonNull Resources resources, int i) {
        if (Build.VERSION.SDK_INT >= 24) {
            return new PointerIconCompat(a.c(resources, i));
        }
        return new PointerIconCompat(null);
    }
