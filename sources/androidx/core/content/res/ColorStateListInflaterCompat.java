...
public final class ColorStateListInflaterCompat {
    ...
    public static TypedValue a() {
        ThreadLocal<TypedValue> threadLocal = f1020a;
    ...
    */
    public static android.content.res.ColorStateList b(@androidx.annotation.NonNull android.content.res.Resources r17, @androidx.annotation.NonNull org.xmlpull.v1.XmlPullParser r18, @androidx.annotation.NonNull android.util.AttributeSet r19, @androidx.annotation.Nullable android.content.res.Resources.Theme r20) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    public static boolean c(@NonNull Resources resources, @ColorRes int i) {
        TypedValue a2 = a();
    ...
    @ColorInt
    public static int d(@ColorInt int i, @FloatRange(from = 0.0d, to = 1.0d) float f, @FloatRange(from = 0.0d, to = 100.0d) float f2) {
