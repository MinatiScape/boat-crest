...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            paddingRight = AbsActionBarView.next(next + positionChild(this.l, next, paddingTop, paddingTop2, isLayoutRtl), i6, isLayoutRtl);
        }
        int i7 = paddingRight;
        LinearLayout linearLayout = this.o;
        if (linearLayout != null && this.n == null && linearLayout.getVisibility() != 8) {
            i7 += positionChild(this.o, i7, paddingTop, paddingTop2, isLayoutRtl);
        }
        int i8 = i7;
        View view2 = this.n;
        if (view2 != null) {
