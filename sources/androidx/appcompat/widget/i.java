...
public class i {
    ...
    public final ProgressBar f473a;
    public Bitmap b;
    ...
    public void c(AttributeSet attributeSet, int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.f473a.getContext(), attributeSet, c, i, 0);
        Drawable drawableIfKnown = obtainStyledAttributes.getDrawableIfKnown(0);
        if (drawableIfKnown != null) {
            this.f473a.setIndeterminateDrawable(e(drawableIfKnown));
        }
        Drawable drawableIfKnown2 = obtainStyledAttributes.getDrawableIfKnown(1);
        if (drawableIfKnown2 != null) {
            this.f473a.setProgressDrawable(d(drawableIfKnown2, false));
        }
