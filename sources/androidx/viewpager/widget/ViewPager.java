...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.i + "}";
        }
    ...
    public class d implements OnApplyWindowInsetsListener {
        ...
        public final Rect f1745a = new Rect();
    ...
    private void calculatePageOffsets(e eVar, int i, e eVar2) {
        ...
        if (eVar2 != null) {
            ...
            if (i4 < i5) {
                ...
                int i6 = i4 + 1;
                int i7 = 0;
                while (i6 <= eVar.b && i7 < this.mItems.size()) {
                    e eVar5 = this.mItems.get(i7);
                    while (true) {
                        eVar4 = eVar5;
                        if (i6 <= eVar4.b || i7 >= this.mItems.size() - 1) {
                            break;
                        }
                        i7++;
                        eVar5 = this.mItems.get(i7);
                    }
                    while (i6 < eVar4.b) {
        ...
        int i10 = count - 1;
        this.mLastOffset = i8 == i10 ? (eVar.d + f5) - 1.0f : Float.MAX_VALUE;
        int i11 = i - 1;
        while (i11 >= 0) {
            e eVar7 = this.mItems.get(i11);
            while (true) {
                i3 = eVar7.b;
                if (i9 <= i3) {
                    break;
        ...
        while (i13 < size2) {
            ...
            if (i2 == i10) {
                this.mLastOffset = (eVar8.d + f6) - 1.0f;
            }
            eVar8.e = f6;
            f6 += eVar8.d + f2;
            i13++;
    ...
    private e infoForCurrentScrollPosition() {
        ...
        while (i2 < this.mItems.size()) {
            e eVar2 = this.mItems.get(i2);
            if (!z && eVar2.b != (i = i3 + 1)) {
                eVar2 = this.mTempItem;
                eVar2.e = f2 + f4 + f3;
                eVar2.b = i;
                eVar2.d = this.mAdapter.getPageWidth(i);
                i2--;
            }
            f2 = eVar2.e;
    ...
    public e addNewItem(int i, int i2) {
        e eVar = new e();
        eVar.b = i;
        eVar.f1746a = this.mAdapter.instantiateItem((ViewGroup) this, i);
    ...
    */
    ...
    public void dataSetChanged() {
        ...
        while (i2 < this.mItems.size()) {
            ...
            int itemPosition = this.mAdapter.getItemPosition(eVar.f1746a);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    ...
                    this.mAdapter.destroyItem((ViewGroup) this, eVar.b, eVar.f1746a);
    ...
    public e infoForChild(View view) {
        for (int i = 0; i < this.mItems.size(); i++) {
            e eVar = this.mItems.get(i);
            if (this.mAdapter.isViewFromObject(view, eVar.f1746a)) {
                return eVar;
            }
        }
        return null;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.f1744a), 1073741824), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    */
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (pagerAdapter != null) {
            pagerAdapter.restoreState(savedState.j, savedState.k);
            setCurrentItemInternal(savedState.i, false, true);
            return;
        }
        this.mRestoredCurItem = savedState.i;
        this.mRestoredAdapterState = savedState.j;
        this.mRestoredClassLoader = savedState.k;
    }

    @Override // android.view.View
    public Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.i = this.mCurItem;
        PagerAdapter pagerAdapter = this.mAdapter;
        if (pagerAdapter != null) {
            savedState.j = pagerAdapter.saveState();
        }
        return savedState;
    }
