...
public class g extends Drawable {
    ...
    public g(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        ...
        this.f839a = resources.getDimensionPixelSize(R.dimen.cardview_compat_inset_shadow);
        n(colorStateList);
    ...
    public final void e(Canvas canvas) {
        float f = this.f;
        float f2 = (-f) - this.i;
        float f3 = f + this.f839a + (this.j / 2.0f);
        float f4 = f3 * 2.0f;
    ...
    public float j() {
        float f = this.h;
        return (Math.max(f, this.f + this.f839a + ((f * 1.5f) / 2.0f)) * 2.0f) + (((this.h * 1.5f) + this.f839a) * 2.0f);
    }

    public float k() {
        float f = this.h;
        return (Math.max(f, this.f + this.f839a + (f / 2.0f)) * 2.0f) + ((this.h + this.f839a) * 2.0f);
    }
    ...
    public final void s(float f, float f2) {
        if (f < 0.0f) {
            ...
            this.j = t;
            this.h = t2;
            this.i = (int) ((t * 1.5f) + this.f839a + 0.5f);
            this.l = true;
            invalidateSelf();
        } else {
