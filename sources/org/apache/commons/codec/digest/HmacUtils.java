...
public final class HmacUtils {
    ...
    public byte[] hmac(byte[] bArr) {
        return this.f14338a.doFinal(bArr);
    }
    ...
    public byte[] hmac(String str) {
        return this.f14338a.doFinal(StringUtils.getBytesUtf8(str));
    }
    ...
    public byte[] hmac(ByteBuffer byteBuffer) {
        this.f14338a.update(byteBuffer);
        return this.f14338a.doFinal();
    }
    ...
    public byte[] hmac(InputStream inputStream) throws IOException {
        ...
        while (true) {
            int read = inputStream.read(bArr, 0, 1024);
            if (read > -1) {
                this.f14338a.update(bArr, 0, read);
            } else {
                return this.f14338a.doFinal();
            }
        }
