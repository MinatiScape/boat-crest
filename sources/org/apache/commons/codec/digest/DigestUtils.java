...
public class DigestUtils {
    ...
    public final MessageDigest f14337a;
    ...
    public static MessageDigest a(MessageDigest messageDigest, FileChannel fileChannel) throws IOException {
    ...
    public byte[] digest(byte[] bArr) {
        return updateDigest(this.f14337a, bArr).digest();
    }

    public byte[] digest(ByteBuffer byteBuffer) {
        return updateDigest(this.f14337a, byteBuffer).digest();
    }

    public byte[] digest(File file) throws IOException {
        return updateDigest(this.f14337a, file).digest();
    }
    ...
    public byte[] digest(InputStream inputStream) throws IOException {
        return updateDigest(this.f14337a, inputStream).digest();
    }

    public byte[] digest(Path path, OpenOption... openOptionArr) throws IOException {
        return updateDigest(this.f14337a, path, openOptionArr).digest();
    }

    public byte[] digest(String str) {
        return updateDigest(this.f14337a, str).digest();
    }
