...
public class HelpFormatter {
    ...
    public Comparator optionComparator = new a();
    ...
    public static void a(StringBuffer stringBuffer, Option option, boolean z) {
        if (!z) {
            stringBuffer.append("[");
        }
    ...
    public final void b(StringBuffer stringBuffer, OptionGroup optionGroup) {
    ...
    */
    public int findWrapPos(java.lang.String r7, int r8, int r9) {
        /*
            r6 = this;
            r0 = 10
