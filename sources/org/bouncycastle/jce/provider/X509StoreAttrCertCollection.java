...
public class X509StoreAttrCertCollection extends X509StoreSpi {
    ...
    public CollectionStore f15100a;

    @Override // org.bouncycastle.x509.X509StoreSpi
    public Collection engineGetMatches(Selector selector) {
        return this.f15100a.getMatches(selector);
    }
    ...
    public void engineInit(X509StoreParameters x509StoreParameters) {
        ...
        this.f15100a = new CollectionStore(((X509CollectionStoreParameters) x509StoreParameters).getCollection());
    }
}
