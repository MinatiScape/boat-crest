...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    public static final ProviderConfiguration CONFIGURATION = new org.bouncycastle.jce.provider.a();
    ...
    private static final String[] SYMMETRIC_CIPHERS = {AesKey.ALGORITHM, "ARC4", "ARIA", "Blowfish", "Camellia", "CAST5", "CAST6", "ChaCha", "DES", "DESede", "GOST28147", "Grainv1", "Grain128", "HC128", "HC256", "IDEA", "Noekeon", "RC2", "RC5", "RC6", "Rijndael", "Salsa20", "SEED", "Serpent", "Shacal2", "Skipjack", "SM4", "TEA", "Twofish", "Threefish", "VMPC", "VMPCKSA3", "XTEA", "XSalsa20", "OpenSSLPBKDF", "DSTU7624", "GOST3412_2015"};
    ...
    private static final String[] DIGESTS = {"GOST3411", "Keccak", MessageDigestAlgorithms.MD2, "MD4", MessageDigestAlgorithms.MD5, "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "SHA3", "Skein", "SM3", "Tiger", "Whirlpool", "Blake2b", "Blake2s", "DSTU7564"};
    ...
    public void setParameter(String str, Object obj) {
        ...
        synchronized (providerConfiguration) {
            ((org.bouncycastle.jce.provider.a) providerConfiguration).a(str, obj);
        }
    }
}
