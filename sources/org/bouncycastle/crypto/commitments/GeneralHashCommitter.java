...
public class GeneralHashCommitter implements Committer {
    ...
    public final Digest f14631a;
    public final int b;
    public final SecureRandom c;

    public GeneralHashCommitter(ExtendedDigest extendedDigest, SecureRandom secureRandom) {
        this.f14631a = extendedDigest;
        this.b = extendedDigest.getByteLength();
        this.c = secureRandom;
    }

    public final byte[] a(byte[] bArr, byte[] bArr2) {
        byte[] bArr3 = new byte[this.f14631a.getDigestSize()];
        this.f14631a.update(bArr, 0, bArr.length);
        this.f14631a.update(bArr2, 0, bArr2.length);
        this.f14631a.update((byte) (bArr2.length >>> 8));
        this.f14631a.update((byte) bArr2.length);
        this.f14631a.doFinal(bArr3, 0);
        return bArr3;
    }
