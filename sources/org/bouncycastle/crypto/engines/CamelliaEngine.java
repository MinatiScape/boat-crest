...
public class CamelliaEngine implements BlockCipher {
    ...
    public static void e(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 2;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    public static void k(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 0;
        int i6 = i3 + 0;
        int i7 = i3 + 1;
        int i8 = 32 - i2;
    ...
    public static void l(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 0;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    public final int h(byte[] bArr, int i2, byte[] bArr2, int i3) {
        for (int i4 = 0; i4 < 4; i4++) {
        ...
        f(iArr2[2], bArr2, i3);
        f(this.f[3], bArr2, i3 + 4);
        f(this.f[0], bArr2, i3 + 8);
        f(this.f[1], bArr2, i3 + 12);
        return 16;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        m(z, ((KeyParameter) cipherParameters).getKey());
        this.f14669a = true;
    }
    ...
    public final void m(boolean z, byte[] bArr) {
        ...
        if (this.b) {
            ...
            if (z) {
                ...
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                k(15, iArr, 0, this.c, 4);
                k(30, iArr, 0, this.c, 12);
                k(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.c;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                k(17, iArr, 0, this.e, 4);
                k(17, iArr, 0, this.c, 24);
                k(17, iArr, 0, this.c, 32);
                int[] iArr7 = this.c;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                k(15, iArr2, 0, iArr7, 8);
                k(15, iArr2, 0, this.e, 0);
                k(15, iArr2, 0, iArr4, 0);
                int[] iArr8 = this.c;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                k(15, iArr2, 0, iArr8, 20);
                l(34, iArr2, 0, this.c, 28);
                k(17, iArr2, 0, this.d, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
        ...
        if (z) {
            ...
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            l(45, iArr, 0, this.c, 16);
            k(15, iArr, 0, this.e, 4);
            k(17, iArr, 0, this.c, 32);
            l(34, iArr, 0, this.c, 44);
            k(15, iArr, 4, this.c, 4);
            k(15, iArr, 4, this.e, 0);
            k(30, iArr, 4, this.c, 24);
            l(34, iArr, 4, this.c, 36);
            k(15, iArr2, 0, this.c, 8);
            k(30, iArr2, 0, this.c, 20);
            int[] iArr13 = this.e;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            l(49, iArr2, 0, this.c, 40);
            int[] iArr14 = this.c;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            k(30, iArr3, 0, iArr14, 12);
            k(30, iArr3, 0, this.c, 28);
            l(51, iArr3, 0, this.d, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        if (this.f14669a) {
            if (i2 + 16 <= bArr.length) {
                if (i3 + 16 <= bArr2.length) {
                    return this.b ? h(bArr, i2, bArr2, i3) : i(bArr, i2, bArr2, i3);
                }
