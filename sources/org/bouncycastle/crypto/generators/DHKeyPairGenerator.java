...
public class DHKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public DHKeyGenerationParameters f14723a;

    @Override // org.bouncycastle.crypto.AsymmetricCipherKeyPairGenerator
    public AsymmetricCipherKeyPair generateKeyPair() {
        a aVar = a.f14746a;
        DHParameters parameters = this.f14723a.getParameters();
        BigInteger a2 = aVar.a(parameters, this.f14723a.getRandom());
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        this.f14723a = (DHKeyGenerationParameters) keyGenerationParameters;
    }
}
