...
public class ECGOST3410_2012Signer implements DSA {
    ...
    public ECKeyParameters f14833a;
    ...
    public BigInteger[] generateSignature(byte[] bArr) {
        ...
        ECDomainParameters parameters = this.f14833a.getParameters();
        BigInteger n = parameters.getN();
        BigInteger d = ((ECPrivateKeyParameters) this.f14833a).getD();
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            this.f14833a = (ECPrivateKeyParameters) parametersWithRandom.getParameters();
            return;
        } else {
            this.b = new SecureRandom();
            eCKeyParameters = (ECPrivateKeyParameters) cipherParameters;
        }
        this.f14833a = eCKeyParameters;
    }
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger n = this.f14833a.getParameters().getN();
        ...
        ECPoint normalize = ECAlgorithms.sumOfTwoMultiplies(this.f14833a.getParameters().getG(), bigInteger2.multiply(modInverse).mod(n), ((ECPublicKeyParameters) this.f14833a).getQ(), n.subtract(bigInteger).multiply(modInverse).mod(n)).normalize();
