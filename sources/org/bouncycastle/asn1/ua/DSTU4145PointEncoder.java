...
public abstract class DSTU4145PointEncoder {
    public static ECFieldElement a(ECCurve eCCurve, ECFieldElement eCFieldElement) {
    ...
    public static ECPoint decodePoint(ECCurve eCCurve, byte[] bArr) {
        ...
        if (!b(fromBigInteger2).equals(eCCurve.getA())) {
        ...
        if (fromBigInteger2.isZero()) {
            ...
            ECFieldElement a2 = a(eCCurve, fromBigInteger2.square().invert().multiply(eCCurve.getB()).add(eCCurve.getA()).add(fromBigInteger2));
            if (a2 != null) {
                if (!b(a2).equals(fromBigInteger)) {
                    a2 = a2.addOne();
                }
                eCFieldElement = fromBigInteger2.multiply(a2);
            }
        }
