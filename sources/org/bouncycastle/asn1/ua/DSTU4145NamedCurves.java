...
public class DSTU4145NamedCurves {
    ...
    public static final BigInteger f14423a;
    ...
    static {
        ...
        c = new ASN1ObjectIdentifier[10];
        d = UAObjectIdentifiers.dstu4145le.getId() + ".2.";
        int i = 0;
        ...
        while (true) {
            ...
            aSN1ObjectIdentifierArr[i] = new ASN1ObjectIdentifier(d + i);
            i++;
        }
    }
