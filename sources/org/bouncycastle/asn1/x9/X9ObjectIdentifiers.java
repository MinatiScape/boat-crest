...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch3 = aSN1ObjectIdentifier.branch(BleConst.GetDeviceInfo);
        ...
        ecdsa_with_SHA512 = branch5.branch(BleConst.GetDeviceInfo);
        ASN1ObjectIdentifier branch6 = aSN1ObjectIdentifier.branch("3");
        ellipticCurve = branch6;
        ASN1ObjectIdentifier branch7 = branch6.branch(BleConst.GetDeviceTime);
        cTwoCurve = branch7;
        c2pnb163v1 = branch7.branch("1");
        c2pnb163v2 = branch7.branch("2");
        c2pnb163v3 = branch7.branch("3");
        c2pnb176w1 = branch7.branch(BleConst.GetDeviceInfo);
        c2tnb191v1 = branch7.branch(BleConst.SetDeviceInfo);
        c2tnb191v2 = branch7.branch(BleConst.CMD_Set_Mac);
        c2tnb191v3 = branch7.branch(BleConst.GetStepGoal);
        c2onb191v4 = branch7.branch(BleConst.SetStepGoal);
        c2onb191v5 = branch7.branch(BleConst.GetDeviceBatteryLevel);
        c2pnb208w1 = branch7.branch(BleConst.GetDeviceMacAddress);
        c2tnb239v1 = branch7.branch(BleConst.GetDeviceVersion);
        c2tnb239v2 = branch7.branch(BleConst.CMD_Reset);
        c2tnb239v3 = branch7.branch(BleConst.CMD_MCUReset);
        c2onb239v4 = branch7.branch(BleConst.SetMotorVibrationWithTimes);
        c2onb239v5 = branch7.branch(BleConst.GetDeviceName);
        c2pnb272w1 = branch7.branch(BleConst.SetDeviceName);
        c2pnb304w1 = branch7.branch(BleConst.GetAutomaticHRMonitoring);
        c2tnb359v1 = branch7.branch(BleConst.SetAutomaticHRMonitoring);
        c2pnb368w1 = branch7.branch(BleConst.GetAlarmClock);
        c2tnb431r1 = branch7.branch(BleConst.SetAlarmClockWithAllClock);
        ...
        prime239v1 = branch8.branch(BleConst.GetDeviceInfo);
        prime239v2 = branch8.branch(BleConst.SetDeviceInfo);
        prime239v3 = branch8.branch(BleConst.CMD_Set_Mac);
        prime256v1 = branch8.branch(BleConst.GetStepGoal);
        ...
        mqvSinglePass_sha1kdf_scheme = aSN1ObjectIdentifier2.branch(BleConst.SetDeviceName);
        ...
        dhHybrid1 = branch9.branch(BleConst.GetDeviceInfo);
        dhHybrid2 = branch9.branch(BleConst.SetDeviceInfo);
        dhHybridOneFlow = branch9.branch(BleConst.CMD_Set_Mac);
        mqv2 = branch9.branch(BleConst.GetStepGoal);
        mqv1 = branch9.branch(BleConst.SetStepGoal);
