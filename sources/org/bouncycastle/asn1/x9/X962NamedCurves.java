...
public class X962NamedCurves {
    ...
    public static X9ECParametersHolder f14439a = new k();
    public static X9ECParametersHolder b = new p();
    public static X9ECParametersHolder c = new q();
    public static X9ECParametersHolder d = new r();
    public static X9ECParametersHolder e = new s();
    public static X9ECParametersHolder f = new t();
    public static X9ECParametersHolder g = new u();
    public static X9ECParametersHolder h = new v();
    public static X9ECParametersHolder i = new w();
    ...
    public static class f extends X9ECParametersHolder {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m((int) Command.CMD_NOTIFY_DEVICE_APP_INFO, 1, 2, 83, new BigInteger(BleConst.GetDeviceTime, 16), new BigInteger("00C8619ED45A62E6212E1160349E2BFA844439FAFC2A3FD1638F9E", 16), bigInteger, valueOf);
    ...
    static {
        a("prime192v1", X9ObjectIdentifiers.prime192v1, f14439a);
