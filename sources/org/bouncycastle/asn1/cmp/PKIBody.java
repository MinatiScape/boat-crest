...
public class PKIBody extends ASN1Object implements ASN1Choice {
    ...
    public PKIBody(int i, ASN1Encodable aSN1Encodable) {
        this.h = i;
        this.i = a(i, aSN1Encodable);
    }

    public PKIBody(ASN1TaggedObject aSN1TaggedObject) {
        int tagNo = aSN1TaggedObject.getTagNo();
        this.h = tagNo;
        this.i = a(tagNo, aSN1TaggedObject.getObject());
    }

    public static ASN1Encodable a(int i, ASN1Encodable aSN1Encodable) {
        switch (i) {
            case 0:
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DERTaggedObject(true, this.h, this.i);
    }
}
