...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final Hashtable f14426a;
    ...
    public final Hashtable defaultSymbols = AbstractX500NameStyle.copyHashTable(f14426a);
    ...
    static {
        ...
        hashtable.put(intern2, c.f10260a);
        hashtable.put(intern3, "cn");
        hashtable.put(intern4, "dc");
        hashtable.put(intern5, SavingTrackHelper.POINT_COL_DESCRIPTION);
        ...
        hashtable.put(intern18, AppMeasurementSdk.ConditionalUserProperty.NAME);
        ...
        hashtable.put(intern31, Constants.SERIAL_NUMBER);
        hashtable.put(intern32, "sn");
        hashtable.put(intern33, "st");
        hashtable.put(intern34, GeoCodingCriteria.POD_STREET);
        ...
        hashtable2.put(c.f10260a, intern2);
        hashtable2.put("cn", intern3);
        hashtable2.put("dc", intern4);
        hashtable2.put(SavingTrackHelper.POINT_COL_DESCRIPTION, intern5);
        ...
        hashtable2.put(AppMeasurementSdk.ConditionalUserProperty.NAME, intern18);
        ...
        hashtable2.put(GeoCodingCriteria.POD_STREET, intern34);
    ...
    public String oidToDisplayName(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return (String) f14426a.get(aSN1ObjectIdentifier);
    }
