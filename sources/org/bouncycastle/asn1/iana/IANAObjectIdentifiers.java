...
public interface IANAObjectIdentifiers {
    ...
    static {
        ...
        _private = aSN1ObjectIdentifier.branch(BleConst.GetDeviceInfo);
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(BleConst.SetDeviceInfo);
        security = branch;
        SNMPv2 = aSN1ObjectIdentifier.branch(BleConst.CMD_Set_Mac);
        mail = aSN1ObjectIdentifier.branch(BleConst.GetStepGoal);
        ASN1ObjectIdentifier branch2 = branch.branch(BleConst.SetDeviceInfo);
        security_mechanisms = branch2;
        security_nametypes = branch.branch(BleConst.CMD_Set_Mac);
        pkix = branch2.branch(BleConst.CMD_Set_Mac);
        ASN1ObjectIdentifier branch3 = branch2.branch(BleConst.SetStepGoal);
        ipsec = branch3;
        ...
        hmacRIPEMD160 = branch4.branch(BleConst.GetDeviceInfo);
    }
}
