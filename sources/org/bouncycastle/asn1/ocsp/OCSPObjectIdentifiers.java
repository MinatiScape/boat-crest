...
public interface OCSPObjectIdentifiers {
    ...
    static {
        ...
        id_pkix_ocsp_pref_sig_algs = aSN1ObjectIdentifier.branch(BleConst.SetStepGoal);
        id_pkix_ocsp_extended_revoke = aSN1ObjectIdentifier.branch(BleConst.GetDeviceBatteryLevel);
    }
}
