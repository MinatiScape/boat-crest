...
public class DisplayText extends ASN1Object implements ASN1Choice {
    ...
    public DisplayText(int i, String str) {
        ...
        this.h = i != 0 ? i != 1 ? i != 2 ? i != 3 ? new DERUTF8String(str) : new DERVisibleString(str) : new DERUTF8String(str) : new DERBMPString(str) : new DERIA5String(str);
    }

    public DisplayText(String str) {
        this.h = new DERUTF8String(str.length() > 200 ? str.substring(0, 200) : str);
    }
