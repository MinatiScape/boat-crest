...
public interface ICAOObjectIdentifiers {
    ...
    static {
        ...
        id_icao_documentTypeList = branch2.branch(BleConst.GetDeviceInfo);
        id_icao_aaProtocolObject = branch2.branch(BleConst.SetDeviceInfo);
        ASN1ObjectIdentifier branch3 = branch2.branch(BleConst.CMD_Set_Mac);
