...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        netscapeCARevocationURL = aSN1ObjectIdentifier.branch(BleConst.GetDeviceInfo);
        netscapeRenewalURL = aSN1ObjectIdentifier.branch(BleConst.GetStepGoal);
        netscapeCApolicyURL = aSN1ObjectIdentifier.branch(BleConst.SetStepGoal);
        netscapeSSLServerName = aSN1ObjectIdentifier.branch(BleConst.CMD_Reset);
        netscapeCertComment = aSN1ObjectIdentifier.branch(BleConst.CMD_MCUReset);
        ...
        cryptlib_algorithm_blowfish_OFB = branch.branch(BuildConfig.VERSION_NAME);
