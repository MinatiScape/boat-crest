...
public interface EACObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch5 = aSN1ObjectIdentifier.branch(BuildConfig.VERSION_NAME);
        id_TA = branch5;
        ...
        id_TA_RSA_PSS_SHA_256 = branch6.branch(BleConst.GetDeviceInfo);
        id_TA_RSA_v1_5_SHA_512 = branch6.branch(BleConst.SetDeviceInfo);
        id_TA_RSA_PSS_SHA_512 = branch6.branch(BleConst.CMD_Set_Mac);
        ...
        id_TA_ECDSA_SHA_384 = branch7.branch(BleConst.GetDeviceInfo);
        id_TA_ECDSA_SHA_512 = branch7.branch(BleConst.SetDeviceInfo);
