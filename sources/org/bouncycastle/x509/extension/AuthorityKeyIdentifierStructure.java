...
public class AuthorityKeyIdentifierStructure extends AuthorityKeyIdentifier {
    ...
    public static ASN1Sequence a(X509Certificate x509Certificate) throws CertificateParsingException {
        try {
    ...
    public static ASN1Sequence b(PublicKey publicKey) throws InvalidKeyException {
        try {
