...
public class b {
    ...
    public static final Map f14563a;
    ...
    /* renamed from: org.bouncycastle.cms.bc.b$b  reason: collision with other inner class name */
    /* loaded from: classes12.dex */
    public static class C0902b implements BcDigestProvider {
        @Override // org.bouncycastle.operator.bc.BcDigestProvider
        public ExtendedDigest get(AlgorithmIdentifier algorithmIdentifier) {
    ...
    static {
        ...
        hashMap.put(aSN1ObjectIdentifier2, AesKey.ALGORITHM);
    ...
    public static Object c(boolean z, CipherParameters cipherParameters, AlgorithmIdentifier algorithmIdentifier) throws CMSException {
        ...
        BufferedBlockCipher a2 = a(algorithmIdentifier.getAlgorithm());
        ...
        if (aSN1Primitive != null && !(aSN1Primitive instanceof ASN1Null)) {
            if (algorithm.equals(CMSAlgorithm.DES_EDE3_CBC) || algorithm.equals(CMSAlgorithm.IDEA_CBC) || algorithm.equals(CMSAlgorithm.AES128_CBC) || algorithm.equals(CMSAlgorithm.AES192_CBC) || algorithm.equals(CMSAlgorithm.AES256_CBC) || algorithm.equals(CMSAlgorithm.CAMELLIA128_CBC) || algorithm.equals(CMSAlgorithm.CAMELLIA192_CBC) || algorithm.equals(CMSAlgorithm.CAMELLIA256_CBC) || algorithm.equals(CMSAlgorithm.SEED_CBC) || algorithm.equals(OIWObjectIdentifiers.desCBC)) {
                ...
                parametersWithIV = new ParametersWithIV(new RC2Parameters(((KeyParameter) cipherParameters).getKey(), e[rC2CBCParameter.getRC2ParameterVersion().intValue()]), rC2CBCParameter.getIV());
            }
            a2.init(z, parametersWithIV);
            ...
            a2.init(z, new ParametersWithIV(cipherParameters, new byte[8]));
        } else {
            a2.init(z, cipherParameters);
        }
        return a2;
    }

    public static Wrapper e(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws CMSException {
        if (NISTObjectIdentifiers.id_aes128_CBC.equals(aSN1ObjectIdentifier) || NISTObjectIdentifiers.id_aes192_CBC.equals(aSN1ObjectIdentifier) || NISTObjectIdentifiers.id_aes256_CBC.equals(aSN1ObjectIdentifier)) {
    ...
    public static Map f() {
        HashMap hashMap = new HashMap();
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA1, new a());
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA224, new C0902b());
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA256, new c());
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA384, new d());
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA512, new e());
        return Collections.unmodifiableMap(hashMap);
    }

    public static ExtendedDigest h(AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
        return ((BcDigestProvider) c.get(algorithmIdentifier.getAlgorithm())).get(null);
    }

    public final CipherKeyGenerator b(SecureRandom secureRandom, int i) {
        CipherKeyGenerator cipherKeyGenerator = new CipherKeyGenerator();
        cipherKeyGenerator.init(new KeyGenerationParameters(secureRandom, i));
        return cipherKeyGenerator;
    }

    public CipherKeyGenerator d(ASN1ObjectIdentifier aSN1ObjectIdentifier, SecureRandom secureRandom) throws CMSException {
        if (NISTObjectIdentifiers.id_aes128_CBC.equals(aSN1ObjectIdentifier)) {
            return b(secureRandom, 128);
        }
        if (NISTObjectIdentifiers.id_aes192_CBC.equals(aSN1ObjectIdentifier)) {
            return b(secureRandom, 192);
        }
        if (NISTObjectIdentifiers.id_aes256_CBC.equals(aSN1ObjectIdentifier)) {
            return b(secureRandom, 256);
        }
        if (PKCSObjectIdentifiers.des_EDE3_CBC.equals(aSN1ObjectIdentifier)) {
    ...
    public AlgorithmIdentifier g(ASN1ObjectIdentifier aSN1ObjectIdentifier, CipherParameters cipherParameters, SecureRandom secureRandom) throws CMSException {
        if (aSN1ObjectIdentifier.equals(CMSAlgorithm.AES128_CBC) || aSN1ObjectIdentifier.equals(CMSAlgorithm.AES192_CBC) || aSN1ObjectIdentifier.equals(CMSAlgorithm.AES256_CBC) || aSN1ObjectIdentifier.equals(CMSAlgorithm.CAMELLIA128_CBC) || aSN1ObjectIdentifier.equals(CMSAlgorithm.CAMELLIA192_CBC) || aSN1ObjectIdentifier.equals(CMSAlgorithm.CAMELLIA256_CBC) || aSN1ObjectIdentifier.equals(CMSAlgorithm.SEED_CBC)) {
            ...
            if (aSN1ObjectIdentifier.equals(PKCSObjectIdentifiers.RC2_CBC)) {
                ...
                return new AlgorithmIdentifier(aSN1ObjectIdentifier, new RC2CBCParameter(d[128], bArr4));
            }
