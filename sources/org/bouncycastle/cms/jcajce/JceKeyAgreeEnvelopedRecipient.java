...
public class JceKeyAgreeEnvelopedRecipient extends JceKeyAgreeRecipient {
    ...
    public class a implements InputDecryptor {
        ...
        public final /* synthetic */ AlgorithmIdentifier f14592a;
        public final /* synthetic */ Cipher b;

        public a(JceKeyAgreeEnvelopedRecipient jceKeyAgreeEnvelopedRecipient, AlgorithmIdentifier algorithmIdentifier, Cipher cipher) {
            this.f14592a = algorithmIdentifier;
            this.b = cipher;
        }
    ...
    public RecipientOperator getRecipientOperator(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2, SubjectPublicKeyInfo subjectPublicKeyInfo, ASN1OctetString aSN1OctetString, byte[] bArr) throws CMSException {
        return new RecipientOperator(new a(this, algorithmIdentifier2, this.contentHelper.createContentCipher(extractSecretKey(algorithmIdentifier, algorithmIdentifier2, subjectPublicKeyInfo, aSN1OctetString, bArr), algorithmIdentifier2)));
    }
}
