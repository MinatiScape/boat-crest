...
public final class RC2 {
        ...
        public AlgorithmParameters engineGenerateParameters() {
            if (this.b != null) {
                try {
                    ...
                    createParametersInstance.init(this.b);
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded() {
            return Arrays.clone(this.f15040a);
        }
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f15040a = ((IvParameterSpec) algorithmParameterSpec).getIV();
                ...
                this.f15040a = rC2ParameterSpec.getIV();
            }
        }

        @Override // java.security.AlgorithmParametersSpi
        public void engineInit(byte[] bArr) throws IOException {
            this.f15040a = Arrays.clone(bArr);
        }
        ...
        public void engineInit(byte[] bArr, String str) throws IOException {
            ...
            if (rC2CBCParameter.getRC2ParameterVersion() != null) {
                this.b = rC2CBCParameter.getRC2ParameterVersion().intValue();
            }
            this.f15040a = rC2CBCParameter.getIV();
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i = this.b) != -1) {
                return i < 256 ? new RC2ParameterSpec(d[this.b], this.f15040a) : new RC2ParameterSpec(this.b, this.f15040a);
            } else if (cls == IvParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new IvParameterSpec(this.f15040a);
            } else {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final String f15041a = RC2.class.getName();
