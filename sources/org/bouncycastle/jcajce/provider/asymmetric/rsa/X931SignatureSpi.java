...
public class X931SignatureSpi extends SignatureSpi {
    ...
    public X931SignatureSpi(Digest digest, AsymmetricBlockCipher asymmetricBlockCipher) {
        this.f14960a = new X931Signer(asymmetricBlockCipher, digest);
    }
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        this.f14960a.init(true, RSAUtil.b((RSAPrivateKey) privateKey));
    }

    @Override // java.security.SignatureSpi
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        this.f14960a.init(false, RSAUtil.c((RSAPublicKey) publicKey));
    }
    ...
    public byte[] engineSign() throws SignatureException {
        try {
            return this.f14960a.generateSignature();
        } catch (Exception e) {
    ...
    public void engineUpdate(byte b) throws SignatureException {
        this.f14960a.update(b);
    }

    @Override // java.security.SignatureSpi
    public void engineUpdate(byte[] bArr, int i, int i2) throws SignatureException {
        this.f14960a.update(bArr, i, i2);
    }

    @Override // java.security.SignatureSpi
    public boolean engineVerify(byte[] bArr) throws SignatureException {
        return this.f14960a.verifySignature(bArr);
    }
}
