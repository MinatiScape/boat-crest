...
public class Curve25519FieldElement extends ECFieldElement {
    ...
    public static final int[] f15139a = {1242472624, -991028441, -1389370248, 792926214, 1039914919, 726466713, 1338105611, 730014848};
    public int[] x;
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f15138a, ((Curve25519FieldElement) eCFieldElement).x, create);
    ...
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f15138a, this.x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement sqrt() {
        ...
        Curve25519Field.multiply(create, f15139a, create);
        Curve25519Field.square(create, create2);
        if (Nat256.eq(iArr, create2)) {
            return new Curve25519FieldElement(create);
        }
