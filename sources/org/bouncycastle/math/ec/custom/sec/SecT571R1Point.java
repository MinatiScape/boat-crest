...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            if (secT571FieldElement.isZero()) {
                return new SecT571R1Point(curve, secT571FieldElement, SecT571R1Curve.e, this.withCompression);
            }
            ...
            if (secT571FieldElement11.isZero()) {
                return new SecT571R1Point(curve, secT571FieldElement11, SecT571R1Curve.e, this.withCompression);
            }
    ...
    public ECPoint twice() {
        ...
        if (Nat576.isZero64(create643)) {
            return new SecT571R1Point(curve, new SecT571FieldElement(create643), SecT571R1Curve.e, this.withCompression);
        }
        long[] createExt64 = Nat576.createExt64();
