...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
    public SecT163R1Point infinity;
    ...
    public class a implements ECLookupTable {
        ...
        public ECPoint lookup(int i) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < this.f15173a; i3++) {
                long j = ((i3 ^ i) - 1) >> 31;
    ...
    public SecT163R1Curve() {
        ...
        this.f15127a = fromBigInteger(new BigInteger(1, Hex.decode("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
