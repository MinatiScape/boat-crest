...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    public class a implements ECLookupTable {
        ...
        public ECPoint lookup(int i) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < this.f15160a; i3++) {
                int i4 = ((i3 ^ i) - 1) >> 31;
    ...
    public SecP256R1Curve() {
        ...
        this.f15127a = fromBigInteger(new BigInteger(1, Hex.decode("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
