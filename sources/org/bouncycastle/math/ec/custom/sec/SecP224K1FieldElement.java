...
public class SecP224K1FieldElement extends ECFieldElement {
    ...
    public static final int[] f15155a = {868209154, -587542221, 579297866, -1014948952, -1470801668, 514782679, -1897982644};
    public int[] x;
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.f15154a, ((SecP224K1FieldElement) eCFieldElement).x, create);
    ...
    public ECFieldElement invert() {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.f15154a, this.x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement sqrt() {
        ...
        SecP224K1Field.multiply(create3, f15155a, create3);
        SecP224K1Field.square(create3, create5);
        if (Nat224.eq(iArr, create5)) {
            return new SecP224K1FieldElement(create3);
        }
