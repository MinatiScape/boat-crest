...
public abstract class Nat {
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i7 = 0; i7 < i; i7++) {
            long mulWordAddTo = (mulWordAddTo(i, iArr[i2 + i7], iArr2, i3, iArr3, i6) & 4294967295L) + j + (4294967295L & iArr3[i5]);
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            long mulWordAddTo = (mulWordAddTo(i, iArr[i3], iArr2, 0, iArr3, i3) & 4294967295L) + j + (4294967295L & iArr3[i2]);
