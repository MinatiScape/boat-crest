...
public abstract class Mod {
    ...
    public static int c(int[] iArr, int[] iArr2, int i, int[] iArr3, int i2) {
        ...
        int a2 = a(iArr2[0]);
        if (a2 > 0) {
            Nat.shiftDownBits(i, iArr2, a2, 0);
            i3 += a2;
        }
    ...
    public static void invert(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        create[0] = 1;
        int c = (1 & copy[0]) == 0 ? c(iArr, copy, length, create, 0) : 0;
        if (Nat.isOne(length, copy)) {
            b(iArr, c, create, iArr3);
            return;
        }
        ...
        while (true) {
            ...
            if (copy[i3] == 0 && copy2[i3] == 0) {
                ...
                c = c(iArr, copy, i2, create, c + (Nat.subFrom(length, create2, create) - i));
                ...
                i = c(iArr, copy2, i2, create2, i + (Nat.subFrom(length, create, create2) - c));
                if (Nat.isOne(i2, copy2)) {
                    b(iArr, i, create2, iArr3);
                    return;
                }
            }
        }
