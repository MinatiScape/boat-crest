...
public class BCMcElieceCCA2PrivateKey implements PrivateKey {
    ...
    public byte[] getEncoded() {
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.mcElieceCca2), new McElieceCCA2PrivateKey(getN(), getK(), getField(), getGoppaPoly(), getP(), a.a(this.params.getDigest()))).getEncoded();
