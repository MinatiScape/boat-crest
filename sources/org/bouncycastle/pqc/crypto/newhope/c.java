...
public class c {
        ...
        for (int i = 0; i < 10; i += 2) {
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                while (i13 < 1023) {
                    ...
                    int i17 = i12 + 1;
                    short s2 = sArr2[i12];
                    sArr[i13] = g.a((short) (i14 + i16));
                    sArr[i15] = g.b(s2 * ((i14 + 36867) - i16));
                    i13 += i10 * 2;
                    i12 = i17;
                }
            }
    ...
    public static void c(short[] sArr, short[] sArr2) {
        for (int i = 0; i < 1024; i++) {
            sArr[i] = g.b((sArr[i] & UShort.MAX_VALUE) * (65535 & sArr2[i]));
        }
    }
}
