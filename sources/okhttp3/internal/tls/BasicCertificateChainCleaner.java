...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public final TrustRootIndex f14301a;
    ...
    public List<Certificate> clean(@NotNull List<? extends Certificate> chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        while (i < 9) {
            ...
            X509Certificate findByIssuerAndSignature = this.f14301a.findByIssuerAndSignature(x509Certificate);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && Intrinsics.areEqual(((BasicCertificateChainCleaner) obj).f14301a, this.f14301a);
    }
