...
public class g implements SyncResultListner {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ SyncCompleteListner f20a;

    public g(SyncManager syncManager, SyncCompleteListner syncCompleteListner) {
        this.f20a = syncCompleteListner;
    }

    @Override // com.coveiot.repository.datasync.domainlogic.SyncResultListner
    public void onFailure(Error error) {
        this.f20a.onFailure(error.getMessage(), error);
    }
