...
public class h extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getInvariantSeparatorsPathString(@NotNull Path path) {
        ...
        return m.replace$default(obj, separator, MqttTopic.TOPIC_LEVEL_SEPARATOR, false, 4, (Object) null);
    }
    ...
    public static final void visitFileTree(@NotNull Path path, @NotNull FileVisitor<Path> visitor, int i, boolean z) {
        ...
        Files.walkFileTree(path, z ? z.setOf(FileVisitOption.FOLLOW_LINKS) : a0.emptySet(), i, visitor);
    }
